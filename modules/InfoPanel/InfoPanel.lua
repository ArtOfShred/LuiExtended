...
local function CreateUIControls()
    ...
    uiLatency.label = UI.Label(
        uiLatency.control,
        { LEFT, RIGHT, 0, 0, uiLatency.icon },
        { 56, 20 },
        { 0, 1 },
        g_infoPanelFont,
        "11999 ms",
    ...
    uiGems.label = UI.Label(
        uiGems.control,
        { LEFT, RIGHT, 2, 0, uiGems.icon },
        { 32, 20 },
        { 0, 1 },
        g_infoPanelFont,
        "8/88",
    ...
    uiFeedTimer.label = UI.Label(
        uiFeedTimer.control,
        { LEFT, RIGHT, 0, 0, uiFeedTimer.icon },
        { 68, 20 },
        { 0, 1 },
        g_infoPanelFont,
        GetString(SI_LUIE_PNL_TRAINNOW),
        false
    )
    ...
    uiArmour.label = UI.Label(
        uiArmour.control,
        { LEFT, RIGHT, 0, 0, uiArmour.icon },
        { 41, 20 },
        { 0, 1 },
        g_infoPanelFont,
        "100%",
    ...
    uiBags.label = UI.Label(
        uiBags.control,
        { LEFT, RIGHT, 0, 0, uiBags.icon },
        { 50, 20 },
        { 0, 1 },
        g_infoPanelFont,
        "888/888",
        ...
        if mountFeedTimer ~= nil then
            if mountFeedTimer == 0 then
                ...
                if
                    ...
                    or staminaBonus ~= maxStaminaBonus
                    or speedBonus ~= maxSpeedBonus
                then

...
function UnitFrames.AltBar_OnMouseEnterXP(control)
    ...
    if isMax then
        ...
        if enlightenedPool > 0 then
            InformationTooltip:AddLine(
                zo_strformat(SI_EXPERIENCE_CHAMPION_ENLIGHTENED_TOOLTIP, enlightenedValue),
                nil,
                ZO_SUCCEEDED_TEXT:UnpackRGB()
            )
        end
    end
end
...
function UnitFrames.AltBar_OnMouseEnterSiege(control)
    local function UpdateSiegePower()
        ...
        InformationTooltip:AddLine(
            zo_strformat(
                SI_LUIE_UF_SIEGE_POWER,
                ZO_CommaDelimitNumber(currentPower),
                ZO_CommaDelimitNumber(maxPower),
                percentagePower
            )
        )
    end
...
local function CreateCustomFrames()
    ...
    if UnitFrames.SV.CustomFramesTarget then
        ...
        targetTlw.previewLabel =
            UI.Label(targetTlw.preview, { CENTER, CENTER }, nil, nil, "ZoFontGameMedium", "Target Frame", false)
        ...
        UnitFrames.CustomFrames.reticleover = {
            ...
            ["star1"] = UI.Texture(
                ...
                { RIGHT, RIGHT, -28, -1 },
                { 16, 16 },
                "esoui/art/ava/ava_bgwindow_capturepointicon.dds",
                nil,
                true
            ),
            ["star2"] = UI.Texture(
            ...
            ["skull"] = UI.Texture(
                ...
                { RIGHT, LEFT, -8, 0 },
                nil,
                "LuiExtended/media/unitframes/unitframes_execute.dds",
                nil,
                true
            ),
            ["buffs"] = buffs,
    ...
    if UnitFrames.SV.AvaCustFramesTarget then
        ...
        targetTlw.preview = UI.Backdrop(targetTlw, "fill", nil, nil, nil, true)
        targetTlw.previewLabel = UI.Label(
            targetTlw.preview,
            { CENTER, CENTER },
            nil,
            nil,
            "ZoFontGameMedium",
            "PvP Player Target Frame",
            false
        )
        local target = UI.Control(targetTlw, { TOPLEFT, TOPLEFT }, nil, false)
        local topInfo = UI.Control(target, { BOTTOM, TOP, 0, -3 }, nil, false)
    ...
    if UnitFrames.SV.CustomFramesGroup then
        ...
        group.previewLabel =
            UI.Label(group.preview, { BOTTOM, TOP, 0, -1, group }, nil, nil, "ZoFontGameMedium", "Small Group", false)
    ...
    if UnitFrames.SV.CustomFramesRaid then
        ...
        raid.previewLabel =
            UI.Label(raid.preview, { BOTTOM, TOP, 0, -1, raid }, nil, nil, "ZoFontGameMedium", "Raid Group", false)
    ...
    if UnitFrames.SV.CustomFramesPet then
        ...
        pet.previewLabel =
            UI.Label(pet.preview, { BOTTOM, TOP, 0, -1, group }, nil, nil, "ZoFontGameMedium", "Player Pets", false)
    ...
    if UnitFrames.SV.CustomFramesCompanion then
        ...
        companionTlw.previewLabel = UI.Label(
            companionTlw.preview,
            { BOTTOM, TOP, 0, -1, group },
            nil,
            nil,
            "ZoFontGameMedium",
            "Player Companion",
    ...
    if UnitFrames.SV.CustomFramesBosses then
        ...
        bosses.previewLabel = UI.Label(
            bosses.preview,
            { BOTTOM, TOP, 0, -1, bosses },
            nil,
            nil,
            "ZoFontGameMedium",
            "Bosses Group",
    ...
    for _, baseName in pairs({
        ...
        if unitFrame ~= nil then
            ...
            unitFrame.tlw.preview.anchorTexture = UI.Texture(
                unitFrame.tlw.preview,
                { TOPLEFT, TOPLEFT },
                { 16, 16 },
            ...
            unitFrame.tlw.preview.anchorLabel = UI.Label(
                unitFrame.tlw.preview,
            ...
            unitFrame.tlw.preview.anchorLabelBg = UI.Backdrop(
                unitFrame.tlw.preview.anchorLabel,
                "fill",
                nil,
                { 0, 0, 0, 1 },
                { 0, 0, 0, 1 },
        ...
        local shieldOverlay = (baseName == "RaidGroup" or baseName == "boss")
            or not UnitFrames.SV.CustomShieldBarSeparate
        for i = 0, 24 do
                    ...
                    if powerBar then
                        ...
                        if powerBar.shield then
                            if shieldOverlay then
                                ...
                                powerBar.shieldbackdrop =
                                    UI.Backdrop(UnitFrames.CustomFrames[unitTag].control, nil, nil, nil, nil, true)
                ...
                for _, powerType in pairs({ COMBAT_MECHANIC_FLAGS_HEALTH }) do
                    if UnitFrames.CustomFrames[unitTag][powerType] then
                        ...
                        if size1 ~= nil and size2 ~= nil then
                            UnitFrames.CustomFrames[unitTag][powerType].regen1 = CreateRegenAnimation(
                                backdrop,
                                { CENTER, CENTER, 0, 0 },
                                { size1 - 4, size2 - (size2 * 0.3) },
                                0.55,
                                "regen1"
                            )
                            UnitFrames.CustomFrames[unitTag][powerType].regen2 = CreateRegenAnimation(
                                backdrop,
                                { CENTER, CENTER, 0, 0 },
                                { size1 - 4, size2 - (size2 * 0.3) },
                                0.55,
                            ...
                            UnitFrames.CustomFrames[unitTag][powerType].degen1 = CreateRegenAnimation(
                                backdrop,
                                { CENTER, CENTER, 0, 0 },
                                { size1 - 4, size2 - (size2 * 0.3) },
                                0.55,
                            ...
                            UnitFrames.CustomFrames[unitTag][powerType].degen2 = CreateRegenAnimation(
                                backdrop,
                                { CENTER, CENTER, 0, 0 },
                                { size1 - 4, size2 - (size2 * 0.3) },
                                0.55,
            ...
            if UnitFrames.CustomFrames[unitTag] then
                ...
                UnitFrames.CustomFrames[unitTag][COMBAT_MECHANIC_FLAGS_HEALTH].stat[STAT_ARMOR_RATING] = {
                    ...
                    ["inc"] = UI.Texture(
                        ...
                        { CENTER, CENTER, 13, 0 },
                        { 24, 24 },
                        "/esoui/art/icons/alchemy/crafting_alchemy_trait_increasearmor.dds",
                        2,
                        true
                    ),
                }
                    ...
                    if UnitFrames.CustomFrames[unitTag][COMBAT_MECHANIC_FLAGS_HEALTH].stat then
                        if UnitFrames.CustomFrames[unitTag][COMBAT_MECHANIC_FLAGS_HEALTH].stat[STAT_POWER] then
                            if UnitFrames.CustomFrames[unitTag][COMBAT_MECHANIC_FLAGS_HEALTH].stat[STAT_POWER].inc then
                                ...
                                local control =
                                    UnitFrames.CustomFrames[unitTag][COMBAT_MECHANIC_FLAGS_HEALTH].stat[STAT_POWER].inc
    ...
    if not UnitFrames.SV.RepositionFrames then
        if defaultPos.health then
            ...
            ZO_PlayerAttributeHealth:SetAnchor(
                ...
                defaultPos.health[3],
                defaultPos.health[4],
                defaultPos.health[5] - UnitFrames.SV.RepositionFramesAdjust
            )
            ZO_PlayerAttributeMagicka:ClearAnchors()
            ZO_PlayerAttributeMagicka:SetAnchor(
                defaultPos.magicka[1],
                defaultPos.magicka[2],
                defaultPos.magicka[3],
                defaultPos.magicka[4],
                defaultPos.magicka[5] - UnitFrames.SV.RepositionFramesAdjust
            )
            ZO_PlayerAttributeStamina:ClearAnchors()
            ZO_PlayerAttributeStamina:SetAnchor(
                defaultPos.stamina[1],
                defaultPos.stamina[2],
                defaultPos.stamina[3],
                defaultPos.stamina[4],
                defaultPos.stamina[5] - UnitFrames.SV.RepositionFramesAdjust
            )
            ...
            ZO_PlayerAttributeSiegeHealth:SetAnchor(
                ...
                defaultPos.siege[3],
                defaultPos.siege[4],
                defaultPos.siege[5] - UnitFrames.SV.RepositionFramesAdjust
            )
            ZO_RAM.control:ClearAnchors()
            ZO_RAM.control:SetAnchor(
                defaultPos.ram[1],
                defaultPos.ram[2],
                defaultPos.ram[3],
                defaultPos.ram[4],
                defaultPos.ram[5] - UnitFrames.SV.RepositionFramesAdjust
            )
            ZO_SmallGroupAnchorFrame:ClearAnchors()
            ZO_SmallGroupAnchorFrame:SetAnchor(
                defaultPos.smallGroup[1],
                defaultPos.smallGroup[2],
                defaultPos.smallGroup[3],
                defaultPos.smallGroup[4],
                defaultPos.smallGroup[5] - UnitFrames.SV.RepositionFramesAdjust
            )
        end
    end
...
function UnitFrames.Initialize(enabled)
    ...
    if
        UnitFrames.CustomFrames.player
        or UnitFrames.CustomFrames.reticleover
        or UnitFrames.CustomFrames.companion
        or UnitFrames.CustomFrames.SmallGroup1
        or UnitFrames.CustomFrames.RaidGroup1
        or UnitFrames.CustomFrames.boss1
        or UnitFrames.PetGroup1
    then
        ...
        eventManager:RegisterForEvent(
            ...
            UnitFrames.ActiveCompanionStateChanged
        )
        ...
        eventManager:RegisterForEvent(
            ...
            UnitFrames.OnGroupSupportRangeUpdate
        )
        eventManager:RegisterForEvent(
            moduleName,
            EVENT_GROUP_MEMBER_CONNECTED_STATUS,
            UnitFrames.OnGroupMemberConnectedStatus
        )
            ...
            if UnitFrames.CustomFrames["player"][powerType] then
                if UnitFrames.CustomFrames["player"][powerType].labelOne then
                    if UnitFrames.SV.BarAlignCenterLabelPlayer then
                        UnitFrames.CustomFrames["player"][powerType].labelOne.fmt =
                        ...
                        UnitFrames.CustomFrames["player"][powerType].labelOne:SetAnchor(
                            CENTER,
                            UnitFrames.CustomFrames["player"][powerType].backdrop,
                            CENTER,
                            0,
                            0
                        )
        ...
        if UnitFrames.CustomFrames["reticleover"][COMBAT_MECHANIC_FLAGS_HEALTH] then
            if UnitFrames.CustomFrames["reticleover"][COMBAT_MECHANIC_FLAGS_HEALTH].labelOne then
                if UnitFrames.SV.BarAlignCenterLabelTarget then
                    UnitFrames.CustomFrames["reticleover"][COMBAT_MECHANIC_FLAGS_HEALTH].labelOne.fmt =
                        UnitFrames.SV.CustomFormatCenterLabel
                    UnitFrames.CustomFrames["reticleover"][COMBAT_MECHANIC_FLAGS_HEALTH].labelOne:ClearAnchors()
                    UnitFrames.CustomFrames["reticleover"][COMBAT_MECHANIC_FLAGS_HEALTH].labelOne:SetHorizontalAlignment(
                        TEXT_ALIGN_CENTER
                    )
                    UnitFrames.CustomFrames["reticleover"][COMBAT_MECHANIC_FLAGS_HEALTH].labelOne:SetAnchor(
                        CENTER,
                        UnitFrames.CustomFrames["reticleover"][COMBAT_MECHANIC_FLAGS_HEALTH].backdrop,
                        CENTER,
                        0,
                        0
                    )
            ...
            if UnitFrames.CustomFrames["reticleover"][COMBAT_MECHANIC_FLAGS_HEALTH].labelTwo then
                if UnitFrames.SV.BarAlignCenterLabelTarget then
                    ...
                    UnitFrames.CustomFrames["reticleover"][COMBAT_MECHANIC_FLAGS_HEALTH].labelTwo.fmt =
    ...
    if UnitFrames.CustomFrames["companion"] then
        if UnitFrames.CustomFrames["companion"][COMBAT_MECHANIC_FLAGS_HEALTH] then
            if UnitFrames.CustomFrames["companion"][COMBAT_MECHANIC_FLAGS_HEALTH].label then
                UnitFrames.CustomFrames["companion"][COMBAT_MECHANIC_FLAGS_HEALTH].label.fmt =
        ...
        if UnitFrames.CustomFrames[unitTag] then
            if UnitFrames.CustomFrames[unitTag][COMBAT_MECHANIC_FLAGS_HEALTH] then
                if UnitFrames.CustomFrames[unitTag][COMBAT_MECHANIC_FLAGS_HEALTH].labelOne then
                    UnitFrames.CustomFrames[unitTag][COMBAT_MECHANIC_FLAGS_HEALTH].labelOne.fmt =
                        UnitFrames.SV.CustomFormatOneGroup
                end
                if UnitFrames.CustomFrames[unitTag][COMBAT_MECHANIC_FLAGS_HEALTH].labelTwo then
                    UnitFrames.CustomFrames[unitTag][COMBAT_MECHANIC_FLAGS_HEALTH].labelTwo.fmt =
                        UnitFrames.SV.CustomFormatTwoGroup
                end
            end
        end
        ...
        if UnitFrames.CustomFrames[unitTag] then
            if UnitFrames.CustomFrames[unitTag][COMBAT_MECHANIC_FLAGS_HEALTH] then
                if UnitFrames.CustomFrames[unitTag][COMBAT_MECHANIC_FLAGS_HEALTH].label then
                    UnitFrames.CustomFrames[unitTag][COMBAT_MECHANIC_FLAGS_HEALTH].label.fmt =
...
function UnitFrames.OnPowerUpdate(eventCode, unitTag, powerIndex, powerType, powerValue, powerMax, powerEffectiveMax)
    ...
    if g_DefaultFrames[unitTag] then
        UnitFrames.UpdateAttribute(
            g_DefaultFrames[unitTag][powerType],
            powerValue,
            powerEffectiveMax,
            (powerType == COMBAT_MECHANIC_FLAGS_HEALTH) and g_savedHealth[unitTag][4] or nil,
            eventCode == nil
        )
    end
    if UnitFrames.CustomFrames[unitTag] then
        if unitTag == "reticleover" and powerType == COMBAT_MECHANIC_FLAGS_HEALTH then
            ...
            if (isCritter or isGuard) and powerValue >= 1 then
                ...
                UnitFrames.UpdateAttribute(
                    UnitFrames.CustomFrames[unitTag][powerType],
                    powerValue,
                    powerEffectiveMax,
                    (powerType == COMBAT_MECHANIC_FLAGS_HEALTH) and g_savedHealth[unitTag][4] or nil,
                    eventCode == nil
    ...
    if g_AvaCustFrames[unitTag] then
        UnitFrames.UpdateAttribute(
            g_AvaCustFrames[unitTag][powerType],
            powerValue,
            powerEffectiveMax,
            (powerType == COMBAT_MECHANIC_FLAGS_HEALTH) and g_savedHealth[unitTag][4] or nil,
            eventCode == nil
    ...
    if
        ...
        and (
            ...
            or powerType == COMBAT_MECHANIC_FLAGS_MAGICKA
            or powerType == COMBAT_MECHANIC_FLAGS_STAMINA
            or powerType == COMBAT_MECHANIC_FLAGS_MOUNT_STAMINA
        )
    then
    ...
    if
        unitTag == "reticleover"
        and powerType == COMBAT_MECHANIC_FLAGS_HEALTH
        and UnitFrames.CustomFrames.reticleover
        and UnitFrames.CustomFrames.reticleover.hostile
    then
        ...
        elseif
            100 * powerValue / powerEffectiveMax
            < UnitFrames.CustomFrames.reticleover[COMBAT_MECHANIC_FLAGS_HEALTH].threshold
        then
    ...
    if UnitFrames.CustomFrames.SmallGroup1 ~= nil or UnitFrames.CustomFrames.RaidGroup1 ~= nil then
        ...
        if not g_PendingUpdate.Group.flag then
            ...
            eventManager:RegisterForUpdate(
                g_PendingUpdate.Group.name,
                g_PendingUpdate.Group.delay,
                UnitFrames.CustomFramesGroupUpdate
            )
        end
...
function UnitFrames.OnVisualizationAdded(
    eventCode,
    unitTag,
    unitAttributeVisual,
    statType,
    ...
    elseif
        unitAttributeVisual == ATTRIBUTE_VISUAL_INCREASED_REGEN_POWER
        or unitAttributeVisual == ATTRIBUTE_VISUAL_DECREASED_REGEN_POWER
    then
        UnitFrames.UpdateRegen(unitTag, statType, attributeType, powerType)
    elseif
        unitAttributeVisual == ATTRIBUTE_VISUAL_INCREASED_STAT
        or unitAttributeVisual == ATTRIBUTE_VISUAL_DECREASED_STAT
    then
...
function UnitFrames.OnVisualizationRemoved(
    eventCode,
    unitTag,
    unitAttributeVisual,
    statType,
...
function UnitFrames.OnVisualizationUpdated(
    eventCode,
    unitTag,
    unitAttributeVisual,
    statType,
...
function UnitFrames.OnReticleTargetChanged(eventCode)
    if DoesUnitExist("reticleover") then
        ...
        elseif attackable and reactionType ~= UNIT_REACTION_HOSTILE then -- those are neutral targets that can become hostile on attack
            ...
            colour = (reactionType == UNIT_REACTION_FRIENDLY or reactionType == UNIT_REACTION_NPC_ALLY)
                    and UnitFrames.SV.Target_FontColour_FriendlyNPC
                or UnitFrames.SV.Target_FontColour
            reticle_colour = colour
            interactableCheck = true
        end
        ...
        if UnitFrames.CustomFrames.reticleover then
            UnitFrames.CustomFrames.reticleover.hostile = (reactionType == UNIT_REACTION_HOSTILE)
                and UnitFrames.SV.TargetEnableSkull
            UnitFrames.CustomFrames.reticleover.skull:SetHidden(
                not UnitFrames.CustomFrames.reticleover.hostile
                    or (g_savedHealth.reticleover[1] == 0)
                    or (
                        100 * g_savedHealth.reticleover[1] / g_savedHealth.reticleover[3]
                        > UnitFrames.CustomFrames.reticleover[COMBAT_MECHANIC_FLAGS_HEALTH].threshold
                    )
            )
            ...
            UnitFrames.CustomFrames.reticleover[COMBAT_MECHANIC_FLAGS_HEALTH].labelTwo:SetHidden(
                isCritter or isGuard or not UnitFrames.CustomFrames.reticleover.dead:IsHidden()
            )
        ...
        if UnitFrames.CustomFrames.AvaPlayerTarget then
            UnitFrames.CustomFrames.AvaPlayerTarget.control:SetHidden(
                not (
                        UnitFrames.CustomFrames.AvaPlayerTarget.isPlayer
                        and (reactionType == UNIT_REACTION_HOSTILE)
        ...
        if UnitFrames.SV.TargetShowClass and g_DefaultFrames.reticleover.isPlayer then
            ...
            g_DefaultFrames.reticleover.classIcon:SetAnchor(
                TOPRIGHT,
                ZO_TargetUnitFramereticleoverTextArea,
                TOPLEFT,
                g_DefaultFrames.reticleover.isChampion and -32 or -2,
                -4
            )
        else
...
function UnitFrames.ReloadValues(unitTag)
    ...
    local shield, _ = GetUnitAttributeVisualizerEffectInfo(
        unitTag,
...
function UnitFrames.UpdateStaticControls(unitFrame)
    ...
    if unitFrame.friendIcon ~= nil then
        ...
        if isIgnored or isFriend or isGuild then
            unitFrame.friendIcon:SetTexture(
                isIgnored and "LuiExtended/media/unitframes/unitframes_social_ignore.dds"
                    or isFriend and "/esoui/art/campaign/campaignbrowser_friends.dds"
                    or "/esoui/art/campaign/campaignbrowser_guild.dds"
            )
    ...
    if unitFrame.level ~= nil then
        ...
        if showLevel then
            ...
            unitFrame.levelIcon:SetTexture(
                unitFrame.isChampion and "LuiExtended/media/unitframes/unitframes_level_champion.dds"
                    or "LuiExtended/media/unitframes/unitframes_level_normal.dds"
            )
            -- Level label should be already anchored
            unitFrame.level:SetText(
                tostring(
                    unitFrame.isChampion and GetUnitChampionPoints(unitFrame.unitTag) or GetUnitLevel(unitFrame.unitTag)
                )
            )
        end
        if unitFrame.unitTag == "player" then
    ...
    if unitFrame.buffs and unitFrame.unitTag == "reticleover" then
        if UnitFrames.SV.PlayerFrameOptions ~= 1 then
            if
                (
                    not UnitFrames.SV.TargetEnableRank
                    and not UnitFrames.SV.TargetEnableTitle
                    and not UnitFrames.SV.TargetEnableRankIcon
                )
                or (savedTitle == "" and not UnitFrames.SV.TargetEnableRankIcon and unitFrame.isPlayer)
                or (savedTitle == "" and not unitFrame.isPlayer)
            then
    ...
    if unitFrame.unitTag and "group" == string.sub(unitFrame.unitTag, 0, 5) and unitFrame.control then
        unitFrame.control:SetAlpha(
            IsUnitInGroupSupportRange(unitFrame.unitTag) and (UnitFrames.SV.GroupAlpha * 0.01)
                or (UnitFrames.SV.GroupAlpha * 0.01) / 2
        )
    end
end
...
function UnitFrames.UpdateAttribute(attributeFrame, powerValue, powerEffectiveMax, shield, forceInit)
    ...
    if
        UnitFrames.CustomFrames
        and UnitFrames.CustomFrames["reticleover"]
        and attributeFrame == UnitFrames.CustomFrames["reticleover"][COMBAT_MECHANIC_FLAGS_HEALTH]
        and IsUnitInvulnerableGuard("reticleover")
    then
        ...
        for _, label in pairs({ "label", "labelOne", "labelTwo" }) do
            if attributeFrame[label] ~= nil then
                ...
                local str = fmt:gsub("Percentage", tostring(pct))
                    ...
                    :gsub(
                        "+ Shield",
                        shield and ("+ " .. AbbreviateNumber(shield, UnitFrames.SV.ShortenNumbers, true)) or ""
                    )
                    :gsub("Nothing", "")
                -- Change text
                ...
                if
                    (label == "labelOne" or label == "labelTwo")
                    and UnitFrames.CustomFrames
                    and UnitFrames.CustomFrames["reticleover"]
                    and attributeFrame == UnitFrames.CustomFrames["reticleover"][COMBAT_MECHANIC_FLAGS_HEALTH]
                    and powerValue == 0
                then
                ...
                attributeFrame[label]:SetColor(
                    unpack(
                        (pct < (attributeFrame.threshold or g_defaultThreshold)) and { 1, 0.25, 0.38 }
                            or attributeFrame.colour
                            or { 1, 1, 1 }
                    )
                )
            end
...
function UnitFrames.UpdateShield(unitTag, value, maxValue)
    ...
    if g_DefaultFrames[unitTag] then
        UnitFrames.UpdateAttribute(
            g_DefaultFrames[unitTag][COMBAT_MECHANIC_FLAGS_HEALTH],
            healthValue,
            healthEffectiveMax,
            value,
            false
    ...
    if UnitFrames.CustomFrames[unitTag] then
        UnitFrames.UpdateAttribute(
            UnitFrames.CustomFrames[unitTag][COMBAT_MECHANIC_FLAGS_HEALTH],
            healthValue,
            healthEffectiveMax,
            value,
            false
        )
        UnitFrames.UpdateShieldBar(
            UnitFrames.CustomFrames[unitTag][COMBAT_MECHANIC_FLAGS_HEALTH],
            value,
            healthEffectiveMax
        )
    ...
    if g_AvaCustFrames[unitTag] then
        UnitFrames.UpdateAttribute(
            g_AvaCustFrames[unitTag][COMBAT_MECHANIC_FLAGS_HEALTH],
            healthValue,
            healthEffectiveMax,
            value,
            false
...
function UnitFrames.UpdateStat(unitTag, statType, attributeType, powerType)
    ...
    if
        UnitFrames.CustomFrames[unitTag]
        and UnitFrames.CustomFrames[unitTag][powerType]
        and UnitFrames.CustomFrames[unitTag][powerType].stat
        and UnitFrames.CustomFrames[unitTag][powerType].stat[statType]
    then
        table.insert(statControls, UnitFrames.CustomFrames[unitTag][powerType].stat[statType])
    end
    if
        g_AvaCustFrames[unitTag]
        and g_AvaCustFrames[unitTag][powerType]
        and g_AvaCustFrames[unitTag][powerType].stat
        and g_AvaCustFrames[unitTag][powerType].stat[statType]
    then
...
function UnitFrames.OnXPUpdate(eventCode, unitTag, currentExp, maxExp, reason)
    ...
    if UnitFrames.CustomFrames.player.isChampion then
        ...
        if not g_PendingUpdate.VeteranXP.flag then
            ...
            eventManager:RegisterForUpdate(
                g_PendingUpdate.VeteranXP.name,
                g_PendingUpdate.VeteranXP.delay,
                UnitFrames.UpdateVeteranXP
            )
        end
...
function UnitFrames.OnGroupSupportRangeUpdate(eventCode, unitTag, status)
    if UnitFrames.CustomFrames[unitTag] and UnitFrames.CustomFrames[unitTag].control then
        UnitFrames.CustomFrames[unitTag].control:SetAlpha(
            status and (UnitFrames.SV.GroupAlpha * 0.01) or (UnitFrames.SV.GroupAlpha * 0.01) / 2
        )
    end
end
...
function UnitFrames.OnDeath(eventCode, unitTag, isDead)
    ...
    if
        isDead
        and UnitFrames.CustomFrames[unitTag]
        and UnitFrames.CustomFrames[unitTag][COMBAT_MECHANIC_FLAGS_HEALTH]
    then
...
function UnitFrames.ResurrectionMonitor(unitTag)
    ...
    if IsUnitDead(unitTag) then
        if IsUnitBeingResurrected(unitTag) then
            UnitFrames.CustomFramesSetDeadLabel(
                UnitFrames.CustomFrames[unitTag],
                g_isRaid and strResCastRaid or strResCast
            )
        elseif DoesUnitHaveResurrectPending(unitTag) then
            UnitFrames.CustomFramesSetDeadLabel(
                UnitFrames.CustomFrames[unitTag],
                g_isRaid and strResPendingRaid or strResPending
            )
        else
...
function UnitFrames.CustomFramesSetupAlternative(isWerewolf, isSiege, isMounted)
    ...
    if UnitFrames.SV.PlayerEnableAltbarMSW and isWerewolf then
        ...
        UnitFrames.OnPowerUpdate(
            nil,
            "player",
            nil,
            COMBAT_MECHANIC_FLAGS_WEREWOLF,
            GetUnitPower("player", COMBAT_MECHANIC_FLAGS_WEREWOLF)
        )
        ...
        UnitFrames.CustomFrames.player.alternative.bar:SetHandler(
            "OnMouseEnter",
            UnitFrames.AltBar_OnMouseEnterWerewolf
        )
    ...
    elseif UnitFrames.SV.PlayerEnableAltbarMSW and isSiege then
        ...
        UnitFrames.CustomFrames.controlledsiege[COMBAT_MECHANIC_FLAGS_HEALTH] =
            UnitFrames.CustomFrames.player.alternative
        UnitFrames.CustomFrames.player[COMBAT_MECHANIC_FLAGS_MOUNT_STAMINA] = nil
        UnitFrames.CustomFrames.player.ChampionXP = nil
        UnitFrames.CustomFrames.player.Experience = nil
        ...
        UnitFrames.OnPowerUpdate(
            ...
            nil,
            COMBAT_MECHANIC_FLAGS_HEALTH,
            GetUnitPower("controlledsiege", COMBAT_MECHANIC_FLAGS_HEALTH)
        )
    ...
    elseif UnitFrames.SV.PlayerEnableAltbarMSW and isMounted then
        ...
        UnitFrames.OnPowerUpdate(
            ...
            nil,
            COMBAT_MECHANIC_FLAGS_MOUNT_STAMINA,
            GetUnitPower("player", COMBAT_MECHANIC_FLAGS_MOUNT_STAMINA)
        )
        ...
        UnitFrames.CustomFrames.player.alternative.enlightenment:SetHidden(true)
    elseif
        UnitFrames.SV.PlayerEnableAltbarXP
        and (UnitFrames.CustomFrames.player.isLevelCap or UnitFrames.CustomFrames.player.isChampion)
    then
        UnitFrames.CustomFrames.player[COMBAT_MECHANIC_FLAGS_WEREWOLF] = nil
        UnitFrames.CustomFrames.controlledsiege[COMBAT_MECHANIC_FLAGS_HEALTH] = nil
        UnitFrames.CustomFrames.player[COMBAT_MECHANIC_FLAGS_MOUNT_STAMINA] = nil
    ...
    elseif UnitFrames.SV.PlayerEnableAltbarXP then
        ...
        UnitFrames.CustomFrames.player.Experience.bar:SetMinMax(
            0,
            UnitFrames.CustomFrames.player.isChampion and championXP or GetUnitXPMax("player")
        )
        UnitFrames.CustomFrames.player.Experience.bar:SetValue(
            UnitFrames.CustomFrames.player.isChampion and GetPlayerChampionXP() or GetUnitXP("player")
        )
    ...
    if UnitFrames.SV.PlayerFrameOptions == 3 then
        if UnitFrames.SV.HideBarMagicka and UnitFrames.SV.HideBarStamina then
            UnitFrames.CustomFrames.player.buffs:SetAnchor(
                TOP,
                hidden and UnitFrames.CustomFrames.player.control or UnitFrames.CustomFrames.player.buffAnchor,
                BOTTOM,
                0,
                5
            )
            ...
            UnitFrames.CustomFrames.player.buffs:SetAnchor(
                ...
                BOTTOM,
                0,
                5 + UnitFrames.SV.PlayerBarHeightStamina + UnitFrames.SV.PlayerBarSpacing
            )
        end
    else
        UnitFrames.CustomFrames.player.buffs:SetAnchor(
...
function UnitFrames.OnChampionPointGained(eventCode)
    if UnitFrames.CustomFrames.player and UnitFrames.CustomFrames.player.ChampionXP then
        ...
        local colour = (UnitFrames.SV.PlayerChampionColour and CP_BAR_COLOURS[attribute])
                and CP_BAR_COLOURS[attribute][2]
            or XP_BAR_COLOURS
        local colour2 = (UnitFrames.SV.PlayerChampionColour and CP_BAR_COLOURS[attribute])
                and CP_BAR_COLOURS[attribute][1]
            or XP_BAR_COLOURS
        UnitFrames.CustomFrames.player.ChampionXP.backdrop:SetCenterColor(
            0.1 * colour.r,
            0.1 * colour.g,
            0.1 * colour.b,
            0.9
...
function UnitFrames.OnCombatEvent(
    eventCode,
    result,
    isError,
    abilityName,
...
function UnitFrames.CustomFramesSetPositions()
    ...
    for _, unitTag in pairs({
        ...
        if UnitFrames.CustomFrames[unitTag] then
            ...
            local anchors = (savedPos ~= nil and #savedPos == 2) and { TOPLEFT, TOPLEFT, savedPos[1], savedPos[2] }
                or default_anchors[unitTag]
            ...
            UnitFrames.CustomFrames[unitTag].tlw.preview.anchorLabel:SetText(
                (savedPos ~= nil and #savedPos == 2) and zo_strformat("<<1>>, <<2>>", savedPos[1], savedPos[2])
                    or "default"
            )
        end
    end
...
function UnitFrames.CustomFramesApplyColours(isMenu)
    ...
    local petcolor =
        { UnitFrames.SV.CustomColourPet[1], UnitFrames.SV.CustomColourPet[2], UnitFrames.SV.CustomColourPet[3], 0.9 } -- Player Pet
    ...
    for _, baseName in pairs({ "player", "reticleover", "boss", "AvaPlayerTarget" }) do
        shield[4] = (UnitFrames.SV.CustomShieldBarSeparate and not (baseName == "boss")) and 0.9
            or (UnitFrames.SV.ShieldAlpha / 100)
        for i = 0, 6 do
            local unitTag = (i == 0) and baseName or (baseName .. i)
            if UnitFrames.CustomFrames[unitTag] then
    ...
    for _, baseName in pairs({ "SmallGroup", "RaidGroup" }) do
        shield[4] = (UnitFrames.SV.CustomShieldBarSeparate and not (baseName == "RaidGroup")) and 0.9
            or (UnitFrames.SV.ShieldAlpha / 100)
        ...
        for i = 1, groupSize do
            ...
            if UnitFrames.CustomFrames[unitTag] then
                ...
                elseif
                    (group and UnitFrames.SV.ColorClassGroup)
                    or (raid and UnitFrames.SV.ColorClassRaid) and class ~= 0
                then
                    local class_color
                    local class_bg
                    if class == 1 then
...
function UnitFrames.CustomFramesApplyTexture()
    ...
    if UnitFrames.CustomFrames.AvaPlayerTarget then
        ...
        if UnitFrames.CustomFrames.AvaPlayerTarget[COMBAT_MECHANIC_FLAGS_HEALTH].shieldbackdrop then
            UnitFrames.CustomFrames.AvaPlayerTarget[COMBAT_MECHANIC_FLAGS_HEALTH].shieldbackdrop:SetCenterTexture(
                texture
            )
        end
...
function UnitFrames.DefaultFramesApplyFont(unitTag)
    ...
    local fontStyle = (UnitFrames.SV.DefaultFontStyle and UnitFrames.SV.DefaultFontStyle ~= "")
            and UnitFrames.SV.DefaultFontStyle
        or "soft-shadow-thick"
    local fontSize = (UnitFrames.SV.DefaultFontSize and UnitFrames.SV.DefaultFontSize > 0)
            and UnitFrames.SV.DefaultFontSize
        or 16
        ...
        if g_DefaultFrames[unitTag] then
            ...
            for _, powerType in pairs({
                ...
                if unitFrame[powerType] then
                    ...
                    unitFrame[powerType].label:SetColor(
                        UnitFrames.SV.DefaultTextColour[1],
                        UnitFrames.SV.DefaultTextColour[2],
                        UnitFrames.SV.DefaultTextColour[3]
                    )
                end
            end
        end
...
function UnitFrames.CustomFramesApplyFont()
    ...
    local fontStyle = (UnitFrames.SV.CustomFontStyle and UnitFrames.SV.CustomFontStyle ~= "")
            and UnitFrames.SV.CustomFontStyle
        or "soft-shadow-thin"
    local sizeCaption = (UnitFrames.SV.CustomFontOther and UnitFrames.SV.CustomFontOther > 0)
            and UnitFrames.SV.CustomFontOther
        or 16
    local sizeBars = (UnitFrames.SV.CustomFontBars and UnitFrames.SV.CustomFontBars > 0)
            and UnitFrames.SV.CustomFontBars
        or 14
        ...
        for i = 0, 24 do
            ...
            if UnitFrames.CustomFrames[unitTag] then
                ...
                if unitFrame.name then
                    unitFrame.name:SetFont(
                        __mkFont((unitFrame.name:GetParent() == unitFrame.topInfo) and sizeCaption or sizeBars)
                    )
                end
                if unitFrame.level then
...
function UnitFrames.CustomFramesApplyLayoutPlayer(unhide)
    ...
    if UnitFrames.CustomFrames.player then
        ...
        if UnitFrames.SV.PlayerFrameOptions == 1 then
            if not UnitFrames.SV.HideBarMagicka and not UnitFrames.SV.HideBarStamina then
                player.tlw:SetDimensions(
                    UnitFrames.SV.PlayerBarWidth,
                    UnitFrames.SV.PlayerBarHeightHealth
                        + UnitFrames.SV.PlayerBarHeightMagicka
                        + UnitFrames.SV.PlayerBarHeightStamina
                        + 2 * UnitFrames.SV.PlayerBarSpacing
                        + (phb.shieldbackdrop and UnitFrames.SV.CustomShieldBarHeight or 0)
                )
                player.control:SetDimensions(
                    UnitFrames.SV.PlayerBarWidth,
                    UnitFrames.SV.PlayerBarHeightHealth
                        + UnitFrames.SV.PlayerBarHeightMagicka
                        + UnitFrames.SV.PlayerBarHeightStamina
            ...
            elseif UnitFrames.SV.HideBarMagicka and not UnitFrames.SV.HideBarStamina then
                player.tlw:SetDimensions(
                    ...
                    UnitFrames.SV.PlayerBarHeightHealth
                        + UnitFrames.SV.PlayerBarHeightStamina
                        + UnitFrames.SV.PlayerBarSpacing
                        + (phb.shieldbackdrop and UnitFrames.SV.CustomShieldBarHeight or 0)
                )
                player.control:SetDimensions(
                    UnitFrames.SV.PlayerBarWidth,
            ...
            if not UnitFrames.SV.ReverseResourceBars then
                ...
                if not UnitFrames.SV.HideBarMagicka then
                    if phb.shieldbackdrop then
                        ...
                        phb.shieldbackdrop:SetDimensions(
                            UnitFrames.SV.PlayerBarWidth,
                            UnitFrames.SV.CustomShieldBarHeight
                        )
        ...
        elseif UnitFrames.SV.PlayerFrameOptions == 2 then
            player.tlw:SetDimensions(
                UnitFrames.SV.PlayerBarWidth,
                UnitFrames.SV.PlayerBarHeightHealth + (phb.shieldbackdrop and UnitFrames.SV.CustomShieldBarHeight or 0)
            )
            player.control:SetDimensions(
                UnitFrames.SV.PlayerBarWidth,
                UnitFrames.SV.PlayerBarHeightHealth + (phb.shieldbackdrop and UnitFrames.SV.CustomShieldBarHeight or 0)
            ...
            if not UnitFrames.SV.ReverseResourceBars then
                pmb.backdrop:ClearAnchors()
                if not UnitFrames.SV.HideBarMagicka then
                    pmb.backdrop:SetAnchor(
                        RIGHT,
                        phb.backdrop,
                        LEFT,
                        -UnitFrames.SV.AdjustMagickaHPos,
                        UnitFrames.SV.AdjustMagickaVPos
                    )
                    pmb.backdrop:SetDimensions(UnitFrames.SV.PlayerBarWidth, UnitFrames.SV.PlayerBarHeightMagicka)
                end
                ...
                psb.backdrop:ClearAnchors()
                if not UnitFrames.SV.HideBarStamina then
                    psb.backdrop:SetAnchor(
                        LEFT,
                        phb.backdrop,
                        RIGHT,
                        UnitFrames.SV.AdjustStaminaHPos,
                        UnitFrames.SV.AdjustStaminaVPos
                    )
                    psb.backdrop:SetDimensions(UnitFrames.SV.PlayerBarWidth, UnitFrames.SV.PlayerBarHeightStamina)
                end
            else
    ...
    if UnitFrames.CustomFrames.reticleover then
        ...
        target.tlw:SetDimensions(
            UnitFrames.SV.TargetBarWidth,
            UnitFrames.SV.TargetBarHeight + (thb.shieldbackdrop and UnitFrames.SV.CustomShieldBarHeight or 0)
        )
        target.control:SetDimensions(
            UnitFrames.SV.TargetBarWidth,
            UnitFrames.SV.TargetBarHeight + (thb.shieldbackdrop and UnitFrames.SV.CustomShieldBarHeight or 0)
        )
        ...
        local enable
        if
            not UnitFrames.SV.TargetEnableTitle
            and not UnitFrames.SV.TargetEnableRank
            and not UnitFrames.SV.TargetEnableRankIcon
        then
            enable = false
        else
    ...
    if UnitFrames.CustomFrames.AvaPlayerTarget then
        ...
        target.tlw:SetDimensions(
            UnitFrames.SV.AvaTargetBarWidth,
            UnitFrames.SV.AvaTargetBarHeight + (thb.shieldbackdrop and UnitFrames.SV.CustomShieldBarHeight or 0)
        )
        target.control:SetDimensions(
            UnitFrames.SV.AvaTargetBarWidth,
            UnitFrames.SV.AvaTargetBarHeight + (thb.shieldbackdrop and UnitFrames.SV.CustomShieldBarHeight or 0)
...
function UnitFrames.CustomFramesApplyLayoutGroup(unhide)
    ...
    for i = 1, 4 do
        ...
        unitFrame.control:SetAnchor(
            TOPLEFT,
            group,
            TOPLEFT,
            0,
            0.5 * UnitFrames.SV.GroupBarSpacing + (groupBarHeight + UnitFrames.SV.GroupBarSpacing) * (i - 1)
        )
...
function UnitFrames.CustomFramesApplyLayoutRaid(unhide)
    ...
    raid:SetDimensions(
        UnitFrames.SV.RaidBarWidth * (12 / itemsPerColumn)
            + (UnitFrames.SV.RaidSpacers and spacerHeight * (itemsPerColumn / 4) or 0),
        UnitFrames.SV.RaidBarHeight * itemsPerColumn
    )
    ...
    for i = 1, GetGroupSize() do
        ...
        unitFrame.control:SetAnchor(
            ...
            raid,
            TOPLEFT,
            UnitFrames.SV.RaidBarWidth * column,
            UnitFrames.SV.RaidBarHeight * (row - 1)
                + (
                    UnitFrames.SV.RaidSpacers
                        and spacerHeight * (math.floor((i - 1) / 4) - math.floor(column * itemsPerColumn / 4))
                    or 0
                )
        )
        ...
        if UnitFrames.SV.RaidIconOptions > 1 then
            if UnitFrames.SV.RaidIconOptions == 2 then -- Class Icon Only
                unitFrame.name:SetDimensions(
                    UnitFrames.SV.RaidBarWidth - UnitFrames.SV.RaidNameClip - 27,
                    UnitFrames.SV.RaidBarHeight - 2
                )
            ...
            if UnitFrames.SV.RaidIconOptions == 4 then -- Class PVP, Role PVE
                ...
                elseif not LUIE.ResolvePVPZone() and role then
                    ...
                    unitFrame.name:SetDimensions(
                        UnitFrames.SV.RaidBarWidth - UnitFrames.SV.RaidNameClip - 10,
                        UnitFrames.SV.RaidBarHeight - 2
                    )
        ...
        unitFrame[COMBAT_MECHANIC_FLAGS_HEALTH].label:SetDimensions(
            UnitFrames.SV.RaidBarWidth - 50,
            UnitFrames.SV.RaidBarHeight - 2
        )

        if not IsUnitOnline(unitTag) then
            unitFrame.name:SetDimensions(
                UnitFrames.SV.RaidBarWidth - UnitFrames.SV.RaidNameClip,
                UnitFrames.SV.RaidBarHeight - 2
            )
            unitFrame.name:SetAnchor(LEFT, rhb, LEFT, 5, 0)
            unitFrame.classIcon:SetHidden(true)
...
function UnitFrames.CustomFramesApplyLayoutCompanion(unhide)
    ...
    unitFrame.name:SetDimensions(
        UnitFrames.SV.CompanionWidth - UnitFrames.SV.CompanionNameClip - 10,
        UnitFrames.SV.CompanionHeight - 2
    )
    unitFrame.name:SetAnchor(LEFT, shb, LEFT, 5, 0)
    unitFrame[COMBAT_MECHANIC_FLAGS_HEALTH].label:SetDimensions(
        UnitFrames.SV.CompanionWidth - 50,
        UnitFrames.SV.CompanionHeight - 2
    )
...
function UnitFrames.CustomFramesApplyLayoutPet(unhide)
    ...
    for i = 1, 7 do
        ...
        unitFrame.name:SetDimensions(
            UnitFrames.SV.PetWidth - UnitFrames.SV.PetNameClip - 10,
            UnitFrames.SV.PetHeight - 2
        )
        unitFrame.name:SetAnchor(LEFT, shb, LEFT, 5, 0)

        unitFrame[COMBAT_MECHANIC_FLAGS_HEALTH].label:SetDimensions(
            UnitFrames.SV.PetWidth - 50,
            UnitFrames.SV.PetHeight - 2
        )
    end
    if unhide then
...
function UnitFrames.CustomFramesApplyLayoutBosses()
    ...
    for i = 1, 6 do
        ...
        unitFrame[COMBAT_MECHANIC_FLAGS_HEALTH].label:SetDimensions(
            UnitFrames.SV.BossBarWidth - 50,
            UnitFrames.SV.BossBarHeight - 2
        )
    end
...
function UnitFrames.CustomFramesGroupAlpha()
    ...
    for i = 1, 4 do
        ...
        if UnitFrames.CustomFrames[unitTag] then
            UnitFrames.CustomFrames[unitTag].control:SetAlpha(
                IsUnitInGroupSupportRange(UnitFrames.CustomFrames[unitTag].unitTag) and alphaGroup or (alphaGroup / 2)
            )
        end
    end
...
function UnitFrames.CustomFramesReloadExecuteMenu()
    ...
    if
        UnitFrames.CustomFrames["reticleover"] and UnitFrames.CustomFrames["reticleover"][COMBAT_MECHANIC_FLAGS_HEALTH]
    then

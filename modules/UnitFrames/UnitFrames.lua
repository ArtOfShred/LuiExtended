...
UF.D = {
    ...
    Format                           = GetString(SI_LUIE_LAM_UF_SHARED_LABEL_CURRSHIELDPERCENT),
    ...
    CustomFormatOnePT                = GetString(SI_LUIE_LAM_UF_SHARED_LABEL_CURRSHIELDMAX),
    CustomFormatOneGroup             = GetString(SI_LUIE_LAM_UF_SHARED_LABEL_CURRSHIELDMAX),
    CustomFormatTwoPT                = GetString(SI_LUIE_LAM_UF_SHARED_LABEL_PERCENT),
    CustomFormatTwoGroup             = GetString(SI_LUIE_LAM_UF_SHARED_LABEL_PERCENT),
    CustomFormatRaid                 = GetString(SI_LUIE_LAM_UF_SHARED_LABEL_CURRPERCENT),
    CustomFormatBoss                 = GetString(SI_LUIE_LAM_UF_SHARED_LABEL_PERCENT),

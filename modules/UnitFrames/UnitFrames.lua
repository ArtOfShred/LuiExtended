...
local strResSelf = GetString(LUIE_UF_DEAD_STATUS_REVIVING)
local strResPending = GetString(SI_PLAYER_TO_PLAYER_RESURRECT_HAS_RESURRECT_PENDING)
local strResCastRaid = GetString(LUIE_UF_DEAD_STATUS_RES_SHORTHAND)
local strResPendingRaid = GetString(LUIE_UF_DEAD_STATUS_RES_PENDING_SHORTHAND)
...
function UnitFrames.ClearCustomList(list)
    local listRef = list == UnitFrames.SV.whitelist and GetString(LUIE_CUSTOM_LIST_UF_WHITELIST) or ""
...
function UnitFrames.AltBar_OnMouseEnterWerewolf(control)
    local function UpdateWerewolfPower()
        ...
        InformationTooltip:AddLine(zo_strformat(LUIE_UF_WEREWOLF_POWER, currentPower, maxPower, percentagePower))
    end
    UpdateWerewolfPower()
...
function UnitFrames.AltBar_OnMouseEnterMounted(control)
    local function UpdateMountPower()
        ...
        SetTooltipText(InformationTooltip, zo_strformat(LUIE_SKILL_MOUNTED))
        InformationTooltip:AddLine(zo_strformat(LUIE_UF_MOUNT_POWER, currentPower, maxPower, percentagePower))
    end
    UpdateMountPower()
...
function UnitFrames.AltBar_OnMouseEnterSiege(control)
    local function UpdateSiegePower()
        ...
        InformationTooltip:AddLine(zo_strformat(LUIE_UF_SIEGE_POWER, ZO_CommaDelimitNumber(currentPower), ZO_CommaDelimitNumber(maxPower), percentagePower))
    end
    UpdateSiegePower()

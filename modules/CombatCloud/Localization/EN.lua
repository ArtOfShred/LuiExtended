...
---------------------------------------------------------------------------------------------------------------------------------------
    ...
    --Damage & Healing
		...
		colorIncomingDamage                 = "Override Incoming Damage Color",
        damageType = {
    ...
    --Tooltips damage & healing
		...
		tooltipColorIncomingDamage          = "Override incoming damage color",
		...
		tooltipIncomingDamageOverride       = "Show override incoming damage color",
        tooltipDamageType = {

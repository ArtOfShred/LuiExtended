...
local function MillisecondTimestampDebug(message)
    ...
    local timestamp = FormatTimeMilliseconds(
        currentTime,
...
function SpellCastBuffs.EventCombatDebug(
    eventCode,
    result,
    isError,
    abilityName,
...
function SpellCastBuffs.EventEffectDebug(
    eventCode,
    changeType,
    effectSlot,
    effectName,
...
function SpellCastBuffs.AuthorCombatDebug(
    eventCode,
    result,
    isError,
    abilityName,
...
-- Account specific DEBUG for ArtOfShred (These are only registered to give me some additional debug options)
function SpellCastBuffs.AuthorEffectDebug(
    eventCode,
    changeType,
    effectSlot,
    effectName,

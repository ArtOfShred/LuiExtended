...
local windowTitles = {
    playerb = GetString(LUIE_SCB_WINDOWTITLE_PLAYERBUFFS),
    playerd = GetString(LUIE_SCB_WINDOWTITLE_PLAYERDEBUFFS),
    player1 = GetString(LUIE_SCB_WINDOWTITLE_PLAYERBUFFS),
    player2 = GetString(LUIE_SCB_WINDOWTITLE_PLAYERDEBUFFS),
    player_long = GetString(LUIE_SCB_WINDOWTITLE_PLAYERLONGTERMEFFECTS),
    targetb = GetString(LUIE_SCB_WINDOWTITLE_TARGETBUFFS),
    targetd = GetString(LUIE_SCB_WINDOWTITLE_TARGETDEBUFFS),
    target1 = GetString(LUIE_SCB_WINDOWTITLE_TARGETBUFFS),
    target2 = GetString(LUIE_SCB_WINDOWTITLE_TARGETDEBUFFS),
    prominentbuffs = GetString(LUIE_SCB_WINDOWTITLE_PROMINENTBUFFS),
    prominentdebuffs = GetString(LUIE_SCB_WINDOWTITLE_PROMINENTDEBUFFS),
}
...
local function UpdateEffectOnSkillUpdate(overrideRank, casterUnitTag)
    -- Mages Guild
    Effects.EffectOverride[40465].tooltip = zo_strformat(GetString(LUIE_SKILL_SCALDING_RUNE_TP), (GetAbilityDuration(40468, overrideRank, casterUnitTag) / 1000) + GetNumPassiveSkillRanks(GetSkillLineIndicesFromSkillLineId(44), select(2, GetSkillLineIndicesFromSkillLineId(44)), 8))
end
...
function SpellCastBuffs.ClearCustomList(list)
    local listRef = list == SpellCastBuffs.SV.PromBuffTable and GetString(LUIE_SCB_WINDOWTITLE_PROMINENTBUFFS) or list == SpellCastBuffs.SV.PromDebuffTable and GetString(LUIE_SCB_WINDOWTITLE_PROMINENTDEBUFFS) or list == SpellCastBuffs.SV.PriorityBuffTable and GetString(LUIE_CUSTOM_LIST_PRIORITY_BUFFS) or list == SpellCastBuffs.SV.PriorityDebuffTable and GetString(LUIE_CUSTOM_LIST_PRIORITY_DEBUFFS) or list == SpellCastBuffs.SV.BlacklistTable and GetString(LUIE_CUSTOM_LIST_AURA_BLACKLIST) or ""

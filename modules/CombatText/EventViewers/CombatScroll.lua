...
function CombatTextCombatScrollEventViewer:OnEvent(
    combatType,
    powerType,
    value,
    abilityName,
...
function CombatTextCombatScrollEventViewer:ViewFromEventBuffer(
    combatType,
    powerType,
    eventKey,
    abilityName,
...
function CombatTextCombatScrollEventViewer:View(
    combatType,
    powerType,
    value,
    abilityName,

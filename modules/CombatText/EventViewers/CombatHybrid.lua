...
function CombatTextCombatHybridEventViewer:New(...)
    ...
    self.eventBuffer = {}
    self.activeControls =
        { [CombatTextConstants.combatType.OUTGOING] = {}, [CombatTextConstants.combatType.INCOMING] = {} }
    self.lastControl = {}
    return obj
end

function CombatTextCombatHybridEventViewer:OnEvent(
    combatType,
    powerType,
    value,
    abilityName,
    ...
    if Settings.animation.animationType ~= "hybrid" then
        return
    end
...
function CombatTextCombatHybridEventViewer:ViewFromEventBuffer(
    combatType,
    powerType,
    eventKey,
    abilityName,
...
function CombatTextCombatHybridEventViewer:View(
    combatType,
    powerType,
    value,
    abilityName,
    ...
    if isDamageCritical or isHealingCritical or isDotCritical or isHotCritical then
        offsetX = math.random(-radiusW, radiusW)

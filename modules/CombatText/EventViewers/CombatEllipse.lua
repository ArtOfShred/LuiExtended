...
function CombatTextCombatEllipseEventViewer:OnEvent(
    combatType,
    powerType,
    value,
    abilityName,
...
function CombatTextCombatEllipseEventViewer:ViewFromEventBuffer(
    combatType,
    powerType,
    eventKey,
    abilityName,
...
function CombatTextCombatEllipseEventViewer:View(
    combatType,
    powerType,
    value,
    abilityName,

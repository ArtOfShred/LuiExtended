...
CombatInfo.Defaults =
{
    ...
    UltimateFontFace = "ArchivoNarrow Bold",
    ...
    BarLabelPosition = -20,
    BarFontFace = "ArchivoNarrow Bold",
    ...
    PotionTimerFontFace = "ArchivoNarrow Bold",
    ...
    CastBarLabel = true,
    CastBarTimer = true,
    CastBarFontFace = "ArchivoNarrow Bold",
    ...
    alerts =
    {
        ...
        {
            alertEnable = true,
            alertFontFace = "ArchivoNarrow Bold",

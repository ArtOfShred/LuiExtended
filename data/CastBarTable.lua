...
--------------------------------------------------------------------------------------------------------------------------------
--  Allow these abilities to interrupt themselves if a new event begins (in cases when the player might accidentally stutterstep placing siege for example
--------------------------------------------------------------------------------------------------------------------------------
CBT.AllowRecast = {
	...
	-- Misc Items
	[63427] = true, -- Clean Fish (Create furniture station) -- TODO: CHECK
    [78052] = true, -- Minor Pardon (Counterfeit Pardon Edict)
    [76350] = true, -- Moderate Pardon (Leniency Edict)
    [76349] = true, -- Full Pardon (Grand Amnesty Edict)
	
	-- Seasonal Mementos and Items
    [86792] = true, -- Eating (High Hrothgar Festival Mints) -- TODO: CHECK
    [86739] = true, -- Drinking (Sailor's Warning Festival Grog) -- TODO: CHECK

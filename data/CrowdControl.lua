...
CrowdControl.aoePlayerNormal = {
    ...
    [183122] = 0,   -- Pragmatic Fatecarver (Pragmatic Fatecarver, Area)
    [184291] = 0,   -- Exhausting Fatecarver (Exhausting Fatecarver, Snare)
    [20183122] = 0, -- Pragmatic Fatecarver (Pragmatic Fatecarver, Area)
    [30183122] = 0, -- Pragmatic Fatecarver (Pragmatic Fatecarver, Area)
    [40183122] = 0, -- Pragmatic Fatecarver (Pragmatic Fatecarver, Area)

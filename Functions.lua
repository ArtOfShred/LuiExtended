...
function LUIE.UpdateMundusTooltipSyntax(abilityId, tooltipText)
    ...
    if abilityId == 13976 or abilityId == 13981 then -- The Lady / The Lover
        tooltipText = string.gsub(
            tooltipText,
            GetString(SI_LUIE_SKILL_MUNDUS_SUB_RES_PEN),
            GetString(SI_LUIE_SKILL_MUNDUS_SUB_RES_PEN_REPLACE)
        )
    elseif abilityId == 13975 then -- The Thief
        tooltipText = string.gsub(
            tooltipText,
            GetString(SI_LUIE_SKILL_MUNDUS_SUB_THIEF),
            GetString(SI_LUIE_SKILL_MUNDUS_SUB_THIEF_REPLACE)
        )
    end
    -- Replace "Increases your" with "Increase"
    tooltipText =
        string.gsub(tooltipText, GetString(SI_LUIE_SKILL_MUNDUS_STRING), GetString(SI_LUIE_SKILL_DRINK_INCREASE))
    return tooltipText
end

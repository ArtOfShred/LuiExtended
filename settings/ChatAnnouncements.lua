...
function ChatAnnouncements.CreateSettings()
    ...
    local panelDataChatAnnouncements = {
        type = "panel",
        name = zo_strformat("<<1>> - <<2>>", LUIE.name, GetString(LUIE_LAM_CA)),
        displayName = zo_strformat("<<1>> <<2>>", LUIE.name, GetString(LUIE_LAM_CA)),
        author = LUIE.author .. "\n",
    ...
    optionsDataChatAnnouncements[#optionsDataChatAnnouncements+1] = {
        type = "description",
        text = GetString(LUIE_LAM_CA_DESCRIPTION),
    }
    ...
    optionsDataChatAnnouncements[#optionsDataChatAnnouncements+1] = {
        type = "submenu",
        name = GetString(LUIE_LAM_CA_CHATHEADER),
        controls = {
            {
                -- Player Name Display Method
                type = "dropdown",
                name = GetString(LUIE_LAM_CA_NAMEDISPLAYMETHOD),
                tooltip = GetString(LUIE_LAM_CA_NAMEDISPLAYMETHOD_TP),
            ...
            },
            {
                ...
                type = "dropdown",
                name = GetString(LUIE_LAM_CA_BRACKET_OPTION_CHARACTER),
                tooltip = GetString(LUIE_LAM_CA_BRACKET_OPTION_CHARACTER_TP),
            ...
            },
            {
                ...
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_CHATBYPASS),
                tooltip = GetString(LUIE_LAM_CA_CHATBYPASS_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "dropdown",
                name = GetString(LUIE_LAM_CA_CHATMETHOD),
                tooltip = GetString(LUIE_LAM_CA_CHATMETHOD_TP),
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_CHATTAB), "1"),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_CHATTAB_TP), "1"),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_CHATTAB), "2"),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_CHATTAB_TP), "2"),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_CHATTAB), "3"),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_CHATTAB_TP), "3"),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_CHATTAB), "4"),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_CHATTAB_TP), "4"),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_CHATTAB), "5"),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_CHATTAB_TP), "5"),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CHATTABSYSTEMALL)),
                tooltip = GetString(LUIE_LAM_CA_CHATTABSYSTEMALL_TP),
                getFunc = function ()
            ...
            },
            {
                -- Include Timestamp
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_TIMESTAMP),
                tooltip = GetString(LUIE_LAM_CA_TIMESTAMP_TP),
                getFunc = function ()
            ...
            },
            {
                -- Timestamp Format
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_TIMESTAMPFORMAT)),
                tooltip = GetString(LUIE_LAM_CA_TIMESTAMPFORMAT_TP),
                getFunc = function ()
            ...
            },
            {
                -- Timestamp Color
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_TIMESTAMPCOLOR)),
                tooltip = GetString(LUIE_LAM_CA_TIMESTAMPCOLOR_TP),
                getFunc = function ()
    ...
    optionsDataChatAnnouncements[#optionsDataChatAnnouncements+1] = {
        type = "submenu",
        name = GetString(LUIE_LAM_CA_CURRENCY_HEADER),
        controls = {
            {
                -- Show Currency Icons
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_SHOWICONS),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_SHOWICONS_TP),
                getFunc = function ()
            ...
            },
            {
                -- Show Gold
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_GOLD),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_GOLD_TP),
                getFunc = function ()
            ...
            },
            {
                -- Show Gold Color
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_GOLDCOLOR)),
                getFunc = function ()
            ...
            },
            {
                -- Show Gold Name
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_GOLDNAME)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_GOLDNAME_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_GOLDTOTAL)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_GOLDTOTAL_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_GOLDTOTAL_MSG)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_GOLDTOTAL_MSG_TP),
                getFunc = function ()
            ...
            },
            {
                -- Show Gold Threshold
                type = "slider",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_GOLDTHRESHOLD)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_GOLDTHRESHOLD_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_GOLDTHROTTLE)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_GOLDTHROTTLE_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_HIDEGOLDAHLIST)),
                tooltip = zo_strformat("<<1>>", GetString(LUIE_LAM_CA_CURRENCY_HIDEGOLDAHLIST_TP)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_HIDEGOLDAHSPENT)),
                tooltip = zo_strformat("<<1>>", GetString(LUIE_LAM_CA_CURRENCY_HIDEGOLDAHSPENT_TP)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_SHOWAP),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_SHOWAP_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_SHOWAPCOLOR)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_SHOWAPNAME)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_SHOWAPNAME_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_SHOWAPTOTAL)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_SHOWAPTOTAL_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_APTOTAL_MSG)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_APTOTAL_MSG_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "slider",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_SHOWAPTHRESHOLD)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_SHOWAPTHRESHOLD_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "slider",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_SHOWAPTHROTTLE)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_SHOWAPTHROTTLE_TP),
                getFunc = function ()
            ...
            },
            {
                -- Show Tel Var
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_SHOWTV),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_SHOWTV_TP),
                getFunc = function ()
            ...
            },
            {
                -- Show Tel Var Color
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_SHOWTVCOLOR)),
                getFunc = function ()
            ...
            },
            {
                -- Show Tel Var Name
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_SHOWTVNAME)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_SHOWTVNAME_TP),
                getFunc = function ()
            ...
            },
            {
                -- Show Tel Var Total
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_SHOWTVTOTAL)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_SHOWTVTOTAL_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_TVTOTAL_MSG)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_TVTOTAL_MSG_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "slider",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_SHOWTVTHRESHOLD)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_SHOWTVTHRESHOLD_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "slider",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_SHOWTVTHROTTLE)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_SHOWTVTHROTTLE_TP),
                getFunc = function ()
            ...
            },
            {
                -- Show Writ Vouchers
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_SHOWVOUCHER),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_SHOWVOUCHER_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_SHOWVOUCHERCOLOR)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_SHOWVOUCHERNAME)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_SHOWVOUCHERNAME_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_SHOWVOUCHERTOTAL)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_SHOWVOUCHERTOTAL_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_WVTOTAL_MSG)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_WVTOTAL_MSG_TP),
                getFunc = function ()
            ...
            },
            {
                -- Show Undaunted Keys
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_SHOWUNDAUNTED),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_SHOWUNDAUNTED_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_SHOWUNDAUNTEDCOLOR)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_SHOWUNDAUNTEDNAME)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_SHOWUNDAUNTEDNAME_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_SHOWUNDAUNTEDTOTAL)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_SHOWUNDAUNTEDTOTAL_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_UNDAUNTEDTOTAL_MSG)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_UNDAUNTEDTOTAL_MSG_TP),
                getFunc = function ()
            ...
            },
            {
                -- Show Endless Keys
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_SHOWENDLESS),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_SHOWENDLESS_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_SHOWENDLESSCOLOR)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_SHOWENDLESSNAME)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_SHOWENDLESSNAME_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_SHOWENDLESSTOTAL)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_SHOWENDLESSTOTAL_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_ENDLESSTOTAL_MSG)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_ENDLESSTOTAL_MSG_TP),
                getFunc = function ()
            ...
            },
            {
                -- Show Outfit Tokens
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_SHOWTOKENS),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_SHOWTOKENS_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_SHOWTOKENSCOLOR)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_SHOWTOKENSNAME)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_SHOWTOKENSNAME_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_SHOWTOKENSTOTAL)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_SHOWTOKENSTOTAL_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_TOKENSTOTAL_MSG)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_TOKENSTOTAL_MSG_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_SHOWTRANSMUTE),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_SHOWTRANSMUTE_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_SHOWTRANSMUTECOLOR)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_SHOWTRANSMUTENAME)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_SHOWTRANSMUTENAME_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_SHOWTRANSMUTETOTAL)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_SHOWTRANSMUTETOTAL_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_TRANSMUTETOTAL_MSG)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_TRANSMUTETOTAL_MSG_TP),
                getFunc = function ()
            ...
            },
            {
                -- Show Event Tickets
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_SHOWEVENT),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_SHOWEVENT_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_SHOWEVENTCOLOR)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_SHOWEVENTNAME)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_SHOWEVENTNAME_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_SHOWEVENTTOTAL)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_SHOWEVENTTOTAL_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_EVENTTOTAL_MSG)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_EVENTTOTAL_MSG_TP),
                getFunc = function ()
            ...
            },
            {
                -- Show Crowns
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_SHOWCROWNS),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_SHOWCROWNS_TP),
                getFunc = function ()
            ...
            },
            {
                -- Show Crowns Color
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_SHOWCROWNSCOLOR)),
                getFunc = function ()
            ...
            },
            {
                -- Show Crowns Name
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_SHOWCROWNSNAME)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_SHOWCROWNSNAME_TP),
                getFunc = function ()
            ...
            },
            {
                -- Show Crowns Total
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_SHOWCROWNSTOTAL)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_SHOWCROWNSTOTAL_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_CROWNSTOTAL_MSG)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_CROWNSTOTAL_MSG_TP),
                getFunc = function ()
            ...
            },
            {
                -- Show Crown Gems
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_SHOWCROWNGEMS),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_SHOWCROWNGEMS_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_SHOWCROWNGEMSCOLOR)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_SHOWCROWNGEMSNAME)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_SHOWCROWNGEMSNAME_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_SHOWCROWNGEMSTOTAL)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_SHOWCROWNGEMSTOTAL_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_CROWNGEMSTOTAL_MSG)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_CROWNGEMSTOTAL_MSG_TP),
                getFunc = function ()
...

            {
                -- Show Endeavors
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_SHOWENDEAVORS),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_SHOWENDEAVORS_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_SHOWENDEAVORSCOLOR)),
                getFunc = function ()
            ...
            },
            {
                -- Show Endeavors Name
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_SHOWENDEAVORSNAME)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_SHOWENDEAVORSNAME_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_SHOWENDEAVORSTOTAL)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_SHOWENDEAVORSTOTAL_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_ENDEAVORSTOTAL_MSG)),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_ENDEAVORSTOTAL_MSG_TP),
                getFunc = function ()
    ...
    optionsDataChatAnnouncements[#optionsDataChatAnnouncements+1] = {
        type = "submenu",
        name = GetString(LUIE_LAM_CA_LOOT_HEADER),
        controls = {
            {
                -- Item Link Bracket
                type = "dropdown",
                name = GetString(LUIE_LAM_CA_BRACKET_OPTION_ITEM),
                tooltip = GetString(LUIE_LAM_CA_BRACKET_OPTION_ITEM_TP),
                choices = linkBracketDisplayOptions,
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_LOOT_SHOWICONS),
                tooltip = GetString(LUIE_LAM_CA_LOOT_SHOWICONS_TP),
                getFunc = function ()
            ...
            },
            {
                -- Show Armor Type
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_LOOT_SHOWARMORTYPE),
                tooltip = GetString(LUIE_LAM_CA_LOOT_SHOWARMORTYPE_TP),
                getFunc = function ()
            ...
            },
            {
                -- Show Item Style
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_LOOT_SHOWITEMSTYLE),
                tooltip = GetString(LUIE_LAM_CA_LOOT_SHOWITEMSTYLE_TP),
                getFunc = function ()
            ...
            },
            {
                -- Show Item Trait
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_LOOT_SHOWITEMTRAIT),
                tooltip = GetString(LUIE_LAM_CA_LOOT_SHOWITEMTRAIT_TP),
                getFunc = function ()
            ...
            },
            {
                -- Show loot total
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_LOOT_TOTAL),
                tooltip = GetString(LUIE_LAM_CA_LOOT_TOTAL_TP),
                getFunc = function ()
            ...
            },
            {
                -- Loot total string
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_LOOT_TOTALSTRING)),
                tooltip = GetString(LUIE_LAM_CA_LOOT_TOTALSTRING_TP),
                getFunc = function ()
            ...
            },
            {
                -- Show looted items
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_LOOT_SHOWITEMS),
                tooltip = GetString(LUIE_LAM_CA_LOOT_SHOWITEMS_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_LOOT_LOOTLOGDISABLE)),
                tooltip = GetString(LUIE_LAM_CA_LOOT_LOOTLOGDISABLE_TP),
                getFunc = function ()
            ...
            },
            {
                -- Show notable loot
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_LOOT_SHOWNOTABLE)),
                tooltip = GetString(LUIE_LAM_CA_LOOT_SHOWNOTABLE_TP),
                getFunc = function ()
            ...
            },
            {
                -- Show group loot
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_LOOT_SHOWGRPLOOT)),
                tooltip = GetString(LUIE_LAM_CA_LOOT_SHOWGRPLOOT_TP),
                getFunc = function ()
            ...
            },
            {
                -- Hide annoying items
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_LOOT_HIDEANNOYINGITEMS)),
                tooltip = GetString(LUIE_LAM_CA_LOOT_HIDEANNOYINGITEMS_TP),
                getFunc = function ()
                ...
                width = "full",
                warning = GetString(LUIE_LAM_CA_LOOT_HIDEANNOYINGITEMS_WARNING),
                disabled = function ()
                    return not (Settings.Inventory.Loot and LUIE.SV.ChatAnnouncements_Enable)
                end,
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_LOOT_HIDETRASH)),
                tooltip = GetString(LUIE_LAM_CA_LOOT_HIDETRASH_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_LOOT_LOOTCONFISCATED)),
                tooltip = GetString(LUIE_LAM_CA_LOOT_LOOTCONFISCATED_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_LOOT_LOOTSHOWCONTAINER)),
                tooltip = GetString(LUIE_LAM_CA_LOOT_LOOTSHOWCONTAINER_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_LOOT_LOOTSHOWDESTROYED)),
                tooltip = GetString(LUIE_LAM_CA_LOOT_LOOTSHOWDESTROYED_TP),
                getFunc = function ()
            ...
            },
            {
                -- Show Removed Items
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_LOOT_LOOTSHOWREMOVED)),
                tooltip = GetString(LUIE_LAM_CA_LOOT_LOOTSHOWREMOVED_TP),
                getFunc = function ()
            ...
            },
            {
                -- Show List Items
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_LOOT_LOOTSHOWLIST)),
                tooltip = GetString(LUIE_LAM_CA_LOOT_LOOTSHOWLIST_TP),
                getFunc = function ()
            ...
            },
            {
                -- Show Turnin Items
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_LOOT_LOOTSHOWTURNIN)),
                tooltip = GetString(LUIE_LAM_CA_LOOT_LOOTSHOWTURNIN_TP),
                getFunc = function ()
            ...
            },
            {
                -- Show Use Potion
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_LOOT_LOOTSHOWUSE_POTION)),
                tooltip = GetString(LUIE_LAM_CA_LOOT_LOOTSHOWUSE_POTION_TP),
                getFunc = function ()
            ...
            },
            {
                -- Show Use Food
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_LOOT_LOOTSHOWUSE_FOOD)),
                tooltip = GetString(LUIE_LAM_CA_LOOT_LOOTSHOWUSE_FOOD_TP),
                getFunc = function ()
            ...
            },
            {
                -- Show Use Drink
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_LOOT_LOOTSHOWUSE_DRINK)),
                tooltip = GetString(LUIE_LAM_CA_LOOT_LOOTSHOWUSE_DRINK_TP),
                getFunc = function ()
            ...
            },
            {
                -- Show Use Repair Kit
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_LOOT_LOOTSHOWUSE_REPAIR_KIT)),
                tooltip = GetString(LUIE_LAM_CA_LOOT_LOOTSHOWUSE_REPAIR_KIT_TP),
                getFunc = function ()
            ...
            },
            {
                -- Show Use Soul Gem
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_LOOT_LOOTSHOWUSE_SOUL_GEM)),
                tooltip = GetString(LUIE_LAM_CA_LOOT_LOOTSHOWUSE_SOUL_GEM_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_LOOT_LOOTSHOWUSE_SIEGE)),
                tooltip = GetString(LUIE_LAM_CA_LOOT_LOOTSHOWUSE_SIEGE_TP),
                getFunc = function ()
            ...
            },
            {
                -- Show Use Misc
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_LOOT_LOOTSHOWUSE_MISC)),
                tooltip = GetString(LUIE_LAM_CA_LOOT_LOOTSHOWUSE_MISC_TP),
                getFunc = function ()
            ...
            },
            {
                -- Show Lockpick Break
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_LOOT_LOOTSHOWLOCKPICK)),
                tooltip = GetString(LUIE_LAM_CA_LOOT_LOOTSHOWLOCKPICK_TP),
                getFunc = function ()
            ...
            },
            {
                -- Show Use RECIPE
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_LOOT_LOOTRECIPE)),
                tooltip = GetString(LUIE_LAM_CA_LOOT_LOOTRECIPE_TP),
                getFunc = function ()
            ...
            },
            {
                -- Show Use MOTIF
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_LOOT_LOOTMOTIF)),
                tooltip = GetString(LUIE_LAM_CA_LOOT_LOOTMOTIF_TP),
                getFunc = function ()
            ...
            },
            {
                -- Show Use STYLE
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_LOOT_LOOTSTYLE)),
                tooltip = GetString(LUIE_LAM_CA_LOOT_LOOTSTYLE_TP),
                getFunc = function ()
            ...
            },
            {
                -- Hide Recipe Alert
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_LOOT_HIDE_RECIPE_ALERT)),
                tooltip = GetString(LUIE_LAM_CA_LOOT_HIDE_RECIPE_ALERT_TP),
                getFunc = function ()
            ...
            },
            {
                -- Show Quest Loot (Add)
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_LOOT_SHOWQUESTADD),
                tooltip = GetString(LUIE_LAM_CA_LOOT_SHOWQUESTADD_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_LOOT_SHOWQUESTREM),
                tooltip = GetString(LUIE_LAM_CA_LOOT_SHOWQUESTREM_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_LOOT_SHOWVENDOR),
                tooltip = GetString(LUIE_LAM_CA_LOOT_SHOWVENDOR_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_LOOT_VENDOR_MERGE)),
                tooltip = GetString(LUIE_LAM_CA_LOOT_VENDOR_MERGE_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_LOOT_VENDOR_TOTALITEMS)),
                tooltip = GetString(LUIE_LAM_CA_LOOT_VENDOR_TOTALITEMS_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_LOOT_VENDOR_TOTALCURRENCY)),
                tooltip = GetString(LUIE_LAM_CA_LOOT_VENDOR_TOTALCURRENCY_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_LOOT_SHOWBANK),
                tooltip = GetString(LUIE_LAM_CA_LOOT_SHOWBANK_TP),
                getFunc = function ()
            ...
            },
            {
                -- Show Craft
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_LOOT_SHOWCRAFT),
                tooltip = GetString(LUIE_LAM_CA_LOOT_SHOWCRAFT_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_LOOT_SHOWCRAFT_MATERIALS)),
                tooltip = GetString(LUIE_LAM_CA_LOOT_SHOWCRAFT_MATERIALS_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_LOOT_SHOWMAIL),
                tooltip = GetString(LUIE_LAM_CA_LOOT_SHOWMAIL_TP),
                getFunc = function ()
            ...
            },
            {
                -- Show Trade
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_LOOT_SHOWTRADE),
                tooltip = GetString(LUIE_LAM_CA_LOOT_SHOWTRADE_TP),
                getFunc = function ()
            ...
            },
            {
                -- Show Disguise Equip
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_LOOT_LOOTSHOWDISGUISE),
                tooltip = GetString(LUIE_LAM_CA_LOOT_LOOTSHOWDISGUISE_TP),
                getFunc = function ()
    ...
    optionsDataChatAnnouncements[#optionsDataChatAnnouncements+1] = {
        type = "submenu",
        name = GetString(LUIE_LAM_CA_CURRENCY_CONTEXT_MENU),
        controls = {
            {
                -- Currency/Loot Message Color
                type = "colorpicker",
                name = GetString(LUIE_LAM_CA_CURRENCY_COLOR),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_COLOR_CONTEXT),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_COLOR_CONTEXT_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_COLORUP)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_CURRENCY_COLORDOWN)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_COLOR_CONTEXT_MERGED),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_COLOR_CONTEXT_MERGED_TP),
                getFunc = function ()
...

            {
                ...
                type = "header",
                name = GetString(LUIE_LAM_CA_CURRENCY_CONTEXT_HEADER),
                width = "full",
            },
            {
                -- Loot Message (Loot)
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_LOOT),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_LOOT_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_RECEIVE),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_RECEIVE_TP),
                getFunc = function ()
            ...
            },
            {
                -- Earned Message
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_EARN),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_EARN_TP),
                getFunc = function ()
            ...
            },
            {
                -- Loot Message (Steal)
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_STEAL),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_STEAL_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_PICKPOCKET),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_PICKPOCKET_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_CONFISCATE),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_CONFISCATE_TP),
                getFunc = function ()
            ...
            },
            {
                -- Loot Message (Spend)
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_SPEND),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_SPEND_TP),
                getFunc = function ()
            ...
            },
            {
                -- Loot Message (Pay)
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_PAY),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_PAY_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_USEKIT),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_USEKIT_TP),
                getFunc = function ()
            ...
            },
            {
                -- Loot Message (Potion)
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_POTION),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_POTION_TP),
                getFunc = function ()
            ...
            },
            {
                -- Loot Message (Food)
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_FOOD),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_FOOD_TP),
                getFunc = function ()
            ...
            },
            {
                -- Loot Message (Drink)
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_DRINK),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_DRINK_TP),
                getFunc = function ()
            ...
            },
            {
                -- Loot Message (Deploy)
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_DEPLOY),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_DEPLOY_TP),
                getFunc = function ()
            ...
            },
            {
                -- Loot Message (Stow)
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_STOW),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_STOW_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_LEARN_RECIPE),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_LEARN_RECIPE_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_LEARN_MOTIF),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_LEARN_MOTIF_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_LEARN_STYLE),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_LEARN_STYLE_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_EXCAVATE),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_EXCAVATE_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_TRADEIN),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_TRADEIN_TP),
                getFunc = function ()
            ...
            },
            {
                -- Loot Message (TradeIn)
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_TRADEIN_NO_NAME),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_TRADEIN_NO_NAME_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_TRADEOUT),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_TRADEOUT_TP),
                getFunc = function ()
            ...
            },
            {
                -- Loot Message (TradeOut)
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_TRADEOUT_NO_NAME),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_TRADEOUT_NO_NAME_TP),
                getFunc = function ()
            ...
            },
            {
                -- Loot Message (MailIn)
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_MAILIN),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_MAILIN_TP),
                getFunc = function ()
            ...
            },
            {
                -- Loot Message (MailIn)
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_MAILIN_NO_NAME),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_MAILIN_NO_NAME_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_MAILOUT),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_MAILOUT_TP),
                getFunc = function ()
            ...
            },
            {
                -- Loot Message (MailOut)
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_MAILOUT_NO_NAME),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_MAILOUT_NO_NAME_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_DEPOSIT),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_DEPOSIT_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_WITHDRAW),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_WITHDRAW_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_DEPOSITGUILD),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_DEPOSITGUILD_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_WITHDRAWGUILD),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_WITHDRAWGUILD_TP),
                getFunc = function ()
            ...
            },
            {
                -- Loot Message (Deposit)
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_DEPOSITSTORAGE),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_DEPOSITSTORAGE_TP),
                getFunc = function ()
            ...
            },
            {
                -- Loot Message (Withdraw)
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_WITHDRAWSTORAGE),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_WITHDRAWSTORAGE_TP),
                getFunc = function ()
            ...
            },
            {
                -- Lost Message
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_LOST),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_LOST_TP),
                getFunc = function ()
            ...
            },
            {
                -- Bounty Message
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_BOUNTY),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_BOUNTY_TP),
                getFunc = function ()
            ...
            },
            {
                -- Repair Message
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_REPAIR),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_REPAIR_TP),
                getFunc = function ()
            ...
            },
            {
                -- Trader Message
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_TRADER),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_TRADER_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_LISTING),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_LISTING_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_LIST),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_LIST_TP),
                getFunc = function ()
...

            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_LISTING_VALUE),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_LISTING_VALUE_TP),
                getFunc = function ()
...

            {
                -- Loot Message (Buy)
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_BUY_VALUE),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_BUY_VALUE_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_BUY),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_BUY_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_BUYBACK_VALUE),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_BUYBACK_VALUE_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_BUYBACK),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_BUYBACK_TP),
                getFunc = function ()
            ...
            },
            {
                -- Loot Message (Sell)
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_SELL_VALUE),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_SELL_VALUE_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_SELL),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_SELL_TP),
                getFunc = function ()
            ...
            },
            {
                -- Loot Message (Fence)
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_FENCE_VALUE),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_FENCE_VALUE_TP),
                getFunc = function ()
            ...
            },
            {
                -- Loot Message (Fence)
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_FENCE),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_FENCE_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_LAUNDER_VALUE),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_LAUNDER_VALUE_TP),
                getFunc = function ()
            ...
            },
            {
                -- Loot Message (Launder)
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_LAUNDER),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_LAUNDER_TP),
                getFunc = function ()
            ...
            },
            {
                -- Stable Message
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_STABLE),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_STABLE_TP),
                getFunc = function ()
            ...
            },
            {
                -- Storage Message
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_STORAGE),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_STORAGE_TP),
                getFunc = function ()
            ...
            },
            {
                -- Wayshrine Message
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_WAYSHRINE),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_WAYSHRINE_TP),
                getFunc = function ()
            ...
            },
            {
                -- Unstuck Message
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_UNSTUCK),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_UNSTUCK_TP),
                getFunc = function ()
            ...
            },
            {
                -- Attributes Message
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_ATTRIBUTES),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_ATTRIBUTES_TP),
                getFunc = function ()
            ...
            },
            {
                -- Champion Message
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_CHAMPION),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_CHAMPION_TP),
                getFunc = function ()
            ...
            },
            {
                -- Morphs Message
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_MORPHS),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_MORPHS_TP),
                getFunc = function ()
            ...
            },
            {
                -- Skills Message
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_SKILLS),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_SKILLS_TP),
                getFunc = function ()
            ...
            },
            {
                -- Campaign Message
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_CAMPAIGN),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_CAMPAIGN_TP),
                getFunc = function ()
            ...
            },
            {
                -- Loot Message (Use)
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_USE),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_USE_TP),
                getFunc = function ()
            ...
            },
            {
                -- Loot Message (Craft)
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_CRAFT),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_CRAFT_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_EXTRACT),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_EXTRACT_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_UPGRADE),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_UPGRADE_TP),
                getFunc = function ()
            ...
            },
            {
                -- Loot Message (Upgrade)
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_UPGRADE_FAIL),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_UPGRADE_FAIL_TP),
                getFunc = function ()
            ...
            },
            {
                -- Loot Message (Refine)
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_REFINE),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_REFINE_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_DECONSTRUCT),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_DECONSTRUCT_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_RESEARCH),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_RESEARCH_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_DESTROY),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_DESTROY_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_CONTAINER),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_CONTAINER_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_LOCKPICK),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_LOCKPICK_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_REMOVE),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_REMOVE_TP),
                getFunc = function ()
...

            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_TURNIN),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_TURNIN_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_QUESTUSE),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_QUESTUSE_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_EXHAUST),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_EXHAUST_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_OFFER),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_OFFER_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_DISCARD),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_DISCARD_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_QUESTOPEN),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_QUESTOPEN_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_QUESTCONFISCATE),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_QUESTCONFISCATE_TP),
                getFunc = function ()
...

            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_QUESTADMINISTER),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_QUESTADMINISTER_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_QUESTPLACE),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_QUESTPLACE_TP),
                getFunc = function ()
...

            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_COMBINE),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_COMBINE_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_MIX),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_MIX_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_BUNDLE),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_BUNDLE_TP),
                getFunc = function ()
...

            {
                -- Loot Message Group
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_GROUP),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_GROUP_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_DISGUISE_EQUIP),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_DISGUISE_EQUIP_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_DISGUISE_REMOVE),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_DISGUISE_REMOVE_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_DISGUISE_DESTROY),
                tooltip = GetString(LUIE_LAM_CA_CURRENCY_MESSAGE_DISGUISE_DESTROY_TP),
                getFunc = function ()
    ...
    optionsDataChatAnnouncements[#optionsDataChatAnnouncements+1] = {
        type = "submenu",
        name = GetString(LUIE_LAM_CA_EXP_HEADER),
        controls = {
            {
                type = "header",
                name = GetString(LUIE_LAM_CA_EXP_HEADER_ENLIGHTENED),
                width = "full",
            },
            {
                -- Enlightenment (ChatAnnouncements)
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_EXP_ENLIGHTENED), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_EXP_ENLIGHTENED_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                -- Enlightenment (CSA)
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_EXP_ENLIGHTENED), GetString(LUIE_LAM_CA_SHARED_CSA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_EXP_ENLIGHTENED_TP), GetString(LUIE_LAM_CA_SHARED_CSA)),
                getFunc = function ()
            ...
            },
            {
                -- Enlightenment (Alert)
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_EXP_ENLIGHTENED), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_EXP_ENLIGHTENED_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            {
                type = "header",
                name = GetString(LUIE_LAM_CA_EXP_HEADER_LEVELUP),
                width = "full",
            },
            {
                -- Level Up (ChatAnnouncements)
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_EXP_LEVELUP), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_EXP_LEVELUP_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                -- Level Up (CSA)
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_EXP_LEVELUP), GetString(LUIE_LAM_CA_SHARED_CSA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_EXP_LEVELUP_TP), GetString(LUIE_LAM_CA_SHARED_CSA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_EXP_LEVELUP_CSAEXPAND)),
                tooltip = GetString(LUIE_LAM_CA_EXP_LEVELUP_CSAEXPAND_TP),
                getFunc = function ()
            ...
            },
            {
                -- Level Up (Alert)
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_EXP_LEVELUP), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_EXP_LEVELUP_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_EXP_LVLUPICON)),
                tooltip = GetString(LUIE_LAM_CA_EXP_LVLUPICON_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_EXPERIENCE_LEVELUP_COLOR)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_EXP_COLORLVLBYCONTEXT)),
                tooltip = GetString(LUIE_LAM_CA_EXP_COLORLVLBYCONTEXT_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "header",
                name = GetString(LUIE_LAM_CA_EXP_HEADER_EXPERIENCEGAIN),
                width = "full",
            },
            {
                -- Show Experience Gain
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_EXP_SHOWEXPGAIN),
                tooltip = GetString(LUIE_LAM_CA_EXP_SHOWEXPGAIN_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_EXP_SHOWEXPICON)),
                tooltip = GetString(LUIE_LAM_CA_EXP_SHOWEXPICON_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_EXPERIENCE_COLORMESSAGE)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_EXPERIENCE_COLORNAME)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_EXP_MESSAGE)),
                tooltip = GetString(LUIE_LAM_CA_EXP_MESSAGE_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_EXP_NAME)),
                tooltip = GetString(LUIE_LAM_CA_EXP_NAME_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_EXP_HIDEEXPKILLS)),
                tooltip = GetString(LUIE_LAM_CA_EXP_HIDEEXPKILLS_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "slider",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_EXP_EXPGAINTHRESHOLD)),
                tooltip = GetString(LUIE_LAM_CA_EXP_EXPGAINTHRESHOLD_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "slider",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_EXP_THROTTLEEXPINCOMBAT)),
                tooltip = GetString(LUIE_LAM_CA_EXP_THROTTLEEXPINCOMBAT_TP),
                getFunc = function ()
            ...
            },
            {
                -- Skill Points Header
                type = "header",
                name = GetString(LUIE_LAM_CA_EXP_HEADER_SKILL_POINTS),
                width = "full",
            },
            {
                -- Show Skill Points Updated ChatAnnouncements
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_SKILLPOINT_UPDATED), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_SKILLPOINT_UPDATED_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_SKILLPOINT_UPDATED), GetString(LUIE_LAM_CA_SHARED_CSA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_SKILLPOINT_UPDATED_TP), GetString(LUIE_LAM_CA_SHARED_CSA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_SKILLPOINT_UPDATED), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_SKILLPOINT_UPDATED_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                -- Skill Point Color 1
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_SKILLPOINT_COLOR1)),
                getFunc = function ()
            ...
            },
            {
                -- Skill Point Color 2
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_SKILLPOINT_COLOR2)),
                getFunc = function ()
            ...
            },
            {
                -- Skyshard Prefix
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_SKILLPOINT_PARTIALPREFIX)),
                tooltip = GetString(LUIE_LAM_CA_SKILLPOINT_PARTIALPREFIX_TP),
                getFunc = function ()
            ...
            },
            {
                -- Skyshard Brackets
                type = "dropdown",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_SKILLPOINT_PARTIALBRACKET)),
                tooltip = GetString(LUIE_LAM_CA_SKILLPOINT_PARTIALBRACKET_TP),
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_SKILLPOINT_UPDATEDPARTIAL)),
                tooltip = GetString(LUIE_LAM_CA_SKILLPOINT_UPDATEDPARTIAL_TP),
                getFunc = function ()
            ...
            },
            {
                -- Skill Lines Header
                type = "header",
                name = GetString(LUIE_LAM_CA_EXP_HEADER_SKILL_LINES),
                width = "full",
            },
            {
                -- Skill Line Unlocked ChatAnnouncements
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_SKILL_LINE_UNLOCKED), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_SKILL_LINE_UNLOCKED_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_SKILL_LINE_UNLOCKED), GetString(LUIE_LAM_CA_SHARED_CSA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_SKILL_LINE_UNLOCKED_TP), GetString(LUIE_LAM_CA_SHARED_CSA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_SKILL_LINE_UNLOCKED), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_SKILL_LINE_UNLOCKED_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                -- Skill Line Icon
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_SKILL_LINE_ICON)),
                tooltip = GetString(LUIE_LAM_CA_SKILL_LINE_ICON_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_SKILL_LINE_PROGRESS), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_SKILL_LINE_PROGRESS_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_SKILL_LINE_PROGRESS), GetString(LUIE_LAM_CA_SHARED_CSA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_SKILL_LINE_PROGRESS_TP), GetString(LUIE_LAM_CA_SHARED_CSA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_SKILL_LINE_PROGRESS), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_SKILL_LINE_PROGRESS_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_SKILL_LINE_ABILITY), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_SKILL_LINE_ABILITY_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_SKILL_LINE_ABILITY), GetString(LUIE_LAM_CA_SHARED_CSA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_SKILL_LINE_ABILITY_TP), GetString(LUIE_LAM_CA_SHARED_CSA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_SKILL_LINE_ABILITY), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_SKILL_LINE_ABILITY_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                -- Skill Line Color
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_SKILL_LINE_COLOR)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "header",
                name = GetString(LUIE_LAM_CA_EXP_HEADER_GUILDREP),
                width = "full",
            },
            {
                -- Display Guild Icon
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_GUILDREP_ICON),
                tooltip = GetString(LUIE_LAM_CA_GUILDREP_ICON_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "colorpicker",
                name = GetString(LUIE_LAM_CA_GUILDREP_MESSAGECOLOR),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_GUILDREP_MESSAGEFORMAT),
                tooltip = GetString(LUIE_LAM_CA_GUILDREP_MESSAGEFORMAT_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_GUILDREP_MESSAGENAME),
                tooltip = GetString(LUIE_LAM_CA_GUILDREP_MESSAGENAME_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_GUILDREP_FG),
                tooltip = GetString(LUIE_LAM_CA_GUILDREP_FG_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_GUILDREP_FG_COLOR)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "slider",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_GUILDREP_THRESHOLD)),
                tooltip = GetString(LUIE_LAM_CA_GUILDREP_THRESHOLD_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "slider",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_GUILDREP_THROTTLE)),
                tooltip = GetString(LUIE_LAM_CA_GUILDREP_THROTTLE_TP),
                getFunc = function ()
            ...
            },
            {
                -- Skill Mages Guild
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_GUILDREP_MG),
                tooltip = GetString(LUIE_LAM_CA_GUILDREP_MG_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_GUILDREP_MG_COLOR)),
                getFunc = function ()
            ...
            },
            {
                -- Skill Undaunted
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_GUILDREP_UD),
                tooltip = GetString(LUIE_LAM_CA_GUILDREP_UD_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_GUILDREP_UD_COLOR)),
                getFunc = function ()
            ...
            },
            {
                -- Skill Thieves Guild
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_GUILDREP_TG),
                tooltip = GetString(LUIE_LAM_CA_GUILDREP_TG_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_GUILDREP_TG_COLOR)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_GUILDREP_DB),
                tooltip = GetString(LUIE_LAM_CA_GUILDREP_DB_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_GUILDREP_DB_COLOR)),
                getFunc = function ()
            ...
            },
            {
                -- Skill Psijic Order
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_GUILDREP_PO),
                tooltip = GetString(LUIE_LAM_CA_GUILDREP_PO_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_GUILDREP_PO_COLOR)),
                getFunc = function ()
            ...
            },
            {
                -- Skill Guild Alert
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_GUILDREP_ALERT),
                tooltip = GetString(LUIE_LAM_CA_GUILDREP_ALERT_TP),
                getFunc = function ()
    ...
    optionsDataChatAnnouncements[#optionsDataChatAnnouncements+1] = {
        type = "submenu",
        name = GetString(LUIE_LAM_CA_COLLECTIBLE_HEADER),
        controls = {
            {
                --
                type = "header",
                name = GetString(LUIE_LAM_CA_COLLECTIBLE_COL_HEADER),
                width = "full",
            },
            {
                -- Show Collectibles Unlocked ChatAnnouncements
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_COLLECTIBLE_ENABLE), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_COLLECTIBLE_ENABLE_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_COLLECTIBLE_ENABLE), GetString(LUIE_LAM_CA_SHARED_CSA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_COLLECTIBLE_ENABLE_TP), GetString(LUIE_LAM_CA_SHARED_CSA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_COLLECTIBLE_ENABLE), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_COLLECTIBLE_ENABLE_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                -- Collectible Icon
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_COLLECTIBLE_ICON)),
                tooltip = GetString(LUIE_LAM_CA_COLLECTIBLE_ICON_TP),
                getFunc = function ()
            ...
            },
            {
                -- Collectible Bracket
                type = "dropdown",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_BRACKET_OPTION_COLLECTIBLE)),
                tooltip = GetString(LUIE_LAM_CA_BRACKET_OPTION_COLLECTIBLE_TP),
                choices = linkBracketDisplayOptions,
                getFunc = function ()
            ...
            },
            {
                -- Collectible Color 1
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_COLLECTIBLE_COLOR_ONE)),
                getFunc = function ()
            ...
            },
            {
                -- Collectible Color 2
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_COLLECTIBLE_COLOR_TWO)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_COLLECTIBLE_MESSAGEPREFIX)),
                tooltip = GetString(LUIE_LAM_CA_COLLECTIBLE_MESSAGEPREFIX_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "dropdown",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_COLLECTIBLE_BRACKET)),
                tooltip = GetString(LUIE_LAM_CA_COLLECTIBLE_BRACKET_TP),
                choices = bracketOptions5,
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_COLLECTIBLE_CATEGORY)),
                tooltip = GetString(LUIE_LAM_CA_COLLECTIBLE_CATEGORY_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_COLLECTIBLE_SUBCATEGORY)),
                tooltip = GetString(LUIE_LAM_CA_COLLECTIBLE_SUBCATEGORY_TP),
                getFunc = function ()
            ...
            },
            {
                -- Collectible Usage
                type = "header",
                name = GetString(LUIE_LAM_CA_COLLECTIBLE_USE_HEADER),
                width = "full",
            },
            {
                -- Collectible Used CA
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_COLLECTIBLE_USE_ENABLE), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_COLLECTIBLE_USE_ENABLE_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_COLLECTIBLE_USE_ENABLE), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_COLLECTIBLE_USE_ENABLE_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_COLLECTIBLE_USE_PET_NICKNAME)),
                tooltip = GetString(LUIE_LAM_CA_COLLECTIBLE_USE_PET_NICKNAME_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_COLLECTIBLE_ICON)),
                tooltip = GetString(LUIE_LAM_CA_COLLECTIBLE_USE_ICON_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_COLLECTIBLE_USE_CATEGORY), GetCollectibleCategoryInfo(3)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_COLLECTIBLE_USE_CATEGORY_TP), GetCollectibleCategoryInfo(3)),
                getFunc = function ()
            ...
            },
            {
                -- Enables collectible tracking in %s category
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_COLLECTIBLE_USE_CATEGORY), GetCollectibleCategoryInfo(7)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_COLLECTIBLE_USE_CATEGORY_TP), GetCollectibleCategoryInfo(7)),
                getFunc = function ()
            ...
            --[[
            {
                -- Enables collectible tracking in %s category
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_COLLECTIBLE_USE_CATEGORY), GetCollectibleCategoryInfo(8)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_COLLECTIBLE_USE_CATEGORY_TP), GetCollectibleCategoryInfo(8)),
            ...
            --
            {
                -- Enables collectible tracking in %s category
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_COLLECTIBLE_USE_CATEGORY), GetCollectibleCategoryInfo(10)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_COLLECTIBLE_USE_CATEGORY_TP), GetCollectibleCategoryInfo(10)),
                getFunc = function ()
            ...
            },
            {
                -- Enables collectible tracking in %s category
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_COLLECTIBLE_USE_CATEGORY), GetCollectibleCategoryInfo(12)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_COLLECTIBLE_USE_CATEGORY_TP), GetCollectibleCategoryInfo(12)),
                getFunc = function ()
            ...
            {
                type = "header",
                name = GetString(LUIE_LAM_CA_COLLECTIBLE_LORE_HEADER),
                width = "full",
            },
            {
                -- Lorebook Bracket
                type = "dropdown",
                name = GetString(LUIE_LAM_CA_BRACKET_OPTION_LOREBOOK),
                tooltip = GetString(LUIE_LAM_CA_BRACKET_OPTION_LOREBOOK_TP),
                choices = linkBracketDisplayOptions,
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_LOREBOOK_ENABLE), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_LOREBOOK_ENABLE_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                -- Show Lorebooks (CSA)
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_LOREBOOK_ENABLE), GetString(LUIE_LAM_CA_SHARED_CSA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_LOREBOOK_ENABLE_TP), GetString(LUIE_LAM_CA_SHARED_CSA)),
                getFunc = function ()
...

            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_LOREBOOK_CSA_LOREONLY)),
                tooltip = GetString(LUIE_LAM_CA_LOREBOOK_CSA_LOREONLY_TP),
                getFunc = function ()
...

            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_LOREBOOK_ENABLE), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_LOREBOOK_ENABLE_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_LOREBOOK_COLLECTION), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_LOREBOOK_COLLECTION_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_LOREBOOK_COLLECTION), GetString(LUIE_LAM_CA_SHARED_CSA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_LOREBOOK_COLLECTION_TP), GetString(LUIE_LAM_CA_SHARED_CSA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_LOREBOOK_COLLECTION), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_LOREBOOK_COLLECTION_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                -- Lorebooks Icon
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_LOREBOOK_ICON)),
                tooltip = GetString(LUIE_LAM_CA_LOREBOOK_ICON_TP),
                getFunc = function ()
            ...
            },
            {
                -- Lorebooks Color 1
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_LOREBOOK_COLOR1)),
                getFunc = function ()
            ...
            },
            {
                -- Lorebooks Color 2
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_LOREBOOK_COLOR2)),
                getFunc = function ()
            ...
            },
            {
                -- Lorebooks Prefix 1
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_LOREBOOK_PREFIX1)),
                tooltip = GetString(LUIE_LAM_CA_LOREBOOK_PREFIX1_TP),
                getFunc = function ()
            ...
            },
            {
                -- Lorebooks Prefix 2
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_LOREBOOK_PREFIX2)),
                tooltip = GetString(LUIE_LAM_CA_LOREBOOK_PREFIX2_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_LOREBOOK_PREFIX_COLLECTION)),
                tooltip = GetString(LUIE_LAM_CA_LOREBOOK_PREFIX_COLLECTION_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "dropdown",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_LOREBOOK_CATEGORY_BRACKET)),
                choices = bracketOptions5,
                tooltip = GetString(LUIE_LAM_CA_LOREBOOK_CATEGORY_BRACKET_TP),
                getFunc = function ()
            ...
            },
            {
                -- Lorebooks Category
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_LOREBOOK_CATEGORY)),
                tooltip = GetString(LUIE_LAM_CA_LOREBOOK_CATEGORY_TP),
                getFunc = function ()
            ...
            },
            {
                -- Show hidden books
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_LOREBOOK_NOSHOWHIDE)),
                tooltip = GetString(LUIE_LAM_CA_LOREBOOK_NOSHOWHIDE_TP),
                getFunc = function ()
    ...
    optionsDataChatAnnouncements[#optionsDataChatAnnouncements+1] = {
        type = "submenu",
        name = GetString(LUIE_LAM_CA_ANTIQUITY_HEADER),
        controls = {
            {
                -- Sub Header Antiquity Leads
                type = "header",
                name = GetString(LUIE_LAM_CA_ANTIQUITY_LEAD_HEADER),
                width = "full",
            },
            {
                -- Show Antiquities (CA)
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_ANTIQUITY_ENABLE), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_ANTIQUITY_ENABLE_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_ANTIQUITY_ENABLE), GetString(LUIE_LAM_CA_SHARED_CSA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_ANTIQUITY_ENABLE_TP), GetString(LUIE_LAM_CA_SHARED_CSA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_ANTIQUITY_ENABLE), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_ANTIQUITY_ENABLE_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "dropdown",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_ANTIQUITY_BRACKET)),
                tooltip = GetString(LUIE_LAM_CA_ANTIQUITY_BRACKET_TP),
                choices = linkBracketDisplayOptions,
                getFunc = function ()
            ...
            },
            {
                -- Antiquities Icon
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_ANTIQUITY_ICON)),
                tooltip = GetString(LUIE_LAM_CA_ANTIQUITY_ICON_TP),
                getFunc = function ()
            ...
            },
            {
                -- Antiquities Color
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_ANTIQUITY_COLOR)),
                getFunc = function ()
            ...
            },
            {
                -- Antiquities Prefix
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_ANTIQUITY_PREFIX)),
                tooltip = GetString(LUIE_LAM_CA_ANTIQUITY_PREFIX_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "dropdown",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_ANTIQUITY_PREFIX_BRACKET)),
                choices = bracketOptions5,
                tooltip = GetString(LUIE_LAM_CA_ANTIQUITY_PREFIX_BRACKET_TP),
                getFunc = function ()
            ...
            },
            {
                -- Antiquities Suffix
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_ANTIQUITY_SUFFIX)),
                tooltip = GetString(LUIE_LAM_CA_ANTIQUITY_SUFFIX_TP),
                getFunc = function ()
    ...
    optionsDataChatAnnouncements[#optionsDataChatAnnouncements+1] = {
        type = "submenu",
        name = GetString(LUIE_LAM_CA_ACHIEVE_HEADER),
        controls = {
            {
                -- Show Achievement Update ChatAnnouncements
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_ACHIEVE_UPDATE), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_ACHIEVE_UPDATE_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_ACHIEVE_UPDATE), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_ACHIEVE_UPDATE_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_ACHIEVE_DETAILINFO)),
                tooltip = GetString(LUIE_LAM_CA_ACHIEVE_DETAILINFO_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "slider",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_ACHIEVE_STEPSIZE)),
                tooltip = GetString(LUIE_LAM_CA_ACHIEVE_STEPSIZE_TP),
                min = 0,
                max = 50,
                step = 1,
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_ACHIEVE_COMPLETE), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_ACHIEVE_COMPLETE_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_ACHIEVE_COMPLETE), GetString(LUIE_LAM_CA_SHARED_CSA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_ACHIEVE_COMPLETE_TP), GetString(LUIE_LAM_CA_SHARED_CSA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_ACHIEVE_COMPLETE_CSA_ALWAYS)),
                tooltip = GetString(LUIE_LAM_CA_ACHIEVE_COMPLETE_CSA_ALWAYS_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_ACHIEVE_COMPLETE), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_ACHIEVE_COMPLETE_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_ACHIEVE_COMPLETEPERCENT),
                tooltip = GetString(LUIE_LAM_CA_ACHIEVE_COMPLETEPERCENT_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_ACHIEVE_ICON),
                tooltip = GetString(LUIE_LAM_CA_ACHIEVE_ICON_TP),
                getFunc = function ()
            ...
            },
            {
                -- Achievement Bracket
                type = "dropdown",
                name = GetString(LUIE_LAM_CA_BRACKET_OPTION_ACHIEVEMENT),
                tooltip = GetString(LUIE_LAM_CA_BRACKET_OPTION_ACHIEVEMENT_TP),
                choices = linkBracketDisplayOptions,
                getFunc = function ()
            ...
            },
            {
                ...
                type = "colorpicker",
                name = GetString(LUIE_LAM_CA_ACHIEVE_COLOR1),
                getFunc = function ()
            ...
            },
            {
                -- Achievement Message Color
                type = "colorpicker",
                name = GetString(LUIE_LAM_CA_ACHIEVE_COLOR2),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_ACHIEVE_PROGMSG),
                tooltip = GetString(LUIE_LAM_CA_ACHIEVE_PROGMSG_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = GetString(LUIE_LAM_CA_ACHIEVE_COMPLETEMSG),
                tooltip = GetString(LUIE_LAM_CA_ACHIEVE_COMPLETEMSG_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_ACHIEVE_SHOWCATEGORY),
                tooltip = GetString(LUIE_LAM_CA_ACHIEVE_SHOWCATEGORY_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_ACHIEVE_SHOWSUBCATEGORY),
                tooltip = GetString(LUIE_LAM_CA_ACHIEVE_SHOWSUBCATEGORY_TP),
                getFunc = function ()
            ...
            },
            {
                -- Prefix Bracket
                type = "dropdown",
                name = GetString(LUIE_LAM_CA_ACHIEVE_BRACKET),
                tooltip = GetString(LUIE_LAM_CA_ACHIEVE_BRACKET_TP),
                choices = bracketOptions5,
                getFunc = function ()
            ...
            },
            {
                ...
                type = "dropdown",
                name = GetString(LUIE_LAM_CA_ACHIEVE_CATEGORYBRACKET),
                tooltip = GetString(LUIE_LAM_CA_ACHIEVE_CATEGORYBRACKET_TP),
            ...
            },
            {
                ...
                type = "checkbox",
                name = GetString(LUIE_LAM_CA_ACHIEVE_COLORPROGRESS),
                tooltip = GetString(LUIE_LAM_CA_ACHIEVE_COLORPROGRESS_TP),
                getFunc = function ()
            ...
            {
                type = "header",
                name = GetString(LUIE_LAM_CA_ACHIEVE_CATEGORY_HEADER),
                width = "full",
            },
        },
    }
    ...
    for i = 1, GetNumAchievementCategories() do
        local name = zo_strformat(GetString(LUIE_LAM_CA_ACHIEVE_CATEGORY), GetAchievementCategoryInfo(i))
        local tooltip = zo_strformat(GetString(LUIE_LAM_CA_ACHIEVE_CATEGORY_TP), GetAchievementCategoryInfo(i))
        local checkbox = {
            type = "checkbox",
            name = name,
            tooltip = tooltip,
    ...
    optionsDataChatAnnouncements[#optionsDataChatAnnouncements+1] = {
        type = "submenu",
        name = GetString(LUIE_LAM_CA_QUEST_HEADER),
        controls = {
            {
                -- Show Quest Share ChatAnnouncements
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_QUEST_SHOWQUESTSHARE), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_QUEST_SHOWQUESTSHARE_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_QUEST_SHOWQUESTSHARE), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_QUEST_SHOWQUESTSHARE_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_QUEST_LOCATION_DISCOVERY), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_QUEST_LOCATION_DISCOVERY_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_QUEST_LOCATION_DISCOVERY), GetString(LUIE_LAM_CA_SHARED_CSA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_QUEST_LOCATION_DISCOVERY_TP), GetString(LUIE_LAM_CA_SHARED_CSA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_QUEST_LOCATION_DISCOVERY), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_QUEST_LOCATION_DISCOVERY_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_QUEST_POI_OBJECTIVE), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_QUEST_POI_OBJECTIVE_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_QUEST_POI_OBJECTIVE), GetString(LUIE_LAM_CA_SHARED_CSA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_QUEST_POI_OBJECTIVE_TP), GetString(LUIE_LAM_CA_SHARED_CSA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_QUEST_POI_OBJECTIVE), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_QUEST_POI_OBJECTIVE_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_QUEST_POI_COMPLETE), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_QUEST_POI_COMPLETE_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_QUEST_POI_COMPLETE), GetString(LUIE_LAM_CA_SHARED_CSA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_QUEST_POI_COMPLETE_TP), GetString(LUIE_LAM_CA_SHARED_CSA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_QUEST_POI_COMPLETE), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_QUEST_POI_COMPLETE_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_QUEST_ACCEPT), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_QUEST_ACCEPT_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_QUEST_ACCEPT), GetString(LUIE_LAM_CA_SHARED_CSA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_QUEST_ACCEPT_TP), GetString(LUIE_LAM_CA_SHARED_CSA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_QUEST_ACCEPT), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_QUEST_ACCEPT_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_QUEST_COMPLETE), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_QUEST_COMPLETE_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_QUEST_COMPLETE), GetString(LUIE_LAM_CA_SHARED_CSA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_QUEST_COMPLETE_TP), GetString(LUIE_LAM_CA_SHARED_CSA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_QUEST_COMPLETE), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_QUEST_COMPLETE_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_QUEST_ABANDON), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_QUEST_ABANDON_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_QUEST_ABANDON), GetString(LUIE_LAM_CA_SHARED_CSA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_QUEST_ABANDON_TP), GetString(LUIE_LAM_CA_SHARED_CSA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_QUEST_ABANDON), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_QUEST_ABANDON_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_QUEST_OBJECTIVE_FAILURE), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_QUEST_OBJECTIVE_FAILURE_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_QUEST_OBJECTIVE_FAILURE), GetString(LUIE_LAM_CA_SHARED_CSA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_QUEST_OBJECTIVE_FAILURE_TP), GetString(LUIE_LAM_CA_SHARED_CSA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_QUEST_OBJECTIVE_FAILURE), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_QUEST_OBJECTIVE_FAILURE_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_QUEST_OBJECTIVE_UPDATE), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_QUEST_OBJECTIVE_UPDATE_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_QUEST_OBJECTIVE_UPDATE), GetString(LUIE_LAM_CA_SHARED_CSA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_QUEST_OBJECTIVE_UPDATE_TP), GetString(LUIE_LAM_CA_SHARED_CSA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_QUEST_OBJECTIVE_UPDATE), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_QUEST_OBJECTIVE_UPDATE_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_QUEST_OBJECTIVE_COMPLETE), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_QUEST_OBJECTIVE_COMPLETE_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_QUEST_OBJECTIVE_COMPLETE), GetString(LUIE_LAM_CA_SHARED_CSA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_QUEST_OBJECTIVE_COMPLETE_TP), GetString(LUIE_LAM_CA_SHARED_CSA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_QUEST_OBJECTIVE_COMPLETE), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_QUEST_OBJECTIVE_COMPLETE_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                -- Show Quest Icon
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_QUEST_SHOWQUESTICON)),
                tooltip = GetString(LUIE_LAM_CA_QUEST_SHOWQUESTICON_TP),
                getFunc = function ()
            ...
            },
            {
                -- Location Color
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_QUEST_COLOR1)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_QUEST_COLOR2)),
                getFunc = function ()
            ...
            },
            {
                -- Quest Color
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_QUEST_COLOR3)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_QUEST_COLOR4)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_QUEST_SHOWQUESTLONG)),
                tooltip = GetString(LUIE_LAM_CA_QUEST_SHOWQUESTLONG_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_QUEST_SHOWQUESTOBJECTIVELONG)),
                tooltip = GetString(LUIE_LAM_CA_QUEST_SHOWQUESTOBJECTIVELONG_TP),
                getFunc = function ()
    ...
    optionsDataChatAnnouncements[#optionsDataChatAnnouncements+1] = {
        type = "submenu",
        name = GetString(LUIE_LAM_CA_SOCIAL_HEADER),
        controls = {
            {
                type = "header",
                name = GetString(LUIE_LAM_CA_SOCIAL_FRIENDS_HEADER),
                width = "full",
            },
            {
                -- Show Friend/Ignore Events ChatAnnouncements
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_FRIENDS), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_FRIENDS_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_FRIENDS), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_FRIENDS_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_FRIENDS_ONOFF), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_FRIENDS_ONOFF_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_FRIENDS_ONOFF), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_FRIENDS_ONOFF_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            {
                type = "header",
                name = GetString(LUIE_LAM_CA_SOCIAL_GUILD_HEADER),
                width = "full",
            },
            {
                -- Show Guild Events ChatAnnouncements
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_GUILD), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_GUILD_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_GUILD), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_GUILD_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_GUILD_RANK), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_GUILD_RANK_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_GUILD_RANK), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_GUILD_RANK_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "dropdown",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_SOCIAL_GUILD_RANKOPTIONS)),
                tooltip = GetString(LUIE_LAM_CA_SOCIAL_GUILD_RANKOPTIONS_TP),
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_GUILD_ADMIN), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_GUILD_ADMIN_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_GUILD_ADMIN), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_GUILD_ADMIN_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                -- Show Guild Icons
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_SOCIAL_GUILD_ICONS)),
                tooltip = GetString(LUIE_LAM_CA_SOCIAL_GUILD_ICONS_TP),
                getFunc = function ()
            ...
            },
            {
                -- Guild Color
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_SOCIAL_GUILD_COLOR)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_SOCIAL_GUILD_COLOR_ALLIANCE)),
                tooltip = GetString(LUIE_LAM_CA_SOCIAL_GUILD_COLOR_ALLIANCE_TP),
                getFunc = function ()
            ...
            {
                type = "header",
                name = GetString(LUIE_LAM_CA_SOCIAL_TRADE_HEADER),
                width = "full",
            },
            {
                -- Show Trade Events
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_TRADE), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_TRADE_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                -- Show Trade Events
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_TRADE), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_TRADE_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            {
                type = "header",
                name = GetString(LUIE_LAM_CA_SOCIAL_DUEL_HEADER),
                width = "full",
            },
            {
                -- Show Duel Events (ChatAnnouncements)
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_DUEL), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_DUEL_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_DUEL), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_DUEL_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_DUELSTART), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_DUELSTART_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                -- Duel Start CSA
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_DUELSTART), GetString(LUIE_LAM_CA_SHARED_CSA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_DUELSTART_TPCSA), GetString(LUIE_LAM_CA_SHARED_CSA)),
                getFunc = function ()
            ...
            },
            {
                -- Duel Start Alert
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_DUELSTART), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_DUELSTART_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                -- Duel Start Options
                type = "dropdown",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_SOCIAL_DUELSTART_OPTION)),
                tooltip = GetString(LUIE_LAM_CA_SOCIAL_DUELSTART_OPTION_TP),
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_DUELCOMPLETE), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_DUELCOMPLETE_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                -- Duel Won CSA
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_DUELCOMPLETE), GetString(LUIE_LAM_CA_SHARED_CSA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_DUELCOMPLETE_TP), GetString(LUIE_LAM_CA_SHARED_CSA)),
                getFunc = function ()
            ...
            },
            {
                -- Duel Won Alert
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_DUELCOMPLETE), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_DUELCOMPLETE_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_DUELBOUNDARY), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_DUELBOUNDARY_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                -- Duel Boundary CSA
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_DUELBOUNDARY), GetString(LUIE_LAM_CA_SHARED_CSA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_DUELBOUNDARY_TP), GetString(LUIE_LAM_CA_SHARED_CSA)),
                getFunc = function ()
            ...
            },
            {
                -- Duel Boundary Alert
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_DUELBOUNDARY), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_SOCIAL_DUELBOUNDARY_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            {
                type = "header",
                name = GetString(LUIE_LAM_CA_SOCIAL_MARA_HEADER),
                width = "full",
            },
            {
                -- Show Pledge of Mara ChatAnnouncements
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_MISC_MARA), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_MISC_MARA_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_MISC_MARA), GetString(LUIE_LAM_CA_SHARED_CSA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_MISC_MARA_TP), GetString(LUIE_LAM_CA_SHARED_CSA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_MISC_MARA), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_MISC_MARA_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_MISC_MARA_ALERT)),
                tooltip = GetString(LUIE_LAM_CA_MISC_MARA_ALERT_TP),
                getFunc = function ()
    ...
    optionsDataChatAnnouncements[#optionsDataChatAnnouncements+1] = {
        type = "submenu",
        name = GetString(LUIE_LAM_CA_GROUP_HEADER),
        controls = {
            {
                type = "header",
                name = GetString(LUIE_LAM_CA_GROUP_BASE_HEADER),
                width = "full",
            },
            {
                -- Show Group ChatAnnouncements
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_GROUP_BASE), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_GROUP_BASE_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                -- Show Group Alert
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_GROUP_BASE), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_GROUP_BASE_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            {
                type = "header",
                name = GetString(LUIE_LAM_CA_GROUP_LFG_HEADER),
                width = "full",
            },
            {
                -- Show Group LFG ChatAnnouncements
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_GROUP_LFGREADY), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_GROUP_LFGREADY_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_GROUP_LFGREADY), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_GROUP_LFGREADY_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                -- Show Group LFG ChatAnnouncements
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_GROUP_LFGQUEUE), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_GROUP_LFGQUEUE_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                -- Show Group LFG Alert
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_GROUP_LFGQUEUE), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_GROUP_LFGQUEUE_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_GROUP_LFGVOTE), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_GROUP_LFGVOTE_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_GROUP_LFGVOTE), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_GROUP_LFGVOTE_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_GROUP_LFGCOMPLETE), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_GROUP_LFGCOMPLETE_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_GROUP_LFGCOMPLETE), GetString(LUIE_LAM_CA_SHARED_CSA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_GROUP_LFGCOMPLETE_TP), GetString(LUIE_LAM_CA_SHARED_CSA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_GROUP_LFGCOMPLETE), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_GROUP_LFGCOMPLETE_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            {
                type = "header",
                name = GetString(LUIE_LAM_CA_GROUP_RAID_HEADER),
                width = "full",
            },
            {
                -- Raid Announcements ChatAnnouncements
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_GROUP_RAID_BASE), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_GROUP_RAID_BASE_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_GROUP_RAID_BASE), GetString(LUIE_LAM_CA_SHARED_CSA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_GROUP_RAID_BASE_TP), GetString(LUIE_LAM_CA_SHARED_CSA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_GROUP_RAID_BASE), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_GROUP_RAID_BASE_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_GROUP_RAID_SCORE), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_GROUP_RAID_SCORE_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                -- Raid Score CSA
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_GROUP_RAID_SCORE), GetString(LUIE_LAM_CA_SHARED_CSA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_GROUP_RAID_SCORE_TP), GetString(LUIE_LAM_CA_SHARED_CSA)),
                getFunc = function ()
            ...
            },
            {
                -- Raid Score Alert
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_GROUP_RAID_SCORE), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_GROUP_RAID_SCORE_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_GROUP_RAID_BESTSCORE), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_GROUP_RAID_BESTSCORE_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                -- Raid Best Score CSA
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_GROUP_RAID_BESTSCORE), GetString(LUIE_LAM_CA_SHARED_CSA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_GROUP_RAID_BESTSCORE_TP), GetString(LUIE_LAM_CA_SHARED_CSA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_GROUP_RAID_BESTSCORE), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_GROUP_RAID_BESTSCORE_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_GROUP_RAID_REVIVE), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_GROUP_RAID_REVIVE_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_GROUP_RAID_REVIVE), GetString(LUIE_LAM_CA_SHARED_CSA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_GROUP_RAID_REVIVE_TP), GetString(LUIE_LAM_CA_SHARED_CSA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_GROUP_RAID_REVIVE), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_GROUP_RAID_REVIVE_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
    ...
    optionsDataChatAnnouncements[#optionsDataChatAnnouncements+1] = {
        type = "submenu",
        name = GetString(LUIE_LAM_CA_DISPLAY_HEADER),
        controls = {
            {
                -- Display Announcements Header
                type = "description",
                text = GetString(LUIE_LAM_CA_DISPLAY_DESCRIPTION),
            },
            {
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_MISC_GENERAL), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_MISC_GENERAL_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_MISC_GENERAL), GetString(LUIE_LAM_CA_SHARED_CSA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_MISC_GENERAL_TP), GetString(LUIE_LAM_CA_SHARED_CSA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_MISC_GENERAL), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_MISC_GENERAL_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "header",
                name = GetString(LUIE_LAM_CA_DISPLAY_HEADER_MISC),
                width = "full",
            },
            {
                -- Respec Notification (ChatAnnouncements)
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_MISC_RESPEC), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_MISC_RESPEC_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_MISC_RESPEC), GetString(LUIE_LAM_CA_SHARED_CSA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_MISC_RESPEC_TP), GetString(LUIE_LAM_CA_SHARED_CSA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_MISC_RESPEC), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_MISC_RESPEC_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_MISC_GROUPAREA), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_MISC_GROUPAREA_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_MISC_GROUPAREA), GetString(LUIE_LAM_CA_SHARED_CSA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_MISC_GROUPAREA_TP), GetString(LUIE_LAM_CA_SHARED_CSA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_MISC_GROUPAREA), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_MISC_GROUPAREA_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "header",
                name = GetString(LUIE_LAM_CA_DISPLAY_HEADER_ZONE),
                width = "full",
            },
            {
                -- Craglorn Buff (ChatAnnouncements)
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_ZONE_CRAGLORN), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_ZONE_CRAGLORN_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                -- Craglorn Buff (CSA)
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_ZONE_CRAGLORN), GetString(LUIE_LAM_CA_SHARED_CSA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_ZONE_CRAGLORN_TP), GetString(LUIE_LAM_CA_SHARED_CSA)),
                getFunc = function ()
            ...
            },
            {
                -- Craglorn Buff (Alert)
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_ZONE_CRAGLORN), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_ZONE_CRAGLORN_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_ZONE_IC), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_ZONE_IC_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_DISPLAY_ZONE_IC_DESCRIPTION)),
                tooltip = GetString(LUIE_LAM_CA_DISPLAY_ZONE_IC_DESCRIPTION_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_ZONE_IC), GetString(LUIE_LAM_CA_SHARED_CSA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_ZONE_IC_TP), GetString(LUIE_LAM_CA_SHARED_CSA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_ZONE_IC), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_ZONE_IC_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "header",
                name = GetString(LUIE_LAM_CA_DISPLAY_HEADER_ARENA),
                width = "full",
            },
            {
                -- Maelstrom Arena Notifications (ChatAnnouncements)
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_ARENA_MAELSTROM), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_ARENA_MAELSTROM_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_ARENA_MAELSTROM), GetString(LUIE_LAM_CA_SHARED_CSA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_ARENA_MAELSTROM_TP), GetString(LUIE_LAM_CA_SHARED_CSA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_ARENA_MAELSTROM), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_ARENA_MAELSTROM_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_ARENA_DRAGONSTAR), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_ARENA_DRAGONSTAR_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_ARENA_DRAGONSTAR), GetString(LUIE_LAM_CA_SHARED_CSA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_ARENA_DRAGONSTAR_TP), GetString(LUIE_LAM_CA_SHARED_CSA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_ARENA_DRAGONSTAR), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_ARENA_DRAGONSTAR_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "header",
                name = GetString(LUIE_LAM_CA_DISPLAY_HEADER_DUNGEON),
                width = "full",
            },
            {
                -- Endless Archive Notifications (ChatAnnouncements)
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_DUNGEON_ENDLESS), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_DUNGEON_ENDLESS_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_DUNGEON_ENDLESS), GetString(LUIE_LAM_CA_SHARED_CSA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_DUNGEON_ENDLESS_TP), GetString(LUIE_LAM_CA_SHARED_CSA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_DUNGEON_ENDLESS), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_DISPLAY_DUNGEON_ENDLESS_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
    ...
    optionsDataChatAnnouncements[#optionsDataChatAnnouncements+1] = {
        type = "submenu",
        name = GetString(LUIE_LAM_CA_MISC_HEADER),
        controls = {
            {
                -- Mail (Send/Recieve - CA)
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_MISC_SHOWMAIL), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_MISC_SHOWMAIL_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_MISC_SHOWMAIL), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_MISC_SHOWMAIL_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
...

            {
                -- Mail (Send/Recieve - CA)
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_MISC_SHOWMAILERROR), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_MISC_SHOWMAILERROR_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                -- Mail (Send/Recieve - Alert)
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_MISC_SHOWMAILERROR), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_MISC_SHOWMAILERROR_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
...

            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_MISC_SHOWLOCKPICK), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_MISC_SHOWLOCKPICK_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_MISC_SHOWLOCKPICK), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_MISC_SHOWLOCKPICK_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_MISC_SHOWJUSTICE), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_MISC_SHOWJUSTICE_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_MISC_SHOWJUSTICE), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_MISC_SHOWJUSTICE_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_MISC_SHOWBANKBAG), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_MISC_SHOWBANKBAG_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_MISC_SHOWBANKBAG), GetString(LUIE_LAM_CA_SHARED_CSA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_MISC_SHOWBANKBAG_TP), GetString(LUIE_LAM_CA_SHARED_CSA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_MISC_SHOWBANKBAG), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_MISC_SHOWBANKBAG_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_MISC_SHOWBANKBAG_COLOR)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_MISC_SHOWRIDING), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_MISC_SHOWRIDING_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_MISC_SHOWRIDING), GetString(LUIE_LAM_CA_SHARED_CSA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_MISC_SHOWRIDING_TP), GetString(LUIE_LAM_CA_SHARED_CSA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_MISC_SHOWRIDING), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_MISC_SHOWRIDING_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_MISC_SHOWRIDING_COLOR)),
                getFunc = function ()
            ...
            },
            {
                -- Mount Upgrade Message Color
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_MISC_SHOWRIDING_COLOR_BOOK)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_MISC_LOOTSHOWDISGUISE), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_MISC_LOOTSHOWDISGUISE_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_MISC_LOOTSHOWDISGUISE), GetString(LUIE_LAM_CA_SHARED_CSA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_MISC_LOOTSHOWDISGUISE_TP), GetString(LUIE_LAM_CA_SHARED_CSA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_MISC_LOOTSHOWDISGUISE), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_MISC_LOOTSHOWDISGUISE_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_MISC_LOOTSHOWDISGUISEALERT), GetString(LUIE_LAM_CA_SHARED_CA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_MISC_LOOTSHOWDISGUISEALERT_TP), GetString(LUIE_LAM_CA_SHARED_CA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_MISC_LOOTSHOWDISGUISEALERT), GetString(LUIE_LAM_CA_SHARED_CSA_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_MISC_LOOTSHOWDISGUISEALERT_TP), GetString(LUIE_LAM_CA_SHARED_CSA)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CA_MISC_LOOTSHOWDISGUISEALERT), GetString(LUIE_LAM_CA_SHARED_ALERT_SHORT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CA_MISC_LOOTSHOWDISGUISEALERT_TP), GetString(LUIE_LAM_CA_SHARED_ALERT)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CA_MISC_LOOTSHOWDISGUISEALERTCOLOR)),
                tooltip = GetString(LUIE_LAM_CA_MISC_LOOTSHOWDISGUISEALERTCOLOR_TP),
                getFunc = function ()

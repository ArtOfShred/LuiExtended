...
function LUIE.CreateSettings()
    ...
    optionsData[#optionsData+1] = {
        type = "button",
        name = GetString(LUIE_LAM_CHANGELOG),
        tooltip = GetString(LUIE_LAM_CHANGELOG_TP),
        func = function ()
    ...
    optionsData[#optionsData+1] = {
        type = "checkbox",
        name = GetString(LUIE_LAM_UNLOCK_DEFAULT_UI),
        tooltip = GetString(LUIE_LAM_UNLOCK_DEFAULT_UI_TP),
        getFunc = function ()
    ...
    optionsData[#optionsData+1] = {
        ...
        tooltip = GetString(LUIE_LAM_RESET_DEFAULT_UI_TP),
        func = LUIE.ResetElementPosition,
        warning = GetString(LUIE_LAM_RELOADUI_BUTTON),
        width = "half",
    }
    ...
    optionsData[#optionsData+1] = {
        type = "submenu",
        name = GetString(LUIE_LAM_SVPROFILE_HEADER),
        controls = {
            {
                -- Character Profile Description
                type = "description",
                text = GetString(LUIE_LAM_SVPROFILE_DESCRIPTION),
                width = "full",
            },
            {
                -- Use Character Specific Settings Toggle
                type = "checkbox",
                name = GetString(LUIE_LAM_SVPROFILE_SETTINGSTOGGLE),
                tooltip = GetString(LUIE_LAM_SVPROFILE_SETTINGSTOGGLE_TP),
                warning = GetString(LUIE_LAM_RELOADUI_BUTTON),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "dropdown",
                scrollable = true,
                name = GetString(LUIE_LAM_SVPROFILE_PROFILECOPY),
                tooltip = GetString(LUIE_LAM_SVPROFILE_PROFILECOPY_TP),
            ...
            },
            {
                -- Copy Profile Button
                type = "button",
                name = GetString(LUIE_LAM_SVPROFILE_PROFILECOPYBUTTON),
                tooltip = GetString(LUIE_LAM_SVPROFILE_PROFILECOPYBUTTON_TP),
                warning = GetString(LUIE_LAM_RELOADUI_BUTTON),
                func = function ()
            ...
            },
            {
                ...
                type = "button",
                name = GetString(LUIE_LAM_SVPROFILE_RESETCHAR),
                tooltip = GetString(LUIE_LAM_SVPROFILE_RESETCHAR_TP),
                warning = GetString(LUIE_LAM_RELOADUI_BUTTON),
                func = function ()
            ...
            },
            {
                ...
                type = "button",
                name = GetString(LUIE_LAM_SVPROFILE_RESETACCOUNT),
                tooltip = GetString(LUIE_LAM_SVPROFILE_RESETACCOUNT_TP),
                warning = GetString(LUIE_LAM_RELOADUI_BUTTON),
                width = "half",
                func = function ()
    ...
    optionsData[#optionsData+1] = {
        type = "header",
        name = GetString(LUIE_LAM_MODULEHEADER),
        width = "full",
    }
    ...
    optionsData[#optionsData+1] = {
        type = "checkbox",
        name = GetString(LUIE_LAM_UF_ENABLE),
        getFunc = function ()
    ...
    optionsData[#optionsData+1] = {
        type = "checkbox",
        name = GetString(LUIE_LAM_CI_SHOWCOMBATINFO),
        getFunc = function ()
    ...
    optionsData[#optionsData+1] = {
        type = "checkbox",
        name = GetString(LUIE_LAM_CT_SHOWCOMBATTEXT),
        getFunc = function ()
    ...
    optionsData[#optionsData+1] = {
        type = "checkbox",
        name = GetString(LUIE_LAM_BUFF_ENABLEEFFECTSTRACK),
        getFunc = function ()
    ...
    optionsData[#optionsData+1] = {
        type = "checkbox",
        name = GetString(LUIE_LAM_CA_ENABLE),
        getFunc = function ()
    ...
    optionsData[#optionsData+1] = {
        type = "checkbox",
        name = GetString(LUIE_LAM_SLASHCMDS_ENABLE),
        getFunc = function ()
    ...
    optionsData[#optionsData+1] = {
        type = "checkbox",
        name = GetString(LUIE_LAM_PNL_ENABLE),
        getFunc = function ()
    ...
    optionsData[#optionsData+1] = {
        type = "description",
        width = "half",
        text = GetString(LUIE_LAM_PNL_DESCRIPTION),
    }

    -- Misc Settings
    optionsData[#optionsData+1] = {
        type = "header",
        name = GetString(LUIE_LAM_MISCHEADER),
        width = "full",
    }
    ...
    optionsData[#optionsData + 1] = {
        type = "dropdown",
        name = GetString(LUIE_LAM_ALERT_TEXT_ALIGNMENT),
        tooltip = GetString(LUIE_LAM_ALERT_TEXT_ALIGNMENT_TP),
    ...
    optionsData[#optionsData+1] = {
        type = "checkbox",
        name = GetString(LUIE_LAM_ALERT_HIDE_ALL),
        tooltip = GetString(LUIE_LAM_ALERT_HIDE_ALL_TP),
        getFunc = function ()
    ...
    optionsData[#optionsData+1] = {
        type = "checkbox",
        name = GetString(LUIE_LAM_HIDE_EXPERIENCE_BAR),
        tooltip = GetString(LUIE_LAM_HIDE_EXPERIENCE_BAR_TP),
        getFunc = function ()
    ...
    optionsData[#optionsData+1] = {
        type = "checkbox",
        name = GetString(LUIE_LAM_STARTUPMSG),
        tooltip = GetString(LUIE_LAM_STARTUPMSG_TP),
        getFunc = function ()

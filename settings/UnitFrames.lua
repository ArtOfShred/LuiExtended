    ...
    optionsDataUnitFrames[#optionsDataUnitFrames + 1] = {
        ...
        controls = {
            ...
            },
            {
                ...
                getFunc = function() return Settings.SortRoleRaid end,
                setFunc = function(value)
                ...
                disabled = function() return not (LUIE.SV.UnitFrames_Enabled and Settings.CustomFramesRaid and Settings.ColorRoleRaid) end,
            },
            {
                -- Display Armor stat change
                type = "checkbox",

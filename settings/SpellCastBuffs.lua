    ...
    optionsDataBuffsDebuffs[#optionsDataBuffsDebuffs + 1] = {
        ...
        controls = {
            ...
            },
            {
                ...
                choices = { "Top", "Middle", "Bottom" },
                sort = "name-up",
                getFunc = function() return Settings.ProminentBuffAlignment end,
                setFunc = SpellCastBuffs.SetIconsAlignmentProminentBuff,
                width = "full",
                default = Defaults.ProminentBuffAlignment,
                disabled = function() return not ( LUIE.SV.SpellCastBuff_Enable ) end,
            },
            {
                ...
                choices = { "Top", "Middle", "Bottom" },
                sort = "name-up",
                getFunc = function() return Settings.ProminentDebuffAlignment end,
                setFunc = SpellCastBuffs.SetIconsAlignmentProminentDebuff,
                width = "full",
                default = Defaults.ProminentDebuffAlignment,
                disabled = function() return not ( LUIE.SV.SpellCastBuff_Enable ) end,
            },
            {

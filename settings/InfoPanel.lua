...
function InfoPanel.CreateSettings()
    ...
    local panelDataInfoPanel = {
        type = "panel",
        name = zo_strformat("<<1>> - <<2>>", LUIE.name, GetString(LUIE_LAM_PNL)),
        displayName = zo_strformat("<<1>> <<2>>", LUIE.name, GetString(LUIE_LAM_PNL)),
        author = LUIE.author .. "\n",
    ...
    optionsDataInfoPanel[#optionsDataInfoPanel+1] = {
        type = "checkbox",
        name = GetString(LUIE_LAM_PNL_UNLOCKPANEL),
        tooltip = GetString(LUIE_LAM_PNL_UNLOCKPANEL_TP),
        getFunc = function ()
    ...
    optionsDataInfoPanel[#optionsDataInfoPanel+1] = {
        type = "slider",
        name = GetString(LUIE_LAM_PNL_PANELSCALE),
        tooltip = GetString(LUIE_LAM_PNL_PANELSCALE_TP),
        min = 100,
        max = 300,
        step = 10,
        getFunc = function ()
    ...
    optionsDataInfoPanel[#optionsDataInfoPanel+1] = {
        ...
        tooltip = GetString(LUIE_LAM_PNL_RESETPOSITION_TP),
    ...
    optionsDataInfoPanel[#optionsDataInfoPanel+1] = {
        type = "submenu",
        name = GetString(LUIE_LAM_PNL_HEADER),
        controls = {
            {
                type = "header",
                name = GetString(LUIE_LAM_PNL_ELEMENTS_HEADER),
                width = "full",
            },
            {
                type = "checkbox",
                name = GetString(LUIE_LAM_PNL_SHOWLATENCY),
                getFunc = function ()
            ...
            {
                type = "checkbox",
                name = GetString(LUIE_LAM_PNL_SHOWCLOCK),
                getFunc = function ()
            ...
            },
            {
                -- Timestamp Format
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_PNL_CLOCKFORMAT)),
            ...
            {
                type = "checkbox",
                name = GetString(LUIE_LAM_PNL_SHOWFPS),
                getFunc = function ()
            ...
            {
                type = "checkbox",
                name = GetString(LUIE_LAM_PNL_SHOWMOUNTTIMER),
                tooltip = GetString(LUIE_LAM_PNL_SHOWMOUNTTIMER_TP),
                getFunc = function ()
            ...
            {
                type = "checkbox",
                name = GetString(LUIE_LAM_PNL_SHOWARMORDURABILITY),
                getFunc = function ()
            ...
            {
                type = "checkbox",
                name = GetString(LUIE_LAM_PNL_SHOWEAPONCHARGES),
                getFunc = function ()
            ...
            {
                type = "checkbox",
                name = GetString(LUIE_LAM_PNL_SHOWBAGSPACE),
                getFunc = function ()
            ...
            {
                type = "checkbox",
                name = GetString(LUIE_LAM_PNL_SHOWSOULGEMS),
                getFunc = function ()
            ...
            {
                type = "checkbox",
                name = GetString(LUIE_LAM_PNL_DISPLAYONWORLDMAP),
                tooltip = GetString(LUIE_LAM_PNL_DISPLAYONWORLDMAP_TP),
                getFunc = function ()
            ...
            {
                type = "checkbox",
                name = GetString(LUIE_LAM_PNL_DISABLECOLORSRO),
                tooltip = GetString(LUIE_LAM_PNL_DISABLECOLORSRO_TP),
                getFunc = function ()

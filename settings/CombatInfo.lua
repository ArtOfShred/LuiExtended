...
local dialogs = {
    [1] = { -- Clear Blacklist
        ...
        text = zo_strformat(GetString(LUIE_LAM_UF_BLACKLIST_CLEAR_DIALOG), GetString(LUIE_CUSTOM_LIST_CASTBAR_BLACKLIST)),
...
function CombatInfo.CreateSettings()
    ...
    local panelDataCombatInfo = {
        type = "panel",
        name = zo_strformat("<<1>> - <<2>>", LUIE.name, GetString(LUIE_LAM_CI)),
        displayName = zo_strformat("<<1>> <<2>>", LUIE.name, GetString(LUIE_LAM_CI)),
        author = LUIE.author .. "\n",
    ...
    optionsDataCombatInfo[#optionsDataCombatInfo+1] = {
        type = "description",
        text = GetString(LUIE_LAM_CI_DESCRIPTION),
    }
    ...
    optionsDataCombatInfo[#optionsDataCombatInfo+1] = {
        type = "submenu",
        name = GetString(LUIE_LAM_CI_HEADER_GCD),
        controls = {
            {
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_GCD_SHOW),
                tooltip = GetString(LUIE_LAM_CI_GCD_SHOW_TP),
                getFunc = function ()
                ...
                width = "full",
                warning = GetString(LUIE_LAM_CI_GCD_SHOW_WARN),
            ...
            {
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CI_GCD_QUICK)),
                tooltip = GetString(LUIE_LAM_CI_GCD_QUICK_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CI_GCD_FLASH)),
                tooltip = GetString(LUIE_LAM_CI_GCD_FLASH_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CI_GCD_DESAT)),
                tooltip = GetString(LUIE_LAM_CI_GCD_DESAT_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CI_GCD_COLOR)),
                tooltip = GetString(LUIE_LAM_CI_GCD_COLOR_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "dropdown",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CI_GCD_ANIMATION)),
                tooltip = GetString(LUIE_LAM_CI_GCD_ANIMATION_TP),
    ...
    optionsDataCombatInfo[#optionsDataCombatInfo+1] = {
        type = "submenu",
        name = GetString(LUIE_LAM_CI_HEADER_ULTIMATE),
        controls = {
            {
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_ULTIMATE_SHOW_VAL),
                tooltip = GetString(LUIE_LAM_CI_ULTIMATE_SHOW_VAL_TP),
                getFunc = function ()
            ...
            {
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_ULTIMATE_SHOW_PCT),
                tooltip = GetString(LUIE_LAM_CI_ULTIMATE_SHOW_PCT_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                tooltip = GetString(LUIE_LAM_CI_SHARED_POSITION_TP),
                min = -72,
                max = 40,
                step = 2,
                getFunc = function ()
            ...
            },
            {
                ...
                tooltip = GetString(LUIE_LAM_CI_SHARED_FONT_TP),
                choices = FontsList,
                sort = "name-up",
                getFunc = function ()
            ...
            },
            {
                ...
                tooltip = GetString(LUIE_LAM_CI_SHARED_FONTSIZE_TP),
                min = 10,
                max = 30,
                step = 1,
                getFunc = function ()
            ...
            },
            {
                ...
                tooltip = GetString(LUIE_LAM_CI_SHARED_FONTSTYLE_TP),
            ...
            {
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CI_ULTIMATE_HIDEFULL)),
                tooltip = GetString(LUIE_LAM_CI_ULTIMATE_HIDEFULL_TP),
                getFunc = function ()
            ...
            {
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_ULTIMATE_TEXTURE),
                tooltip = GetString(LUIE_LAM_CI_ULTIMATE_TEXTURE_TP),
                getFunc = function ()
    ...
    optionsDataCombatInfo[#optionsDataCombatInfo+1] = {
        type = "submenu",
        name = GetString(LUIE_LAM_CI_HEADER_BAR),
        controls = {
            {
                -- Highlight Ability Bar Icon for Active Procs
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_BAR_PROC),
                tooltip = GetString(LUIE_LAM_CI_BAR_PROC_TP),
                getFunc = function ()
            ...
            },
            {
                -- Bar Proc Sound
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CI_BAR_PROCSOUND)),
                tooltip = GetString(LUIE_LAM_CI_BAR_PROCSOUND_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_BAR_EFFECT),
                tooltip = GetString(LUIE_LAM_CI_BAR_EFFECT_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CI_BAR_ULTIMATE)),
                tooltip = GetString(LUIE_LAM_CI_BAR_ULTIMATE_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CI_BAR_LABEL)),
                tooltip = GetString(LUIE_LAM_CI_BAR_LABEL_TP),
                getFunc = function ()
            ...
            {
                type = "slider",
                name = zo_strformat("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<<1>>", GetString(LUIE_LAM_BUFF_SHOWFRACTIONSTHRESHOLDVALUE)),
                tooltip = GetString(LUIE_LAM_BUFF_SHOWFRACTIONSTHRESHOLDVALUE_TP),
                min = 1,
                max = 30,
                step = 1,
                getFunc = function ()
            ...
            {
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<<1>>", GetString(LUIE_LAM_BUFF_SHOWFRACTIONSABOVETHRESHOLD)),
                tooltip = GetString(LUIE_LAM_BUFF_SHOWFRACTIONSABOVETHRESHOLD_TP),
                getFunc = function ()
            ...
            {
                type = "header",
                name = GetString(LUIE_LAM_CI_BACKBAR_HEADER),
            },
            {
                type = "description",
                text = GetString(LUIE_LAM_CI_BACKBAR_NOTE),
            },
            {
                -- Show Backbar
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_BACKBAR_ENABLE),
                tooltip = GetString(LUIE_LAM_CI_BACKBAR_ENABLE_TP),
                getFunc = function ()
            ...
            },
            {
                -- Dark Backbar
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CI_BACKBAR_DARK)),
                tooltip = GetString(LUIE_LAM_CI_BACKBAR_DARK_TP),
                getFunc = function ()
            ...
            },
            {
                -- Desaturate Backbar
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CI_BACKBAR_DESATURATE)),
                tooltip = GetString(LUIE_LAM_CI_BACKBAR_DESATURATE_TP),
                getFunc = function ()
            ...
            },
            {
                -- Hide Unused Backbar
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CI_BACKBAR_HIDE_UNUSED)),
                tooltip = GetString(LUIE_LAM_CI_BACKBAR_HIDE_UNUSED_TP),
                getFunc = function ()
    ...
    optionsDataCombatInfo[#optionsDataCombatInfo+1] = {
        type = "submenu",
        name = GetString(LUIE_LAM_CI_HEADER_POTION),
        controls = {
            {
                -- Show Quickslot Cooldown
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_POTION),
                tooltip = GetString(LUIE_LAM_CI_POTION_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                tooltip = GetString(LUIE_LAM_CI_POTION_COLOR_TP),
                getFunc = function ()
    ...
    optionsDataCombatInfo[#optionsDataCombatInfo+1] = {
        type = "submenu",
        name = GetString(LUIE_LAM_CI_ENEMY_MARKER_HEADER),
        controls = {
            {
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_ENEMY_MARKER),
                tooltip = GetString(LUIE_LAM_CI_ENEMY_MARKER_TP),
            ...
            {
                type = "slider",
                name = GetString(LUIE_LAM_CI_ENEMY_MARKER_SIZE),
    ...
    optionsDataCombatInfo[#optionsDataCombatInfo+1] = {
        type = "submenu",
        name = GetString(LUIE_LAM_CI_HEADER_CASTBAR),
        controls = {

            -- Cast Bar Unlock
            {
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_CASTBAR_MOVE),
                tooltip = GetString(LUIE_LAM_CI_CASTBAR_MOVE_TP),
                getFunc = function ()
            ...
            -- Cast Bar Unlock Reset position
            {
                ...
                tooltip = GetString(LUIE_LAM_CI_CASTBAR_RESET_TP),
            ...
            },
            {
                -- Enable Cast Bar
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_CASTBAR_ENABLE),
                tooltip = GetString(LUIE_LAM_CI_CASTBAR_ENABLE_TP),
                getFunc = function ()
            ...
            },
            {
                -- Cast Bar Width
                type = "slider",
                name = GetString(LUIE_LAM_CI_CASTBAR_SIZEW),
                min = 100,
                max = 500,
                step = 5,
                getFunc = function ()
            ...
            },
            {
                -- Cast Bar Height
                type = "slider",
                name = GetString(LUIE_LAM_CI_CASTBAR_SIZEH),
                min = 16,
                max = 64,
                step = 2,
                getFunc = function ()
            ...
            },
            {
                -- Cast Bar Icon Size
                type = "slider",
                name = GetString(LUIE_LAM_CI_CASTBAR_ICONSIZE),
                min = 16,
                max = 64,
                step = 2,
                getFunc = function ()
            ...
            },
            {
                -- Display Label
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CI_CASTBAR_LABEL)),
                tooltip = GetString(LUIE_LAM_CI_CASTBAR_LABEL_TP),
                getFunc = function ()
            ...
            },
            {
                -- Display Timer
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CI_CASTBAR_TIMER)),
                tooltip = GetString(LUIE_LAM_CI_CASTBAR_TIMER_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "dropdown",
                scrollable = true,
                name = zo_strformat("\t\t\t\t\t\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CI_CASTBAR_FONTFACE)),
                tooltip = GetString(LUIE_LAM_CI_CASTBAR_FONTFACE_TP),
                choices = FontsList,
                sort = "name-up",
                getFunc = function ()
            ...
            },
            {
                -- Cast Bar Font Size
                type = "slider",
                name = zo_strformat("\t\t\t\t\t\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CI_CASTBAR_FONTSIZE)),
                tooltip = GetString(LUIE_LAM_CI_CASTBAR_FONTSIZE_TP),
                min = 10,
                max = 30,
                step = 1,
                getFunc = function ()
            ...
            },
            {
                -- Cast Bar Font Style
                type = "dropdown",
                name = zo_strformat("\t\t\t\t\t\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CI_CASTBAR_FONTSTYLE)),
                tooltip = GetString(LUIE_LAM_CI_CASTBAR_FONTSTYLE_TP),
                choices = { "normal", "outline", "shadow", "soft-shadow-thick", "soft-shadow-thin", "thick-outline" },
                sort = "name-up",
                getFunc = function ()
            ...
            },
            {
                ...
                type = "dropdown",
                scrollable = true,
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CI_CASTBAR_TEXTURE)),
                tooltip = GetString(LUIE_LAM_CI_CASTBAR_TEXTURE_TP),
            ...
            },
            {
                ...
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CI_CASTBAR_GRADIENTC1)),
                tooltip = GetString(LUIE_LAM_CI_CASTBAR_GRADIENTC1_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CI_CASTBAR_GRADIENTC2)),
                tooltip = GetString(LUIE_LAM_CI_CASTBAR_GRADIENTC2_TP),
                getFunc = function ()
...

            {
                -- Combat Info Filters
                type = "header",
                name = GetString(LUIE_LAM_CI_CASTBAR_FILTERS_HEADER),
                width = "full",
            },
            {
                -- Display Heavy Attacks
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CI_CASTBAR_HEAVY_ATTACKS)),
                tooltip = GetString(LUIE_LAM_CI_CASTBAR_HEAVY_ATTACKS_TP),
                getFunc = function ()
...

            {
                ...
                type = "header",
                name = GetString(LUIE_CUSTOM_LIST_CASTBAR_BLACKLIST),
                width = "full",
            },
            {
    ...
    optionsDataCombatInfo[#optionsDataCombatInfo+1] = {
        type = "submenu",
        name = GetString(LUIE_LAM_CI_HEADER_ACTIVE_COMBAT_ALERT),
        controls = {
            {
                type = "description",
                text = GetString(LUIE_LAM_CI_ALERT_DESCRIPTION),
            },
            {
                -- Unlock Alert Frame
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_ALERT_UNLOCK),
                tooltip = GetString(LUIE_LAM_CI_ALERT_UNLOCK_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "button",
                name = GetString(LUIE_LAM_RESETPOSITION),
                tooltip = GetString(LUIE_LAM_CI_ALERT_RESET_TP),
            ...
            },
            {
                -- Show Alerts
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_ALERT_TOGGLE),
                tooltip = GetString(LUIE_LAM_CI_ALERT_TOGGLE_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                scrollable = true,
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_FONT)),
                tooltip = GetString(LUIE_LAM_CI_ALERT_FONTFACE_TP),
                choices = FontsList,
                sort = "name-up",
                getFunc = function ()
            ...
            },
            {
                ...
                type = "slider",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_FONT_SIZE)),
                tooltip = GetString(LUIE_LAM_CI_ALERT_FONTSIZE_TP),
                min = 16,
                max = 64,
                step = 1,
                getFunc = function ()
            ...
            },
            {
                ...
                type = "dropdown",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_FONT_STYLE)),
                tooltip = GetString(LUIE_LAM_CI_ALERT_FONTSTYLE_TP),
                choices = { "normal", "outline", "shadow", "soft-shadow-thick", "soft-shadow-thin", "thick-outline" },
                sort = "name-up",
                getFunc = function ()
            ...
            },
            {
                -- Alert Timer
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CI_ALERT_TIMER_TOGGLE)),
                tooltip = GetString(LUIE_LAM_CI_ALERT_TIMER_TOGGLE_TP),
                getFunc = function ()
            ...
            },
            {
                -- Shared Timer Color
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CI_ALERT_TIMER_COLOR)),
                tooltip = GetString(LUIE_LAM_CI_ALERT_TIMER_COLOR_TP),
                getFunc = function ()
            ...
            },
            {
                -- Shared Label Color
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CI_ALERT_COLOR_BASE)),
                tooltip = GetString(LUIE_LAM_CI_ALERT_COLOR_BASE_TP),
                getFunc = function ()
            ...
            {
                type = "header",
                name = GetString(LUIE_LAM_CI_ALERT_HEADER_SHARED),
                width = "full",
            },
            {
                -- Mitigation Rank 3
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_ALERT_RANK3),
                tooltip = GetString(LUIE_LAM_CI_ALERT_RANK3_TP),
                getFunc = function ()
            ...
            },
            {
                -- Mitigation Rank 2
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_ALERT_RANK2),
                tooltip = GetString(LUIE_LAM_CI_ALERT_RANK2_TP),
                getFunc = function ()
            ...
            },
            {
                -- Mitigation Rank 1
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_ALERT_RANK1),
                tooltip = GetString(LUIE_LAM_CI_ALERT_RANK1_TP),
                getFunc = function ()
            ...
            },
            {
                -- Mitigation Aura
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CI_ALERT_AURA)),
                tooltip = GetString(LUIE_LAM_CI_ALERT_AURA_TP),
                getFunc = function ()
            ...
            },
            {
                -- Mitigation Dungeon
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CI_ALERT_DUNGEON)),
                tooltip = GetString(LUIE_LAM_CI_ALERT_DUNGEON_TP),
                getFunc = function ()
            ...
            {
                type = "header",
                name = GetString(LUIE_LAM_CI_ALERT_MITIGATION_HEADER),
                width = "full",
            },
            {
                type = "description",
                text = GetString(LUIE_LAM_CI_ALERT_MITIGATION_DESCRIPTION),
            },
            {
                -- MITIGATION ENABLE
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_ALERT_MITIGATION_ENABLE),
                tooltip = GetString(LUIE_LAM_CI_ALERT_MITIGATION_ENABLE_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "dropdown",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CI_ALERT_MITIGATION_FILTER)),
                tooltip = GetString(LUIE_LAM_CI_ALERT_MITIGATION_FILTER_TP),
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CI_ALERT_MITIGATION_SUFFIX)),
                tooltip = GetString(LUIE_LAM_CI_ALERT_MITIGATION_SUFFIX_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CI_ALERT_MITIGATION_FORMAT_ABILITY)),
                tooltip = zo_strformat("<<1>>", GetString(LUIE_LAM_CI_ALERT_MITIGATION_FORMAT_ABILITY_TP)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CI_ALERT_MITIGATION_FORMAT_NAME)),
                tooltip = zo_strformat("<<1>>", GetString(LUIE_LAM_CI_ALERT_MITIGATION_FORMAT_NAME_TP)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CI_ALERT_MITIGATION_BORDER)),
                tooltip = GetString(LUIE_LAM_CI_ALERT_MITIGATION_BORDER_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CI_ALERT_MITIGATION_LABEL_COLOR)),
                tooltip = GetString(LUIE_LAM_CI_ALERT_MITIGATION_LABEL_COLOR_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CI_CCT_DEFAULT_ICON)),
                tooltip = GetString(LUIE_LAM_CI_CCT_DEFAULT_ICON_ALERT_TP),
                getFunc = function ()
            ...
            },
            {
                -- Enable Modifiers
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CI_ALERT_ALLOW_MODIFIER)),
                tooltip = GetString(LUIE_LAM_CI_ALERT_ALLOW_MODIFIER_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CI_ALERT_MODIFIER_DIRECT)),
                tooltip = GetString(LUIE_LAM_CI_ALERT_MODIFIER_DIRECT_TP),
                getFunc = function ()
            ...
            },
            {
                -- Modifier (Spread Out)
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CI_ALERT_MODIFIER_SPREAD)),
                tooltip = GetString(LUIE_LAM_CI_ALERT_MODIFIER_SPREAD_TP),
                getFunc = function ()
            ...
            {
                type = "header",
                name = GetString(LUIE_LAM_CT_SHARED_ALERT_BLOCK),
                width = "full",
            },
            {
                -- Block Format
                type = "editbox",
                width = "half",
                name = zo_strformat("<<1>> (<<2>>)", GetString(LUIE_LAM_CT_SHARED_FORMAT), GetString(LUIE_LAM_CT_SHARED_ALERT_BLOCK)),
                tooltip = GetString(LUIE_LAM_CT_FORMAT_NOTIFICATION_BLOCK_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                width = "half",
                name = zo_strformat("<<1>> (<<2>>)", GetString(LUIE_LAM_CT_SHARED_FORMAT), GetString(LUIE_LAM_CT_SHARED_ALERT_BLOCK_S)),
                tooltip = GetString(LUIE_LAM_CT_FORMAT_NOTIFICATION_BLOCK_S_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                tooltip = GetString(LUIE_LAM_CT_COLOR_NOTIFICATION_BLOCK_TP),
                getFunc = function ()
            ...
            {
                type = "header",
                name = GetString(LUIE_LAM_CT_SHARED_ALERT_DODGE),
                width = "full",
            },
            {
                -- Dodge  Format
                ...
                tooltip = GetString(LUIE_LAM_CT_FORMAT_NOTIFICATION_DODGE_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "colorpicker",
                name = GetString(LUIE_LAM_CT_SHARED_COLOR),
                tooltip = GetString(LUIE_LAM_CT_COLOR_NOTIFICATION_DODGE_TP),
                getFunc = function ()
            ...
            {
                type = "header",
                name = GetString(LUIE_LAM_CT_SHARED_ALERT_AVOID),
                width = "full",
            },
            {
                -- Avoid Format
                type = "editbox",
                name = GetString(LUIE_LAM_CT_SHARED_FORMAT),
                tooltip = GetString(LUIE_LAM_CT_FORMAT_NOTIFICATION_AVOID_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "colorpicker",
                name = GetString(LUIE_LAM_CT_SHARED_COLOR),
                tooltip = GetString(LUIE_LAM_CT_COLOR_NOTIFICATION_AVOID_TP),
                getFunc = function ()
            ...
            {
                type = "header",
                name = GetString(LUIE_LAM_CT_SHARED_ALERT_INTERRUPT),
                width = "full",
            },
            {
                -- Interrupt Format
                type = "editbox",
                name = GetString(LUIE_LAM_CT_SHARED_FORMAT),
                tooltip = GetString(LUIE_LAM_CT_FORMAT_NOTIFICATION_INTERRUPT_TP),
                getFunc = function ()
            ...
            },
            {
                -- Hard CC Format
                type = "editbox",
                name = GetString(LUIE_LAM_CT_FORMAT_NOTIFICATION_SHOULDUSECC),
                tooltip = GetString(LUIE_LAM_CT_FORMAT_NOTIFICATION_SHOULDUSECC_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "colorpicker",
                name = GetString(LUIE_LAM_CT_SHARED_COLOR),
                tooltip = GetString(LUIE_LAM_CT_COLOR_NOTIFICATION_INTERRUPT_TP),
                getFunc = function ()
            ...
            {
                type = "header",
                name = GetString(LUIE_LAM_CT_SHARED_ALERT_UNMIT),
                width = "full",
            },
            {
                -- Unmit Enable
                type = "checkbox",
                name = zo_strformat("<<1>> <<2>>", GetString(LUIE_LAM_CT_SHARED_DISPLAY), GetString(LUIE_LAM_CT_SHARED_ALERT_UNMIT)),
                tooltip = GetString(LUIE_LAM_CT_NOTIFICATION_ALERT_UNMIT_TP),
                getFunc = function ()
            ...
            },
            {
                -- Unmit Format
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CT_SHARED_FORMAT)),
                tooltip = GetString(LUIE_LAM_CT_FORMAT_NOTIFICATION_UNMIT_TP),
                getFunc = function ()
            ...
            },
            {
                -- Unmit Color
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CT_SHARED_COLOR)),
                tooltip = GetString(LUIE_LAM_CT_COLOR_NOTIFICATION_UNMIT_TP),
                getFunc = function ()
            ...
            {
                type = "header",
                name = GetString(LUIE_LAM_CT_SHARED_ALERT_POWER),
                width = "full",
            },
            {
                -- Power Enable
                type = "checkbox",
                name = zo_strformat("<<1>> <<2>>", GetString(LUIE_LAM_CT_SHARED_DISPLAY), GetString(LUIE_LAM_CT_SHARED_ALERT_POWER)),
                tooltip = GetString(LUIE_LAM_CT_NOTIFICATION_ALERT_POWER_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CT_SHARED_FORMAT)),
                tooltip = GetString(LUIE_LAM_CT_FORMAT_NOTIFICATION_POWER_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t<<1>> <<2>>", GetString(LUIE_LAM_CI_ALERT_MITIGATION_FORMAT_P), GetString(LUIE_LAM_CI_ALERT_MITIGATION_NO_NAME)),
                tooltip = zo_strformat("<<1>> <<2>>", GetString(LUIE_LAM_CI_ALERT_MITIGATION_FORMAT_P_TP), GetString(LUIE_LAM_CI_ALERT_MITIGATION_NO_NAME_TP)),
                getFunc = function ()
            ...
            },
            {
                -- Prefix Power (Name)
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t<<1>> <<2>>", GetString(LUIE_LAM_CI_ALERT_MITIGATION_FORMAT_P), GetString(LUIE_LAM_CI_ALERT_MITIGATION_NAME)),
                tooltip = zo_strformat("<<1>> <<2>>", GetString(LUIE_LAM_CI_ALERT_MITIGATION_FORMAT_P_TP), GetString(LUIE_LAM_CI_ALERT_MITIGATION_NAME_TP)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CT_SHARED_COLOR)),
                tooltip = GetString(LUIE_LAM_CT_COLOR_NOTIFICATION_POWER_TP),
                getFunc = function ()
            ...
            {
                type = "header",
                name = GetString(LUIE_LAM_CT_SHARED_ALERT_DESTROY),
                width = "full",
            },
            {
                -- Destroy Enable
                type = "checkbox",
                name = zo_strformat("<<1>> <<2>>", GetString(LUIE_LAM_CT_SHARED_DISPLAY), GetString(LUIE_LAM_CT_SHARED_ALERT_DESTROY)),
                tooltip = GetString(LUIE_LAM_CT_NOTIFICATION_ALERT_DESTROY_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CT_SHARED_FORMAT)),
                tooltip = GetString(LUIE_LAM_CT_FORMAT_NOTIFICATION_DESTROY_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t<<1>> <<2>>", GetString(LUIE_LAM_CI_ALERT_MITIGATION_FORMAT_D), GetString(LUIE_LAM_CI_ALERT_MITIGATION_NO_NAME)),
                tooltip = zo_strformat("<<1>> <<2>>", GetString(LUIE_LAM_CI_ALERT_MITIGATION_FORMAT_D_TP), GetString(LUIE_LAM_CI_ALERT_MITIGATION_NO_NAME_TP)),
                getFunc = function ()
            ...
            },
            {
                -- Prefix Destroy (Name)
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t<<1>> <<2>>", GetString(LUIE_LAM_CI_ALERT_MITIGATION_FORMAT_D), GetString(LUIE_LAM_CI_ALERT_MITIGATION_NAME)),
                tooltip = zo_strformat("<<1>> <<2>>", GetString(LUIE_LAM_CI_ALERT_MITIGATION_FORMAT_D_TP), GetString(LUIE_LAM_CI_ALERT_MITIGATION_NAME_TP)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CT_SHARED_COLOR)),
                tooltip = GetString(LUIE_LAM_CT_COLOR_NOTIFICATION_DESTROY_TP),
                getFunc = function ()
            ...
            {
                type = "header",
                name = GetString(LUIE_LAM_CT_SHARED_ALERT_SUMMON),
                width = "full",
            },
            {
                -- Summon Enable
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>> <<2>>", GetString(LUIE_LAM_CT_SHARED_DISPLAY), GetString(LUIE_LAM_CT_SHARED_ALERT_SUMMON)),
                tooltip = GetString(LUIE_LAM_CT_NOTIFICATION_ALERT_SUMMON_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CT_SHARED_FORMAT)),
                tooltip = GetString(LUIE_LAM_CT_FORMAT_NOTIFICATION_SUMMON_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t<<1>> <<2>>", GetString(LUIE_LAM_CI_ALERT_MITIGATION_FORMAT_S), GetString(LUIE_LAM_CI_ALERT_MITIGATION_NO_NAME)),
                tooltip = zo_strformat("<<1>> <<2>>", GetString(LUIE_LAM_CI_ALERT_MITIGATION_FORMAT_S_TP), GetString(LUIE_LAM_CI_ALERT_MITIGATION_NO_NAME_TP)),
                getFunc = function ()
            ...
            },
            {
                -- Prefix Summon (Name)
                type = "editbox",
                name = zo_strformat("\t\t\t\t\t<<1>> <<2>>", GetString(LUIE_LAM_CI_ALERT_MITIGATION_FORMAT_S), GetString(LUIE_LAM_CI_ALERT_MITIGATION_NAME)),
                tooltip = zo_strformat("<<1>> <<2>>", GetString(LUIE_LAM_CI_ALERT_MITIGATION_FORMAT_S_TP), GetString(LUIE_LAM_CI_ALERT_MITIGATION_NAME_TP)),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CT_SHARED_COLOR)),
                tooltip = GetString(LUIE_LAM_CT_COLOR_NOTIFICATION_SUMMON_TP),
                getFunc = function ()
            ...
            {
                type = "header",
                name = GetString(LUIE_LAM_CI_ALERT_HEADER_CC_COLOR),
                width = "full",
            },
            {
                -- Stun
                type = "colorpicker",
                name = GetString(LUIE_LAM_CI_ALERT_CC_COLOR_STUN),
                tooltip = GetString(LUIE_LAM_CI_ALERT_CC_COLOR_STUN_TP),
                getFunc = function ()
            ...
            },
            {
                -- Knockback
                type = "colorpicker",
                name = GetString(LUIE_LAM_CI_ALERT_CC_COLOR_KNOCKBACK),
                tooltip = GetString(LUIE_LAM_CI_ALERT_CC_COLOR_KNOCKBACK_TP),
                getFunc = function ()
            ...
            },
            {
                -- Levitate/Pull
                type = "colorpicker",
                name = GetString(LUIE_LAM_CI_ALERT_CC_COLOR_LEVITATE),
                tooltip = GetString(LUIE_LAM_CI_ALERT_CC_COLOR_LEVITATE_TP),
                getFunc = function ()
            ...
            },
            {
                -- Disorient
                type = "colorpicker",
                name = GetString(LUIE_LAM_CI_ALERT_CC_COLOR_DISORIENT),
                tooltip = GetString(LUIE_LAM_CI_ALERT_CC_COLOR_DISORIENT_TP),
                getFunc = function ()
            ...
            },
            {
                -- Fear
                type = "colorpicker",
                name = GetString(LUIE_LAM_CI_ALERT_CC_COLOR_FEAR),
                tooltip = GetString(LUIE_LAM_CI_ALERT_CC_COLOR_FEAR_TP),
                getFunc = function ()
            ...
            },
            {
                -- Charm
                type = "colorpicker",
                name = GetString(LUIE_LAM_CI_ALERT_CC_COLOR_CHARM),
                tooltip = GetString(LUIE_LAM_CI_ALERT_CC_COLOR_CHARM_TP),
                getFunc = function ()
            ...
            },
            {
                -- Silence
                type = "colorpicker",
                name = GetString(LUIE_LAM_CI_ALERT_CC_COLOR_SILENCE),
                tooltip = GetString(LUIE_LAM_CI_ALERT_CC_COLOR_SILENCE_TP),
                getFunc = function ()
            ...
            },
            {
                -- Stagger
                type = "colorpicker",
                name = GetString(LUIE_LAM_CI_ALERT_CC_COLOR_STAGGER),
                tooltip = GetString(LUIE_LAM_CI_ALERT_CC_COLOR_STAGGER_TP),
                getFunc = function ()
            ...
            },
            {
                -- Unbreakable
                type = "colorpicker",
                name = GetString(LUIE_LAM_CI_ALERT_CC_COLOR_UNBREAKABLE),
                tooltip = GetString(LUIE_LAM_CI_ALERT_CC_COLOR_UNBREAKABLE_TP),
                getFunc = function ()
            ...
            },
            {
                -- Snare
                type = "colorpicker",
                name = GetString(LUIE_LAM_CI_ALERT_CC_COLOR_SNARE),
                tooltip = GetString(LUIE_LAM_CI_ALERT_CC_COLOR_SNARE_TP),
                getFunc = function ()
            ...
            },
            {
                -- Root
                type = "colorpicker",
                name = GetString(LUIE_LAM_CI_ALERT_CC_COLOR_ROOT),
                tooltip = GetString(LUIE_LAM_CI_ALERT_CC_COLOR_ROOT_TP),
                getFunc = function ()
            ...
            {
                type = "header",
                name = GetString(LUIE_LAM_CI_ALERT_SOUND_HEADER),
                width = "full",
            },

            {
                -- Sound Volume
                type = "slider",
                name = GetString(LUIE_LAM_CI_ALERT_SOUND_VOLUME),
                tooltip = GetString(LUIE_LAM_CI_ALERT_SOUND_VOLUME_TP),
            ...
            },
            {
                ...
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_ALERT_SOUND_ST),
                tooltip = GetString(LUIE_LAM_CI_ALERT_SOUND_ST_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_ALERT_SOUND_ST_CC),
                tooltip = GetString(LUIE_LAM_CI_ALERT_SOUND_ST_CC_TP),
                getFunc = function ()
            ...
            },
            {
                -- Play Sound (AOE)
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_ALERT_SOUND_ST_AOE),
                tooltip = GetString(LUIE_LAM_CI_ALERT_SOUND_ST_AOE_TP),
                getFunc = function ()
            ...
            },
            {
                -- Play Sound (AOE CC)
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_ALERT_SOUND_ST_AOE_CC),
                tooltip = GetString(LUIE_LAM_CI_ALERT_SOUND_ST_AOE_CC_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_ALERT_SOUND_ST_POWER_ATTACK),
                tooltip = GetString(LUIE_LAM_CI_ALERT_SOUND_ST_POWER_ATTACK_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_ALERT_SOUND_ST_RADIAL_AVOID),
                tooltip = GetString(LUIE_LAM_CI_ALERT_SOUND_ST_RADIAL_AVOID_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_ALERT_SOUND_GROUND_TRAVEL),
                tooltip = GetString(LUIE_LAM_CI_ALERT_SOUND_GROUND_TRAVEL_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_ALERT_SOUND_GROUND_TRAVEL_CC),
                tooltip = GetString(LUIE_LAM_CI_ALERT_SOUND_GROUND_TRAVEL_CC_TP),
                getFunc = function ()
            ...
            },
            {
                -- Play Sound (GROUND)
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_ALERT_SOUND_GROUND),
                tooltip = GetString(LUIE_LAM_CI_ALERT_SOUND_GROUND_TP),
                getFunc = function ()
            ...
            },
            {
                -- Play Sound (METEOR)
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_ALERT_SOUND_METEOR),
                tooltip = GetString(LUIE_LAM_CI_ALERT_SOUND_METEOR_TP),
                getFunc = function ()
            ...
            },
            {
                -- Play Sound (UNMIT ST)
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_ALERT_SOUND_UNMIT),
                tooltip = GetString(LUIE_LAM_CI_ALERT_SOUND_UNMIT_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_ALERT_SOUND_UNMIT_AOE),
                tooltip = GetString(LUIE_LAM_CI_ALERT_SOUND_UNMIT_AOE_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_ALERT_SOUND_POWER_DAMAGE),
                tooltip = GetString(LUIE_LAM_CI_ALERT_SOUND_POWER_DAMAGE_TP),
                getFunc = function ()
            ...
            },
            {
                ...
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_ALERT_SOUND_POWER_DEFENSE),
                tooltip = GetString(LUIE_LAM_CI_ALERT_SOUND_POWER_DEFENSE_TP),
                getFunc = function ()
            ...
            },
            {
                -- Play Sound (SUMMON)
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_ALERT_SOUND_SUMMON),
                tooltip = GetString(LUIE_LAM_CI_ALERT_SOUND_SUMMON_TP),
                getFunc = function ()
            ...
            },
            {
                -- Play Sound (DESTROY)
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_ALERT_SOUND_DESTROY),
                tooltip = GetString(LUIE_LAM_CI_ALERT_SOUND_DESTROY_TP),
                getFunc = function ()
            ...
            },
            {
                -- Play Sound (HEAL)
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_ALERT_SOUND_HEAL),
                tooltip = GetString(LUIE_LAM_CI_ALERT_SOUND_HEAL_TP),
                getFunc = function ()
    ...
    optionsDataCombatInfo[#optionsDataCombatInfo+1] = {
        type = "submenu",
        name = GetString(LUIE_LAM_CI_CCT_HEADER),
        controls = {

            -- CCT Description
            {
                type = "description",
                text = GetString(LUIE_LAM_CI_CCT_DESCRIPTION),
            },

            {
                -- Unlock CCT
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_CCT_UNLOCK),
                tooltip = GetString(LUIE_LAM_CI_CCT_UNLOCK_TP),
            ...
            },
            {
                ...
                type = "button",
                name = GetString(LUIE_LAM_RESETPOSITION),
                tooltip = GetString(LUIE_LAM_CI_CCT_RESET_TP),
            ...
            },
            {
                ...
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_CCT_TOGGLE),
                tooltip = GetString(LUIE_LAM_CI_CCT_TOGGLE_TP),
            ...
            },
            {
                -- Enable only in PVP
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CI_CCT_PVP_ONLY)),
                tooltip = GetString(LUIE_LAM_CI_CCT_PVP_ONLY_TP),
            ...
            },
            {
                ...
                type = "header",
                name = GetString(LUIE_LAM_CI_CCT_DISPLAY_HEADER),
            },
            {
                -- Display Method
                -- TODO: Change theses to displayOptions + better punctuation
                type = "dropdown",
                name = GetString(LUIE_LAM_CI_CCT_DISPLAY_STYLE),
                tooltip = GetString(LUIE_LAM_CI_CCT_DISPLAY_STYLE_TP),
            ...
            },
            {
                ...
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_CCT_DISPLAY_NAME),
                tooltip = GetString(LUIE_LAM_CI_CCT_DISPLAY_NAME_TP),
            ...
            },
            {
                -- Icon and Text Scale
                type = "slider",
                name = GetString(LUIE_LAM_CI_CCT_SCALE),
                tooltip = GetString(LUIE_LAM_CI_CCT_SCALE_TP),
            ...
            {
                type = "header",
                name = GetString(LUIE_LAM_CI_CCT_MISC_OPTIONS_HEADER),
            },
            {
                -- Play Sound when CC'ed
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_CCT_SOUND),
                tooltip = GetString(LUIE_LAM_CI_CCT_SOUND_TP),
            ...
            },
            {
                ...
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_CCT_STAGGER),
                tooltip = GetString(LUIE_LAM_CI_CCT_STAGGER_TP),
            ...
            },
            {
                ...
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_CCT_GCD_TOGGLE),
                tooltip = GetString(LUIE_LAM_CI_CCT_GCD_TOGGLE_TP),
            ...
            },
            {
                -- Show when Immune
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_CCT_IMMUNE_TOGGLE),
                tooltip = GetString(LUIE_LAM_CI_CCT_IMMUNE_TOGGLE_TP),
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CI_CCT_IMMUNE_CYRODIIL)),
                tooltip = GetString(LUIE_LAM_CI_CCT_IMMUNE_CYRODIIL_TP),
            ...
            },
            {
                ...
                type = "slider",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CI_CCT_IMMUNE_TIME)),
                tooltip = GetString(LUIE_LAM_CI_CCT_IMMUNE_TIME_TP),
            ...
            },
            {
                ...
                type = "colorpicker",
                name = GetString(LUIE_LAM_CI_ALERT_CC_COLOR_STUN),
                tooltip = zo_strformat(GetString(LUIE_LAM_CI_CCT_COLOR_TP), GetString(LUIE_LAM_CI_ALERT_CC_COLOR_STUN)),
...

            {
                ...
                type = "colorpicker",
                name = GetString(LUIE_LAM_CI_ALERT_CC_COLOR_KNOCKBACK),
                tooltip = zo_strformat(GetString(LUIE_LAM_CI_CCT_COLOR_TP), GetString(LUIE_LAM_CI_ALERT_CC_COLOR_KNOCKBACK)),
...

            {
                ...
                type = "colorpicker",
                name = GetString(LUIE_LAM_CI_ALERT_CC_COLOR_LEVITATE),
                tooltip = zo_strformat(GetString(LUIE_LAM_CI_CCT_COLOR_TP), GetString(LUIE_LAM_CI_ALERT_CC_COLOR_LEVITATE)),
...

            {
                ...
                type = "colorpicker",
                name = GetString(LUIE_LAM_CI_ALERT_CC_COLOR_DISORIENT),
                tooltip = zo_strformat(GetString(LUIE_LAM_CI_CCT_COLOR_TP), GetString(LUIE_LAM_CI_ALERT_CC_COLOR_DISORIENT)),
            ...
            },
            {
                ...
                type = "colorpicker",
                name = GetString(LUIE_LAM_CI_ALERT_CC_COLOR_SILENCE),
                tooltip = zo_strformat(GetString(LUIE_LAM_CI_CCT_COLOR_TP), GetString(LUIE_LAM_CI_ALERT_CC_COLOR_SILENCE)),
            ...
            },
            {
                ...
                type = "colorpicker",
                name = GetString(LUIE_LAM_CI_ALERT_CC_COLOR_FEAR),
                tooltip = zo_strformat(GetString(LUIE_LAM_CI_CCT_COLOR_TP), GetString(LUIE_LAM_CI_ALERT_CC_COLOR_FEAR)),
            ...
            },
            {
                ...
                type = "colorpicker",
                name = GetString(LUIE_LAM_CI_ALERT_CC_COLOR_CHARM),
                tooltip = zo_strformat(GetString(LUIE_LAM_CI_CCT_COLOR_TP), GetString(LUIE_LAM_CI_ALERT_CC_COLOR_CHARM)),
            ...
            },
            {
                ...
                type = "colorpicker",
                name = GetString(LUIE_LAM_CI_ALERT_CC_COLOR_STAGGER),
                tooltip = zo_strformat(GetString(LUIE_LAM_CI_CCT_COLOR_TP), GetString(LUIE_LAM_CI_ALERT_CC_COLOR_STAGGER)),
            ...
            },
            {
                ...
                type = "colorpicker",
                name = GetString(LUIE_LAM_CI_ALERT_CC_COLOR_UNBREAKABLE),
                tooltip = zo_strformat(GetString(LUIE_LAM_CI_CCT_COLOR_TP), GetString(LUIE_LAM_CI_ALERT_CC_COLOR_UNBREAKABLE)),
            ...
            },
            {
                -- Immune
                type = "colorpicker",
                name = GetString(LUIE_LAM_CI_CCT_IMMUNE),
                tooltip = zo_strformat(GetString(LUIE_LAM_CI_CCT_COLOR_TP), GetString(LUIE_LAM_CI_CCT_IMMUNE)),
            ...
            {
                type = "header",
                name = GetString(LUIE_LAM_CI_CCT_ROOT_HEADER),
            },
            {
                -- ROOT SHOW
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_CCT_ROOT_TOGGLE),
                tooltip = GetString(LUIE_LAM_CI_CCT_ROOT_TOGGLE_TP),
            ...
            },
            {
                -- Root Color
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CI_CCT_ROOT_COLOR)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CI_CCT_COLOR_TP), GetString(LUIE_LAM_CI_ALERT_CC_COLOR_ROOT)),
            ...
            {
                type = "header",
                name = GetString(LUIE_LAM_CI_CCT_AOE_HEADER),
            },
            {
                -- AOE SHOW
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_CCT_AOE_TOGGLE),
                tooltip = GetString(LUIE_LAM_CI_CCT_AOE_TOGGLE_TP),
            ...
            },
            {
                -- AOE Color
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CT_CCT_AOE_COLOR)),
                tooltip = GetString(LUIE_LAM_CT_CCT_AOE_COLOR_TP),
            ...
            {
                type = "header",
                name = GetString(LUIE_LAM_CI_CCT_SNARE_HEADER),
            },
            {
                -- SNARE SHOW
                type = "checkbox",
                name = GetString(LUIE_LAM_CI_CCT_SNARE_TOGGLE),
                tooltip = GetString(LUIE_LAM_CI_CCT_SNARE_TOGGLE_TP),
            ...
            },
            {
                -- Snare Color
                type = "colorpicker",
                name = zo_strformat("\t\t\t\t\t<<1>>", GetString(LUIE_LAM_CI_CCT_SNARE_COLOR)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CI_CCT_COLOR_TP), GetString(LUIE_LAM_CI_ALERT_CC_COLOR_SNARE)),
            ...
            -- AOE DISPLAY OPTIONS
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CI_CCT_AOE_SHOW), GetString(LUIE_LAM_CI_CCT_AOE_TIER_PLAYER_ULT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CI_CCT_AOE_SHOW_TP), GetString(LUIE_LAM_CI_CCT_AOE_TIER_PLAYER_ULT)),
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CI_CCT_AOE_SOUND), GetString(LUIE_LAM_CI_CCT_AOE_TIER_PLAYER_ULT)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CI_CCT_AOE_SOUND_TP), GetString(LUIE_LAM_CI_CCT_AOE_TIER_PLAYER_ULT)),
                width = "half",
...

            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CI_CCT_AOE_SHOW), GetString(LUIE_LAM_CI_CCT_AOE_TIER_PLAYER_NORM)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CI_CCT_AOE_SHOW_TP), GetString(LUIE_LAM_CI_CCT_AOE_TIER_PLAYER_NORM)),
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CI_CCT_AOE_SOUND), GetString(LUIE_LAM_CI_CCT_AOE_TIER_PLAYER_NORM)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CI_CCT_AOE_SOUND_TP), GetString(LUIE_LAM_CI_CCT_AOE_TIER_PLAYER_NORM)),
                width = "half",
...

            {
                -- Show AOE - Player Set
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CI_CCT_AOE_SHOW), GetString(LUIE_LAM_CI_CCT_AOE_TIER_PLAYER_SET)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CI_CCT_AOE_SHOW_TP), GetString(LUIE_LAM_CI_CCT_AOE_TIER_PLAYER_SET)),
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CI_CCT_AOE_SOUND), GetString(LUIE_LAM_CI_CCT_AOE_TIER_PLAYER_SET)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CI_CCT_AOE_SOUND_TP), GetString(LUIE_LAM_CI_CCT_AOE_TIER_PLAYER_SET)),
                width = "half",
...

            {
                -- Show AOE - Trap
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CI_CCT_AOE_SHOW), GetString(LUIE_LAM_CI_CCT_AOE_TIER_TRAP)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CI_CCT_AOE_SHOW_TP), GetString(LUIE_LAM_CI_CCT_AOE_TIER_TRAP)),
            ...
            },
            {
                -- Sound AOE - Trap
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CI_CCT_AOE_SOUND), GetString(LUIE_LAM_CI_CCT_AOE_TIER_TRAP)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CI_CCT_AOE_SOUND_TP), GetString(LUIE_LAM_CI_CCT_AOE_TIER_TRAP)),
                width = "half",
...

            {
                -- Show AOE - NPC Boss
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CI_CCT_AOE_SHOW), GetString(LUIE_LAM_CI_CCT_AOE_TIER_NPC_BOSS)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CI_CCT_AOE_SHOW_TP), GetString(LUIE_LAM_CI_CCT_AOE_TIER_NPC_BOSS)),
            ...
            },
            {
                -- Sound AOE - NPC Boss
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CI_CCT_AOE_SOUND), GetString(LUIE_LAM_CI_CCT_AOE_TIER_NPC_BOSS)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CI_CCT_AOE_SOUND_TP), GetString(LUIE_LAM_CI_CCT_AOE_TIER_NPC_BOSS)),
                width = "half",
...

            {
                -- Show AOE - NPC Elite
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CI_CCT_AOE_SHOW), GetString(LUIE_LAM_CI_CCT_AOE_TIER_NPC_ELITE)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CI_CCT_AOE_SHOW_TP), GetString(LUIE_LAM_CI_CCT_AOE_TIER_NPC_ELITE)),
            ...
            },
            {
                -- Sound AOE - NPC Elite
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CI_CCT_AOE_SOUND), GetString(LUIE_LAM_CI_CCT_AOE_TIER_NPC_ELITE)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CI_CCT_AOE_SOUND_TP), GetString(LUIE_LAM_CI_CCT_AOE_TIER_NPC_ELITE)),
                width = "half",
...

            {
                -- Show AOE - NPC Normal
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CI_CCT_AOE_SHOW), GetString(LUIE_LAM_CI_CCT_AOE_TIER_NPC_NORMAL)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CI_CCT_AOE_SHOW_TP), GetString(LUIE_LAM_CI_CCT_AOE_TIER_NPC_NORMAL)),
            ...
            },
            {
                ...
                type = "checkbox",
                name = zo_strformat(GetString(LUIE_LAM_CI_CCT_AOE_SOUND), GetString(LUIE_LAM_CI_CCT_AOE_TIER_NPC_NORMAL)),
                tooltip = zo_strformat(GetString(LUIE_LAM_CI_CCT_AOE_SOUND_TP), GetString(LUIE_LAM_CI_CCT_AOE_TIER_NPC_NORMAL)),
                width = "half",

...
function LUIE_CreateSettings()
    ...
    for key, _ in pairs(LUIE.StatusbarTextures) do
        insert(StatusbarTexturesList, key)
    end
    ...
    optionsDataCombatText[#optionsDataCombatText +1] = {
        ...
        controls = {
            ...
            },
            {
                ...
                func = function()
                    CALLBACK_MANAGER:FireCallbacks(LUIE.CombatTextConstants.eventType.COMBAT, LUIE.CombatTextConstants.combatType.INCOMING, POWERTYPE_STAMINA, random(7, 777), GetString(SI_LUIE_LAM_CT_ANIMATION_TEST), 41567, DAMAGE_TYPE_PHYSICAL, "Test", true, false, false, false, false, false, false, false, false, false, false, false, false, false)
                end,
            },
        },
    }

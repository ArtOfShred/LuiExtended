...
function LUIE_CreateSettings()
    ...
    optionsDataChatAnnouncements[#optionsDataChatAnnouncements +1] = {
        ...
        setFunc = function(value) LUIE.ChatAnnouncements.SV.BracketOptionCharacter = linkBracketDisplayOptionsKeys[value] end,
        width = "full",
        disabled = function() return not LUIE.SV.ChatAnnouncements_Enable end,
...
---------------------------------------------------------------------------------------------------------------------------------------
    optionsDataCombatText[#optionsDataCombatText +1] = {
        ...
        controls = {
				...
				{--DAMAGE CRITICAL
                    type    = "slider",
                    name    = L.damagecritical,
                    tooltip = L.tooltipFontDamageCritical,
                    min     = 8,
                    max     = 72,
                    step    = 1,
				...
				{--HEALING CRITICAL
                    type    = "slider",
                    name    = L.healingcritical,
                    tooltip = L.tooltipFontHealingCritical,
                    min     = 8,
                    max     = 72,
                    step    = 1,
				...
				{--DOT CRITICAL
                    type    = "slider",
                    name    = L.dotcritical,
                    tooltip = L.tooltipFontDotCritical,
                    min     = 8,
                    max     = 72,
                    step    = 1,
				...
				{--HOT CRITICAL
                    type    = "slider",
                    name    = L.hotcritical,
                    tooltip = L.tooltipFontHotCritical,
                    min     = 8,
                    max     = 72,
                    step    = 1,
        ...
        --COLOR DAMAGE & HEALING
            {
                ...
                {--CHECKBOX CRITICAL DAMAGE OVERRIDE
                    ...
                    tooltip = L.tooltipCriticalDamage,
                ...
                {--COLOR CRITICAL DAMAGE OVERRIDE
                    type    = "colorpicker",
                    name    = L.colorCriticalDamageOverride,
                    tooltip = L.tooltipColorCriticalDamageOverride,
                ...
                {--CHECKBOX CRITICAL HEALING OVERRIDE
                    ...
                    tooltip = L.tooltipCriticalHealing,
                ...
                {--COLOR CRITICAL HEALING OVERRIDE
                    type    = "colorpicker",
                    name    = L.colorCriticalHealingOverride,
                    tooltip = L.tooltipColorCriticalHealingOverride,
                ...
                {--COLOR INCOMING DAMAGE OVERRIDE
                    type    = "colorpicker",
                    name    = L.colorIncomingDamageOverride,
                    tooltip = L.tooltipColorIncomingDamageOverride,
        ...
        --FORMATS DAMAGE & HEALING
            {
				...
				{--DAMAGE CRITICAL
                    type    = "editbox",
                    name    = L.damagecritical,
                    tooltip = L.tooltipFormatDamageCritical,
				...
				{--HEALING CRITICAL
                    type    = "editbox",
                    name    = L.healingcritical,
                    tooltip = L.tooltipFormatHealingCritical,
				...
				{--DOT CRITICAL
                    type    = "editbox",
                    name    = L.dotcritical,
                    tooltip = L.tooltipFormatDotCritical,
				...
				{--HOT CRITICAL
                    type    = "editbox",
                    name    = L.hotcritical,
                    tooltip = L.tooltipFormatHotCritical,

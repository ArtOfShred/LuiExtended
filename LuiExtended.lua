...
LUIE = {
    ...
    feedback = "https://github.com/ArtOfShred/LuiExtended/issues",
    translation = "https://github.com/ArtOfShred/LuiExtended/tree/develop/i18n",
    donation = "https://www.paypal.me/ArtOfShred",

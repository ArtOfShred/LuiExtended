...
# Remove newlines and extra spaces within each table entry
formatted_code = re.sub(r"\n\s*", "", CODE)

# Add a new line before each match to \[\d+\]
formatted_code = re.sub(r"(\[\d+\])", r"\n\1", formatted_code)

# Write the formatted code to a file
OUTPUT_FILE = "C:\\Users\\Dack\\Documents\\Elder Scrolls Online\\live\\AddOns\\LuiExtended\\.vscode\\Effects.lua"
with open(OUTPUT_FILE, "w") as file:
    file.write(formatted_code)

print("Formatted code has been written to", OUTPUT_FILE)
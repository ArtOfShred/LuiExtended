...
local strings = {
    ...
    SI_LUIE_LAM_BUFF_LONGTERM_MOUNT_ICON =               "Display Generic Mount Icon", -- TODO: Translate
    SI_LUIE_LAM_BUFF_LONGTERM_MOUNT_ICON_TP =            "Use a generic mount icon instead of using the currently selected mount icon.", -- TODO: Translate
    ...
    SI_LUIE_LAM_UF_CFRAMESPT_CLASS_TARGET =              "Target - Use Class Color", -- TODO: Translate
    SI_LUIE_LAM_UF_CFRAMESPT_CLASS_TARGET_TP =           "Color the target frame by Player Class instead of using the health bar color. This will take precedent over Reaction Color when both are enabled.", -- TODO: Translate
    ...
    SI_LUIE_SKILL_MINOR_EVASION_TP =                     "Reduce damage from area attacks by |cffffff5|r%.",

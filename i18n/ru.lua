...
local strings = {
	...
	SI_LUIE_LAM_SLASHCMDS_OUTFIT =						 "Включить ( '/outfit' ) наряд",
    ...
    SI_LUIE_LAM_BUFF_LONGTERM_MOUNT_ICON =               "Общий значок езд. животного", -- TODO: Translate
    ...
    SI_LUIE_LAM_CA_LOOT_SHOWCRAFT_MATERIALS_TP =         "Выводить ли в чат оповещение о расходе материалов при ремесле.\nNote: This setting only works properly if you have ESO Plus and therefore have the crafting bag unlocked.", -- TODO: Translate 2nd part of this string
    ...
    SI_LUIE_LAM_UF_DFRAMES_BOSS_COMPASS =                "Hide Default COMPASS Boss Bar", -- TODO: TRANSLATE
    SI_LUIE_LAM_UF_DFRAMES_BOSS_COMPASS_TP =             "Enable this option to hide the default boss bar that overlays the Compass.", -- TODO: TRANSLATE
    ...
    SI_LUIE_LAM_UF_CFRAMESPT_REACTION_TARGET_TP =        "Цвет фрейма цели определяется реакцией, а не цветом для полоски здоровья.",
    ...
    SI_LUIE_LAM_CT_COLOR_COMBAT_DAMAGE_FIRE =            "Цвет шрифта (Огненные)",
    ...
    SI_LUIE_SKILL_FIRELIGHT_TP =                         "Увеличивает Запас сил на |cFFFFFF5|r% в течение |cFFFFFF30|r мунут.",
    ...
    SI_LUIE_SKILL_MINOR_EVASION_TP =                     "Reduce damage from area attacks by |cffffff5|r%.", -- TODO: Translate
    SI_LUIE_SKILL_MAJOR_EVASION_TP =                     "Reduce damage from area attacks by |cffffff25|r%.", -- TODO: Translate
    ...
    SI_LUIE_SKILL_MINOR_HEROISM_TP =                     "Даёт |cffffff1|r очков ульты каждые |cffffff1.5|r секунд.",
    SI_LUIE_SKILL_MAJOR_HEROISM_TP =                     "Даёт |cffffff3|r очков ульты каждые |cffffff1.5|r секунд.",
    ...
    SI_LUIE_SKILL_QUEST_LIGHTNING_FURY_TP =              "Молния протекает через ваше тело, наделяя все ваши атаки оружием электрическим уроном.",

...
local strings = {
    ...
    SI_LUIE_SKILL_MINOR_RESOLVE_TP =                     "Increase Physical Resistance by |cffffff1320|r for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MAJOR_RESOLVE_TP =                     "Increase Physical Resistance by |cffffff5280|r for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MINOR_WARD_TP =                        "Increase Spell Resistance by |cffffff1320|r for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MAJOR_WARD_TP =                        "Increase Spell Resistance by |cffffff5280|r for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MINOR_FORTITUDE_TP =                   "Increase Health Recovery by |cffffff10|r% for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MAJOR_FORTITUDE_TP =                   "Increase Health Recovery by |cffffff20|r% for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MINOR_ENDURANCE_TP =                   "Increase Stamina Recovery by |cffffff10|r% for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MAJOR_ENDURANCE_TP =                   "Increase Stamina Recovery by |cffffff20|r% for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MINOR_INTELLECT_TP =                   "Increase Magicka Recovery by |cffffff10|r% for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MAJOR_INTELLECT_TP =                   "Increase Magicka Recovery by |cffffff20|r% for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MINOR_SORCERY_TP =                     "Increase Spell Damage by |cffffff5|r% for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MAJOR_SORCERY_TP =                     "Increase Spell Damage by |cffffff20|r% for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MINOR_PROPHECY_TP =                    "Increase Spell Critical by |cffffff657|r for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MAJOR_PROPHECY_TP =                    "Increase Spell Critical by |cffffff2191|r for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MINOR_BRUTALITY_TP =                   "Increase Weapon Damage by |cffffff5|r% for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MAJOR_BRUTALITY_TP =                   "Increase Weapon Damage by |cffffff20|r% for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MINOR_SAVAGERY_TP =                    "Increase Weapon Critical by |cffffff657|r for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MAJOR_SAVAGERY_TP =                    "Increase Weapon Critical by |cffffff2191|r for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MINOR_BERSERK_TP =                     "Increase damage done by |cffffff8|r% for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MAJOR_BERSERK_TP =                     "Increase damage done by |cffffff25|r% for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MINOR_FORCE_TP =                       "Increase Critical Damage by |cffffff10|r% for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MAJOR_FORCE_TP =                       "Increase Critical Damage by |cffffff15|r% for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MINOR_VITALITY_TP =                    "Increase healing received by |cffffff8|r% for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MAJOR_VITALITY_TP =                    "Increase healing received by |cffffff30|r% for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MINOR_MENDING_TP =                     "Increase healing done by |cffffff8|r% for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MAJOR_MENDING_TP =                     "Increase healing done by |cffffff25|r% for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MINOR_PROTECTION_TP =                  "Reduce damage taken by |cffffff8|r% for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MAJOR_PROTECTION_TP =                  "Reduce damage taken by |cffffff30|r% for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MINOR_EVASION_TP =                     "Increase dodge chance by |cffffff5|r% for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MAJOR_EVASION_TP =                     "Increase dodge chance by |cffffff15|r% for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MINOR_EXPEDITION_TP =                  "Increase Movement Speed by |cffffff10|r% for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MAJOR_EXPEDITION_TP =                  "Increase Movement Speed by |cffffff30|r% for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MAJOR_GALLOP_TP =                      "Increase Mounted Speed by |cffffff30|r% for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MINOR_HEROISM_TP =                     "Gain |cffffff1|r Ultimate every |cffffff1.5|r seconds for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MAJOR_HEROISM_TP =                     "Gain |cffffff3|r Ultimate every |cffffff1.5|r seconds for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MINOR_TOUGHNESS_TP =                   "Increase Max Health by |cffffff10|r% for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MAJOR_COURAGE_TP =                     "Increase Weapon Damage and Spell Damage by |cffffff258|r for |cffffff<<1>>|r seconds.",

    SI_LUIE_SKILL_MINOR_BREACH_TP =                      "Reduce Spell Resistance by |cffffff1320|r for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MAJOR_BREACH_TP =                      "Reduce Spell Resistance by |cffffff5280|r for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MINOR_FRACTURE_TP =                    "Reduce Physical Resistance |cffffff1320|r for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MAJOR_FRACTURE_TP =                    "Reduce Physical Resistance |cffffff5280|r for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MINOR_VULNERABILITY_TP =               "Increase damage taken by |cffffff8|r% for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MINOR_MAIM_TP =                        "Reduce damage done by |cffffff15|r% for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MAJOR_MAIM_TP =                        "Reduce damage done by |cffffff30|r% for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MINOR_DEFILE_TP =                      "Reduce healing received and Health Recovery by |cffffff15|r% for |cffffff<<1>>|r seconds.",
    SI_LUIE_SKILL_MAJOR_DEFILE_TP =                      "Reduce healing received and Health Recovery by |cffffff30|r% for |cffffff<<1>>|r seconds.",
    ...
    SI_LUIE_SKILL_MINOR_ENERVATION_TP =                  "Reduce Critical Damage by |cffffff10|r% for |cffffff<<1>>|r seconds.",

...
local strings = {
    ...
    SI_LUIE_LAM_UF_DFRAMES_BOSS_COMPASS =                "Default BOSS Frame (Compass)", -- TODO: TRANSLATE
    ...
    SI_LUIE_SKILL_MINOR_EVASION_TP =                     "Reduce damage from area attacks by |cffffff10|r%.", -- TODO: Translate

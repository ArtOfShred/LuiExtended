...
local strings = {
    ...
    SI_LUIE_SLASHCMDS_COLLECTIBLE_SUMMON_NN =            "You summon <<1>> \"|cFFFFFF<<2>>|r.\"",
    SI_LUIE_SLASHCMDS_COLLECTIBLE_SUMMON =               "You summon <<1>>.",
    SI_LUIE_SLASHCMDS_COLLECTIBLE_UNSUMMON_NN =          "You dismiss <<1>> \"|cFFFFFF<<2>>|r.\"",
    SI_LUIE_SLASHCMDS_COLLECTIBLE_UNSUMMON =             "You dismiss <<1>>.",
    SI_LUIE_SLASHCMDS_COLLECTIBLE_USED =                 "You use <<1>>.",

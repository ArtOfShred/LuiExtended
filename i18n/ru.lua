...
local strings = {
    ...
    SI_LUIE_CT_MITIGATION_FORMAT_POWER =                 "%t!",
    SI_LUIE_CT_MITIGATION_FORMAT_POWER_N =               "%t на %n!",
    SI_LUIE_CT_MITIGATION_FORMAT_DESTROY =               "%t",
    SI_LUIE_CT_MITIGATION_FORMAT_DESTROY_N =             "%t",
    SI_LUIE_CT_MITIGATION_FORMAT_SUMMON =                "%t",
    SI_LUIE_CT_MITIGATION_FORMAT_SUMMON_N =              "%t",

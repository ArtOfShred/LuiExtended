local strings = {
    ...
    SI_LUIE_LAM_UF_DFRAMES_BOSS_COMPASS =                "Hide Default COMPASS Boss Bar",
    SI_LUIE_LAM_UF_DFRAMES_BOSS_COMPASS_TP =             "Enable this option to hide the default boss bar that overlays the Compass.",

...
ZO_CreateStringId("SI_LUIE_CA_GROUP_FINDER_NOTIFY_VOTEKICK_FAIL_ALT",   "A vote to kick |cFEFEFE<<1>>|r from the group has failed.") -- Wwhen localize option is turned on, this replaces other format.

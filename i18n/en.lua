...
ZO_CreateStringId("SI_LUIE_CA_CURRENCY_MESSAGE_GAINEDSTACK",            "Gained Stack")
...
ZO_CreateStringId("SI_LUIE_CA_CURRENCY_MESSAGE_LOOTED",                 "Looted")
ZO_CreateStringId("SI_LUIE_CA_CURRENCY_MESSAGE_LOOTEDITEM",             "Looted Item")
ZO_CreateStringId("SI_LUIE_CA_CURRENCY_MESSAGE_LOST",                   "Lost")
ZO_CreateStringId("SI_LUIE_CA_CURRENCY_MESSAGE_REFINED",                "Refined")
ZO_CreateStringId("SI_LUIE_CA_CURRENCY_MESSAGE_SENT",                   "Sent")
ZO_CreateStringId("SI_LUIE_CA_CURRENCY_MESSAGE_SOLD",                   "Sold")
ZO_CreateStringId("SI_LUIE_CA_CURRENCY_MESSAGE_SPENT",                  "Spent")
ZO_CreateStringId("SI_LUIE_CA_CURRENCY_MESSAGE_TRADED",                 "Traded")
ZO_CreateStringId("SI_LUIE_CA_CURRENCY_MESSAGE_UPGRADED",               "Upgraded")
ZO_CreateStringId("SI_LUIE_CA_CURRENCY_MESSAGE_USED",                   "Used")
ZO_CreateStringId("SI_LUIE_CA_CURRENCY_MESSAGE_WITHDREW",               "Withdrew")

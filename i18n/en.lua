...
ZO_CreateStringId("SI_LUIE_LAM_UNITFRAMES_DEFFRAMES_FONT_SIZE_TOOLTIP", "Font Size to be used on all labels on the default unit frames bars.")
ZO_CreateStringId("SI_LUIE_LAM_UNITFRAMES_DEFFRAMES_FONT_TOOLTIP",      "Font to display all labels on default frames.")
ZO_CreateStringId("SI_LUIE_LAM_UNITFRAMES_DEFFRAMES_GROUPSMALL",        "Default Small GROUP Frame")
ZO_CreateStringId("SI_LUIE_LAM_UNITFRAMES_DEFFRAMES_HEADER",            "Default Unit Frames")
ZO_CreateStringId("SI_LUIE_LAM_UNITFRAMES_DEFFRAMES_INCTRANSP",         "In-Combat bars transparency")
ZO_CreateStringId("SI_LUIE_LAM_UNITFRAMES_DEFFRAMES_INCTRANS_TOOLTIP",  "Change the value of transparency of default unit frames when in combat. Default UI makes frames fully visible, this value is 100.")
ZO_CreateStringId("SI_LUIE_LAM_UNITFRAMES_DEFFRAMES_LABEL",             "Format label text")
ZO_CreateStringId("SI_LUIE_LAM_UNITFRAMES_DEFFRAMES_LABEL_COLOR",       "Color of text labels")
ZO_CreateStringId("SI_LUIE_LAM_UNITFRAMES_DEFFRAMES_LABEL_TOOLTIP",     "Format of the label text over default unit frames.")
ZO_CreateStringId("SI_LUIE_LAM_UNITFRAMES_DEFFRAMES_OOCTRANS",          "Out-of-Combat bars transparency")
ZO_CreateStringId("SI_LUIE_LAM_UNITFRAMES_DEFFRAMES_OOCTRANS_TOOLTIP",  "Change the value of transparency of default unit frames when out of combat. Default UI makes frames disappear completely, this value is 0.")
ZO_CreateStringId("SI_LUIE_LAM_UNITFRAMES_DEFFRAMES_PLAYER",            "Default PLAYER Frame")
ZO_CreateStringId("SI_LUIE_LAM_UNITFRAMES_DEFFRAMES_REPOSIT",           "Reposition default player bars")
ZO_CreateStringId("SI_LUIE_LAM_UNITFRAMES_DEFFRAMES_REPOSIT_TOOLTIP",   "Change position of default unit frames to be stuck in the center.")
ZO_CreateStringId("SI_LUIE_LAM_UNITFRAMES_DEFFRAMES_TARGET",            "Default TARGET Frame")
ZO_CreateStringId("SI_LUIE_LAM_UNITFRAMES_DESCRIPTION",                 "This allows display of textual attributes information over default UI controls. It also creates custom frames for player and target.")
ZO_CreateStringId("SI_LUIE_LAM_UNITFRAMES_ENABLE",                      "Allow mouse dragging for Info Panel.")
ZO_CreateStringId("SI_LUIE_LAM_UNITFRAMES_SHORTNUMBERS",                "Shorten numbers on all bars")
ZO_CreateStringId("SI_LUIE_LAM_UNITFRAMES_SHORTNUMBERS_TOOLTIP",        "Replace large numbers like 12,345 with 12.3k on all bars and labels related to unit frames.")

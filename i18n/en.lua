local strings = {
    ...
    SI_LUIE_SKILL_SHATTERING_ROCKS_TP =                  "Your next attack used within |cffffff4|r seconds heals your target.",
    ...
    SI_LUIE_SKILL_NEGATE_MAGIC_TP =                      "Enemies in the globe are stunned for |cFFFFFF12|r seconds. Enemy players will be silenced rather than stunned.",
    SI_LUIE_SKILL_SUPPRESSION_FIELD_TP =                 "Enemies in the globe are stunned and take Magic Damage every |cFFFFFF0.5|r seconds for |cFFFFFF12|r seconds. Enemy players will be silenced rather than stunned.",
    SI_LUIE_SKILL_ABSORPTION_FIELD_TP =                  "Enemies in the globe are stunned and allies are healed every |cFFFFFF0.5|r seconds for |cFFFFFF12|r seconds. Enemy players will be silenced rather than stunned.",

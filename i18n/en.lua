...
ZO_CreateStringId("SI_LUIE_LAM_BUFF_MISC_SHOWREZZ",                     "Show Resurrection Immunity icon")
ZO_CreateStringId("SI_LUIE_LAM_BUFF_MISC_SHOWREZZ_TOOLTIP",             "Show Resurrection Immunity icon")
ZO_CreateStringId("SI_LUIE_LAM_BUFF_MISC_SHOWRECALL",                   "Show Recall Cooldown icon")

local strings = {
    ...
    SI_LUIE_SKILL_GENERIC_BLIND_TP =                     "Blinded. |cffffff100|r% chance to miss all attacks.",
    ...
    SI_LUIE_SKILL_SET_GENERIC_IMMUNITY_TP =              "Immune to damage and crowd control effects.",
    ...
    SI_LUIE_SKILL_ENGULFING_FLAMES_TP =                  "Afflicted with Flame Damage over time. Increase damage taken from Fire Damage attacks by |cffffff10|r%.",
    ...
    SI_LUIE_SKILL_SET_RELEQUENS_TP =                     "Engulfed in harmful winds, afflicted with Physical damage over time.",

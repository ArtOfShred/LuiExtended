...
ZO_CreateStringId("SI_LUIE_LAM_BUFF_MISC_SHOWBLOCK",                    "Show Block icon")
ZO_CreateStringId("SI_LUIE_LAM_BUFF_MISC_SHOWBLOCK_TOOLTIP",            "Display special buff icon when player is holding block.")
ZO_CreateStringId("SI_LUIE_LAM_BUFF_MISC_SHOWSTEALTH",                  "Show Stealth icon")
ZO_CreateStringId("SI_LUIE_LAM_BUFF_MISC_SHOWSTEALTH_TOOLTIP",          "Display special buff icon when player is hidden or in stealth.")

...
ZO_CreateStringId("SI_LUIE_LAM_CA_CURRENCY_COLOR_CONTEXT",              "Use Context Color for Currency Gain/Loss")
ZO_CreateStringId("SI_LUIE_LAM_CA_CURRENCY_COLOR_CONTEXT_TP",           "Color the currency message depending on whether currency was gained or lost.")
ZO_CreateStringId("SI_LUIE_LAM_CA_CURRENCY_COLOR",                      "Currency Message Color")
-- TODO: Add Tooltip with finalized color value
ZO_CreateStringId("SI_LUIE_LAM_CA_CURRENCY_COLORDOWN",                  "Currency Loss Color")
-- TODO: Add Tooltip with finalized color value
ZO_CreateStringId("SI_LUIE_LAM_CA_CURRENCY_COLORUP",                    "Currency Gain Color")
-- TODO: Add Tooltip with finalized color value

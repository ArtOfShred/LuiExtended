...
local strings = {
    ...
    SI_LUIE_CA_FRIENDS_FRIEND_ADDED =                    "|cFEFEFE<<1>>|r added to friends list.",
    SI_LUIE_CA_FRIENDS_FRIEND_REMOVED =                  "|cFEFEFE<<1>>|r removed from friends list.",
    ...
    SI_LUIE_CA_FRIENDS_LIST_IGNORE_ADDED =               "|cFEFEFE<<1>>|r added to ignore list.",
    SI_LUIE_CA_FRIENDS_LIST_IGNORE_REMOVED =             "|cFEFEFE<<1>>|r removed from ignore list.",

...
ZO_CreateStringId("SI_LUIE_CA_GUILD_RANK_CHANGED",                      "|cFEFEFE<<1>>|r has been changed to rank <<3>> in <<2>>.")
...
--ZO_CreateStringId("SI_LUIE_CA_GUILD_ROSTER_REMOVED",                    "|cFEFEFE<<1>>|r has been removed from <<2>>.")

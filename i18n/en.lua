...
ZO_CreateStringId("SI_LUIE_LAM_LUIPRINTTOCHAT",                         "Add Timestamps to System Messages")
ZO_CreateStringId("SI_LUIE_LAM_LUIPRINTTOCHAT_TP",                      "Enabling this will prevent other chat addons like PChat from interfering with system messages displayed by LUIE, and allow you to prepend messages with a timestamp similiar to pChat.")

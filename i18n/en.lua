...
ZO_CreateStringId("SI_LUIE_LAM_CHATMETHOD",                             "Choose Chat Message Display Method")
ZO_CreateStringId("SI_LUIE_LAM_CHATMETHOD_TP",                          "Choose whether to print chat messages to all tabs or print to individual tabs.")
ZO_CreateStringId("SI_LUIE_LAM_CHATBYPASS",                             "Enable pChat Message Saving")
ZO_CreateStringId("SI_LUIE_LAM_CHATBYPASS_TP",                          "Enabling this will prevent LUIE from adding timestamps to messages and allow pChat or other chat addons to handle chat messages. When using pChat, these messages can be saved and restored on reload.\nNote: This option is only available for messages printed to all tabs as pChat does not yet support messages sent to specific tabs.")
...
ZO_CreateStringId("SI_LUIE_LAM_TIMESTAMPCOLOR",                         "Timestamp Color")
ZO_CreateStringId("SI_LUIE_LAM_TIMESTAMPCOLOR_TP",                      "Color to use for Timestamp.\nDefault: 143/143/143")
ZO_CreateStringId("SI_LUIE_LAM_TIMESTAMP_TP",                           "Prepend printed text with current time label. This will apply to any messages sent by LUIE & System Messages but not player chat messages. Default color and format matches pChat.")
...
ZO_CreateStringId("SI_LUIE_LAM_CHATHEADER",                             "Chat Message Settings")
ZO_CreateStringId("SI_LUIE_LAM_CHATTAB",                                "\t\t\t\t\tDisplay Chat Announcements in Chat Tab <<1>>")
ZO_CreateStringId("SI_LUIE_LAM_CHATTAB_TP",                             "Display Notifications & Chat Announcements in Chat Tab <<1>>.")
ZO_CreateStringId("SI_LUIE_LAM_CHATTABSYSTEMALL",                       "Display System Messages in ALL Tabs")
ZO_CreateStringId("SI_LUIE_LAM_CHATTABSYSTEMALL_TP",                    "When enabled: System Messages, Social Notifications (Group, Guild, Friends & Ignored List, Trade & Duels), Slash Command Notifications and Error Messages will display in all chat tabs.")

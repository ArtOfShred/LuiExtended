local strings = {
    ...
    SI_LUIE_SKILL_GENERIC_BURN_TP =                      "Afflicted with fire damage over time for |cffffff<<1>>|r <<1[second/seconds]>>.",
    ...
    SI_LUIE_SKILL_GENERIC_STAGGER_TP =                   "Staggered for |cffffff<<1>>|r <<1[second/seconds]>>. You are unable to attack or move while staggered.",
    ...
    SI_LUIE_SKILL_IMMOBILIZE_IMMUNITY_TP =               "Immune to all snare and immobilization effects for |cFFFFFF<<1>>|r <<1[second/seconds]>>.",
    ...
    SI_LUIE_SKILL_INVISIBLE_TP =                         "Concealed from sight by magical or environmental means.\nAttacking from stealth grants you a |cFFFFFF100|r% Critical Strike Chance, a |cFFFFFF275|r% Melee Critical Damage bonus (|cFFFFFF46|r% Ranged Critical Damage bonus), and stuns the target for |cFFFFFF2|r seconds.",

...
local strings = {
    ...
    SI_LUIE_LAM_BUFF_LONGTERM_MOUNT_PLAYER =             "Show Icon for Active Mount on Player",
    ...
    SI_LUIE_LAM_CT_BLACKLIST_ADD_CROUCH =                "Add Crouch Drain",
    SI_LUIE_LAM_CT_BLACKLIST_ADD_CROUCH_TP =             "Add Crouch stamina drain to the blacklist.",

...
local strings = {
    ...
    SI_LUIE_LAM_CI_ALERT_MITIGATION_FORMAT =             "Mitigation Alert Prefix",
    SI_LUIE_LAM_CI_ALERT_MITIGATION_FORMAT_TP =          "Choose the prefix to display for mitigation alerts",

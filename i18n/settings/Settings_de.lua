...
local strings = {
    ...
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_CONSUME =            "Consume (Food, Potion, etc)",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_CONSUME_TP =         "Default: You consume %s.",
    ...
    SI_LUIE_LAM_CA_LOOT_LOOTSHOWUSE_FOOD_DRINK =         "Display Item Loss - Food & Drink Used",
    SI_LUIE_LAM_CA_LOOT_LOOTSHOWUSE_FOOD_DRINK_TP =      "Display a message when you consume food or drink.",

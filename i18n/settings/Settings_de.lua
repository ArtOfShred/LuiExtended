...
local strings = {
    ...
    SI_LUIE_LAM_UF_CFRAMESPET_ENABLE_TP =                "Create custom pet unit frames. This will track the health of up to 6 player pets.",
    ...
    SI_LUIE_LAM_UF_CFRAMESPET_USE_CLASS_COLOR_TP =       "Color the pet frame by Player Class instead of using the pet bar color (Also applies to Target Frame).",

...
local strings = {
    ...
    SI_LUIE_LAM_UF_BLACKLIST_DESCRIPT =                  "Add pet names to the Blacklist by entering the name into the input field and pressing enter. Remove pet names from the Blacklist by clicking the pet name from the dropdown list.\nNote: Names are not case-sensitive.",

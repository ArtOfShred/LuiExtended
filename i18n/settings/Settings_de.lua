...
local strings = {
    ...
    SI_LUIE_LAM_CI_ALERT_SOUND_GROUND_TRAVEL_CC_TP =     "Use this sound when an enemy casts a moving ground effect that applies hard Crowd Control such as the Daedric's Titan's Soul Flame ability.",

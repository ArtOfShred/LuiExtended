...
local strings = {
    ...
    SI_LUIE_LAM_BUFF_PROM_BUFFALIGNMENT_VERT =           "Vertical Prominent Buff Alignment",
    SI_LUIE_LAM_BUFF_PROM_BUFFALIGNMENT_VERT_TP =        "Alignment of buff and debuff icons within the prominent buff container when set to vertical orientation.",
    SI_LUIE_LAM_BUFF_PROM_BUFFALIGNMENT_HORIZ =          "Horizontal Prominent Buff Alignment",
    SI_LUIE_LAM_BUFF_PROM_BUFFALIGNMENT_HORIZ_TP =       "Alignment of buff and debuff icons within the prominent buff container when set to horizontal orientation.",
    SI_LUIE_LAM_BUFF_PROM_DEBUFFALIGNMENT_VERT =         "Vertical Prominent Debuff Alignment",
    SI_LUIE_LAM_BUFF_PROM_DEBUFFALIGNMENT_VERT_TP =      "Alignment of buff and debuff icons within the prominent buff container when set to vertical orientation.",
    SI_LUIE_LAM_BUFF_PROM_DEBUFFALIGNMENT_HORIZ =        "Horizontal Prominent Debuff Alignment",
    SI_LUIE_LAM_BUFF_PROM_DEBUFFALIGNMENT_HORIZ_TP =     "Alignment of buff and debuff icons within the prominent buff container when set to horizontal orientation.",

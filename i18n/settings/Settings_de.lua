...
local strings = {
    ...
    SI_LUIE_LAM_SLASHCMDS_BANKER_TP =                    "'/banker' Beschwört <<1>> (wenn freigeschaltet).\n\t\t\t\t\tAlternative Optionen: '/bank'",
    SI_LUIE_LAM_SLASHCMDS_MERCHANT =                     "Aktiviere ( '/merchant' ) Händler",
    SI_LUIE_LAM_SLASHCMDS_MERCHANT_TP =                  "'/merchant' Beschwört <<1>> (wenn freigeschaltet).\n\t\t\t\t\tAlternative Optionen: '/sell', '/vendor'",
    SI_LUIE_LAM_SLASHCMDS_ARMORY =                       "Aktiviere ( '/armory' ) Waffenkammer",
    SI_LUIE_LAM_SLASHCMDS_ARMORY_TP =                    "'/armory' Beschwört <<1>> (wenn freigeschaltet).",
	SI_LUIE_LAM_SLASHCMDS_DECON =                        "Aktiviere ( '/decon' ) Dekonstruktion",

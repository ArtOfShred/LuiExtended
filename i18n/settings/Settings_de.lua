...
local strings = {
    ...
    -- Settings
    SI_LUIE_LAM_COMPATIBILITY_WARNING = "Deaktiviere diese Option, wenn es Probleme mit anderen Addons gibt.",
    SI_LUIE_LAM_FONT = "Schrift",
    SI_LUIE_LAM_FONT_SIZE = "Schriftgröße",
    SI_LUIE_LAM_FONT_STYLE = "Schriftart",
    ...
    SI_LUIE_LAM_CHANGELOG = "Changelog anzeigen",
    SI_LUIE_LAM_CHANGELOG_TP = "Zeigt eine Liste mit Änderungen gegenüber der vorigen Version von LUIE.",
    SI_LUIE_LAM_STARTUPMSG = "Start-Nachricht deaktivieren",
    SI_LUIE_LAM_STARTUPMSG_TP = "Diese Einstellung deaktiviert die Start-Nachricht von LUIE.",
    SI_LUIE_LAM_SVPROFILE_HEADER = "Charakter-Profil-Einstellungen",
    SI_LUIE_LAM_SVPROFILE_DESCRIPTION = "Standardmäßig verwendet LUIE accountweite Einstellungen. Unten können charakterspezifische Einstellungen aktiviert werden. Profile können zwischen Charakteren kopiert werden und einzelne oder accountweite Einstellungen können unten zurückgesetzt werden. Bitte beachten, dass accountweite Einstellungen beibehalten werden, sollte von individuellen Einstellungen zurückgestellt werden.",
    SI_LUIE_LAM_SVPROFILE_SETTINGSTOGGLE = "Charakterspezifische Einstellungen aktivieren",
    SI_LUIE_LAM_SVPROFILE_SETTINGSTOGGLE_TP = "Wechsel zwischen accountweiten und charakterspezifischen Einstellungen.",
    SI_LUIE_LAM_SVPROFILE_PROFILECOPY = "Charakter-Profil kopieren",
    SI_LUIE_LAM_SVPROFILE_PROFILECOPY_TP = "Einen Charakter oder accountweite Einstellungen wählen, die kopiert werden sollen.",
    SI_LUIE_LAM_SVPROFILE_PROFILECOPYBUTTON = "Profil kopieren",
    SI_LUIE_LAM_SVPROFILE_PROFILECOPYBUTTON_TP = "Markiertes Profil auf aktuellen Charakter oder accountweite Einstellungen anwenden.",
    SI_LUIE_LAM_SVPROFILE_RESETCHAR = "Aktuellen Charakter zurücksetzen",
    SI_LUIE_LAM_SVPROFILE_RESETCHAR_TP = "Setzt die aktuellen Charakter-Profil-Einstellungen zurück.",
    SI_LUIE_LAM_SVPROFILE_RESETACCOUNT = "Accountweit zurücksetzen",
    SI_LUIE_LAM_SVPROFILE_RESETACCOUNT_TP = "Setzt die accountweiten Einstellungen zurück. Beachten, dass hiervon keine charakterspezifischen Einstellungen betroffen sind.",
    ...
    SI_LUIE_LAM_CA = "Chat Bekanntgabe",
    SI_LUIE_LAM_CI = "Kampf Info",
    SI_LUIE_LAM_SLASHCMDS = "Slash Befehle",
    SI_LUIE_LAM_CI_DESCRIPTION = "Erlaubt die Anzeige von Ultimate-Werten auf Leisten, Effekt-Tracker auf Leisten sowie Cooldown-Tracking für Schnellwahl-Items und GCD Anzeigen auf Aktionsleisten.",
    SI_LUIE_LAM_BUFFS_DESCRIPTION = "Aktiviert Buff- und Debuffanzeigen für Spieler- und Gegnereffekte. Enthält desweiteren Einstellungen für weitere Verbesserungen.",
    SI_LUIE_LAM_BUFFSDEBUFFS = "Buffs & Debuffs",
    SI_LUIE_LAM_MODULEHEADER = "Modul Einstellungen",
    SI_LUIE_LAM_MISCHEADER = "Versch. Einstellungen",

    -- Module: Slash Commands
    SI_LUIE_LAM_SLASHCMDS_ENABLE = "Slash Befehle-Modul",
    SI_LUIE_LAM_SLASHCMDS_DESCRIPTION = "Eigene /slash-Befehle zur Ausführung diverser Grundfunktionen wie Gruppenkick, Gildeneinladung oder Freundeseinladung hinzufügen.",
    SI_LUIE_LAM_SLASHCMDSHEADER = "Slash Befehle",
    SI_LUIE_LAM_SLASHCMDSHEADER_GENERAL = "Allgemeine Befehle",
    SI_LUIE_LAM_SLASHCMDS_TRADE = "Aktiviere ( '/trade' ) Handel",
    SI_LUIE_LAM_SLASHCMDS_TRADE_TP = "'/trade' 'Name' Lädt einen Spieler zum Handel ein.",
    SI_LUIE_LAM_SLASHCMDS_HOME = "Aktiviere ( '/home' ) Heimatteleport",
    ...
    SI_LUIE_LAM_SLASHCMDS_CAMPAIGN = "Aktiviere ( '/campaign' ) Kampagnen-Warteschlange",
    SI_LUIE_LAM_SLASHCMDS_CAMPAIGN_TP = "'/campaign' 'Name' Listet für den angegebenen Kampagnennamen, wenn dieser die Heimat- oder Gast-Kampagne ist.",
    SI_LUIE_LAM_SLASHCMDSHEADER_GROUP = "Gruppen Befehle",
    SI_LUIE_LAM_SLASHCMDS_REGROUP = "Aktiviere ( '/regroup' ) Regroup Funktion",
    SI_LUIE_LAM_SLASHCMDS_REGROUP_TP = "'/regroup' Speichert die aktuelle Gruppenkonfiguration, löst die Gruppe auf und lädt die Mitglieder nach 5 Sekunden neu ein.",
    SI_LUIE_LAM_SLASHCMDS_LEAVE = "Aktiviere ( '/leave' ) Gruppenverlassen",
    SI_LUIE_LAM_SLASHCMDS_LEAVE_TP = "'/leave' Verlässt die aktuelle Gruppe.\n\t\t\t\t\tAlternative Optionen: '/leavegroup'",
    SI_LUIE_LAM_SLASHCMDS_DISBAND = "Aktiviere ( '/disband' ) Gruppenauflösung",
    SI_LUIE_LAM_SLASHCMDS_DISBAND_TP = "'/disband' Löst die aktuelle Gruppe als Gruppenanführer auf.",
    SI_LUIE_LAM_SLASHCMDS_KICK = "Aktiviere ( '/kick' ) Gruppenentfernung",
    SI_LUIE_LAM_SLASHCMDS_KICK_TP = "'/kick' 'Name' Wirft ein Mitglied als Gruppenanführer aus der Gruppe.\n\t\t\t\t\tAnmerkung: Ersetzt nicht den /kick Emote.\n\t\t\t\t\tAlternative Optionen: '/remove', '/groupkick', '/groupremove'",
    SI_LUIE_LAM_SLASHCMDS_ROLE = "Aktiviere Rollenwechsel ( '/changerole'  )",
    SI_LUIE_LAM_SLASHCMDS_ROLE_TP = "'/changerole' Ändert die Rolle in der Gruppe auf 'dps' oder 'heal' oder 'tank' ",
    SI_LUIE_LAM_SLASHCMDS_VOTEKICK = "Aktiviere ( '/votekick') Rauswurf-Abstimmung",
    SI_LUIE_LAM_SLASHCMDS_VOTEKICK_TP = "/votekick' 'Name' Initiiert eine Umfrage zum Rauswerfen eines Mitglieds aus der aktuellen LFG Gruppe.\n\t\t\t\t\tAlternative Optionen: '/voteremove'",
    SI_LUIE_LAM_SLASHCMDSHEADER_GUILD = "Gilden Befehle",
    SI_LUIE_LAM_SLASHCMDS_GUILDINVITE = "Aktiviere ( '/guildinvite' ) Gildeneinladung",
    SI_LUIE_LAM_SLASHCMDS_GUILDINVITE_TP = "'/guildinvite' '#' 'Name' Lädt einen Spieler in eine von der Reihenfolge im Gildenmenü abhängige Gilde ein.\n\t\t\t\t\tAlternative Optionen: /'ginvite'",
    SI_LUIE_LAM_SLASHCMDS_GUILDKICK = "Aktiviere ( '/guildkick' ) Gildenrauswurf",
    SI_LUIE_LAM_SLASHCMDS_GUILDKICK_TP = "'/guildkick' '#' 'Name' Wirft einen Spieler aus einer von der Reihenfolge im Gildenmenü abhängige Gilde, solange benötigte Berechtigungen vorhanden sind.\n\t\t\t\t\tAlternative Optionen: '/gkick'",
    SI_LUIE_LAM_SLASHCMDS_GUILDQUIT = "Aktiviere ( '/guildquit' ) Gildenverlassen",
    SI_LUIE_LAM_SLASHCMDS_GUILDQUIT_TP = "'/guildquit' '#' Verlässt eine von der Reihenfolge im Gildenmenü abhängige Gilde.\n\t\t\t\t\tAlternative Optionen: '/gquit', '/guildleave', '/gleave'",
    SI_LUIE_LAM_SLASHCMDSHEADER_SOCIAL = "Soziale Befehle",
    SI_LUIE_LAM_SLASHCMDS_FRIEND = "Aktiviere ( '/friend' ) Freundeseinladung",
    SI_LUIE_LAM_SLASHCMDS_FRIEND_TP = "'/friend' 'Name' Lädt einen Spieler auf die Freundesliste ein.\n\t\t\t\t\tAlternative Optionen: '/addfriend'",
    SI_LUIE_LAM_SLASHCMDS_IGNORE = "Aktiviere ( '/ignore' ) Ignorieren",
    SI_LUIE_LAM_SLASHCMDS_IGNORE_TP = "'/ignore' 'Name' Fügt einen Spieler zu den ignorierten Spielern hinzu.\n\t\t\t\t\t\tAlternative Optionen: '/addignore'",
    SI_LUIE_LAM_SLASHCMDS_REMOVEFRIEND = "Aktiviere ( '/removefriend' ) Freundlöschung",
    SI_LUIE_LAM_SLASHCMDS_REMOVEFRIEND_TP = "'/unfriend' 'Name' Entfernt einen Spieler von der Freundesliste.\n\t\t\t\t\tAlternative Optionen: '/removefriend'",
    SI_LUIE_LAM_SLASHCMDS_REMOVEIGNORE = "Aktiviere ( /'removeignore' ) Nicht-Ignorieren",
    SI_LUIE_LAM_SLASHCMDS_REMOVEIGNORE_TP = "'/unignore' 'Name' Entfernt einen Spieler aus den ignorierten Spielern.\n\t\t\t\t\tAlternative Optionen: '/removeignore'",
    ...
    SI_LUIE_LAM_SLASHCMDS_BANKER = "Aktiviere ( '/banker' ) Bänker",
    SI_LUIE_LAM_SLASHCMDS_BANKER_TP = "'/banker' Beschwört euren ausgewählten Bänker.\n\t\t\t\t\tAlternative Optionen: '/bank'",
    SI_LUIE_LAM_SLASHCMDS_MERCHANT = "Aktiviere ( '/merchant' ) Händler",
    SI_LUIE_LAM_SLASHCMDS_MERCHANT_TP = "'/merchant' Beschwört euren ausgewählten Händler.\n\t\t\t\t\tAlternative Optionen: '/sell', '/vendor'",
    SI_LUIE_LAM_SLASHCMDS_ARMORY = "Aktiviere ( '/armory' ) Arsenalgehilfe",
    SI_LUIE_LAM_SLASHCMDS_ARMORY_TP = "'/armory' Beschwört euren ausgewählten Arsenalgehilfen.",
    SI_LUIE_LAM_SLASHCMDS_DECON = "Aktiviere ( '/decon' ) Verwerterin",
    SI_LUIE_LAM_SLASHCMDS_DECON_TP = "'/decon' Beschwört <<1>> (wenn freigeschaltet).\n\t\t\t\t\tAlternative Optionen: '/deconstruction'",
    SI_LUIE_LAM_SLASHCMDS_FENCE = "Aktiviere ( '/fence' ) Hehler",
    SI_LUIE_LAM_SLASHCMDS_FENCE_TP = "'/fence' Beschwört <<1>> (wenn freigeschaltet).\n\t\t\t\t\tAlternative Optionen: '/smuggler'",
    SI_LUIE_LAM_SLASHCMDS_EYE = "Aktiviere ( '/eye' ) Das Auge des Antiquars",
    SI_LUIE_LAM_SLASHCMDS_EYE_TP = "'/eye' Use the Antiquarian's Eye at a dig site (If unlocked).",
    SI_LUIE_LAM_SLASHCMDS_PET = "Aktiviere ( '/pet' ) Dismiss Pet",
    ...
    SI_LUIE_LAM_SLASHCMDS_READYCHECK = "Aktiviere ( '/ready' ) Bereitschaftsabfrage",
    SI_LUIE_LAM_SLASHCMDS_READYCHECK_TP = "Sende einen 'Bereitschaftsabfrage'-Dialog an alle Gruppenmitglieder.",
    SI_LUIE_LAM_SLASHCMDS_OUTFIT = "Aktiviere ( '/outfit' ) Montur",
    SI_LUIE_LAM_SLASHCMDS_OUTFIT_TP = "'/outfit' '#' Legt die im angegeben Slot hinterlegte Montur an.",
    SI_LUIE_LAM_SLASHCMDSHEADER_HOLIDAY = "Fest XP Events Befehle",
    SI_LUIE_LAM_SLASHCMDS_CAKE = "Aktiviere ( '/cake' ) Jubiläums Event XP Buff",
    SI_LUIE_LAM_SLASHCMDS_CAKE_TP = "'/cake' Benutzt die Jubiläums Event XP Buff Erinnerung zum Aktivieren/Erneuern des Effekts.\n\t\t\t\t\tAlternative Optionen: '/anniversary'",
    SI_LUIE_LAM_SLASHCMDS_PIE = "Aktiviere ( '/pie' ) Narrenfest XP Buff",
    SI_LUIE_LAM_SLASHCMDS_PIE_TP = "'/pie' Benutzt die Narrenfest XP Buff Erinnerung zum Aktivieren/Erneuern des Effekts.\n\t\t\t\t\tAlternative Optionen: '/jester'",
    SI_LUIE_LAM_SLASHCMDS_MEAD = "Aktiviere ( '/mead' ) Neujahrsfest XP Buff",
    SI_LUIE_LAM_SLASHCMDS_MEAD_TP = "'/mead' Benutzt die Neujahrsfest XP Buff Erinnerung zum Aktivieren/Erneuern des Effekts.\n\t\t\t\t\tAlternative Optionen: '/newlife'",
    SI_LUIE_LAM_SLASHCMDS_WITCH = "Aktiviere ( '/witch' ) The Witches Festival XP Buff",
    SI_LUIE_LAM_SLASHCMDS_WITCH_TP = "'/witch' Benutzt die Hexenfest XP Buff Erinnerung zum Aktivieren/Erneuern des Effekts.\n\t\t\t\t\tAlternative Optionen: '/witchfest'",
    SI_LUIE_LAM_SLASHCMDS_REPORT = "Aktiviere ( '/report' ) Meldung",
    SI_LUIE_LAM_SLASHCMDS_REPORT_TP = "'/report' 'Name' Öffnet das Spieler-Melden Fenster.",
    ...
    SI_LUIE_LAM_CA_MISC_SHOWMAILERROR_TP = "Display an error <<1>> when mail fails to send.",
    ...
    SI_LUIE_LAM_CI_BACKBAR_HIDE_UNUSED = "Back Bar - Hide Inactive Slots", -- changed from Bar Bar by Nagolite
    ...
    SI_LUIE_LAM_UF_WHITELIST_ADD_ASSISTANTS_TP = "Add Ezabi, Fezez, Pirharri, Nuzhimeh, Tythis, Baron, and Peddler to the whitelist.",

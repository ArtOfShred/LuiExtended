...
local strings = {
    ...
    SI_LUIE_LAM_UF_CFRAMESPT_PLAYER_REVERSE_RES =        "Swap Magicka and Stamina Bars",
    SI_LUIE_LAM_UF_CFRAMESPT_PLAYER_REVERSE_RES_TP =     "Swap the positions of Magicka and Stamina on the Player frame.",

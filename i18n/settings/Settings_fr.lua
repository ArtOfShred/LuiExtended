...
local strings = {
    ...
    SI_LUIE_LAM_BUFFS_DESCRIPTION =                      "Active l'affichage des améliorations et afaiblissements du joueur et de la cible. A également des diverses options de personnalisation.",
    SI_LUIE_LAM_BUFFSDEBUFFS =                           "Améliorations & Afaiblissements",
    ...
    SI_LUIE_LAM_BUFF_ENABLEEFFECTSTRACK =                "Module des Améliorations & Affaiblissements",
    SI_LUIE_LAM_BUFF_HEADER_POSITION =                   "Options d'affichage",
    SI_LUIE_LAM_BUFF_HARDLOCK =                          "Attacher la position aux cadres des unités",
    SI_LUIE_LAM_BUFF_HARDLOCK_TP =                       "Attacher la position du cadre des améliorations à la barre de santé des cadres des unités.",
    SI_LUIE_LAM_BUFF_HARDLOCK_WARNING =                  "Un rechargement de l'interface sera nécessaire.\nLorsque cette position est verrouillée, vous ne pourrez pas déplacer le cadre des améliorations.",
    SI_LUIE_LAM_BUFF_UNLOCKWINDOW =                      "Déverrouiller le cadre des améliorations",
    SI_LUIE_LAM_BUFF_UNLOCKWINDOW_TP =                   "Déverrouiller pour déplacer les cadres d'améliorations. Cela ne déverrouillera pas les cadres attachés aux cadres des unités.",
    SI_LUIE_LAM_BUFF_RESETPOSITION_TP =                  "Cela réinitialisera à la position par défaut de tous les conteneurs d'icônes d'améliorations.",
    SI_LUIE_LAM_BUFF_SHOWPLAYERBUFF =                    "JOUEUR : Afficher Améliorations",
    SI_LUIE_LAM_BUFF_SHOWPLAYERBUFF_TP =                 "Afficher les améliorations du joueur.",
    SI_LUIE_LAM_BUFF_SHOWPLAYERDEBUFF =                  "JOUEUR : Afficher Affaiblissements",
    SI_LUIE_LAM_BUFF_SHOWPLAYERDEBUFF_TP =               "Afficher les affaiblissements du joueur.",
    SI_LUIE_LAM_BUFF_SHOWTARGETBUFF =                    "CIBLE : Afficher Améliorations",
    SI_LUIE_LAM_BUFF_SHOWTARGETBUFF_TP =                 "Afficher les améliorations de la cible.",
    SI_LUIE_LAM_BUFF_SHOWTARGETDEBUFF =                  "CIBLE : Afficher Affaiblissements",
    SI_LUIE_LAM_BUFF_SHOWTARGETDEBUFF_TP =               "Afficher les affaiblissements de la cible.",
    ...
    SI_LUIE_LAM_BUFF_SHOWREMAINTIMELABEL_TP =            "Afficher l'étiquette de texte avec le nombre de secondes restantes jusqu'à l'expiration des Améliorations/Affaiblissements.",
    ...
    SI_LUIE_LAM_BUFF_SORTING_NORMAL_HEADER =             "Améliorations & Affaiblissements du joueur et la cible",
    ...
    SI_LUIE_LAM_BUFF_SORTING_LONGTERM_HEADER =           "Améliorations du joueur à longue durée",
    SI_LUIE_LAM_BUFF_SORTING_PROMINET_HEADER =           "Améliorations & Affaiblissements importants",

...
local strings = {
    ...
    SI_LUIE_LAM_CA_DISPLAY_ARENA_MAELSTROM = "Display DSA/Maelstrom Arena Stage - <<1>>",
    SI_LUIE_LAM_CA_DISPLAY_ARENA_MAELSTROM_TP = "Display <<1>> when a new stage begins in Dragonstar or Maelstrom Arena.",
    SI_LUIE_LAM_CA_DISPLAY_ARENA_DRAGONSTAR = "Display DSA/Maelstrom Arena Stage - <<1>>",
    SI_LUIE_LAM_CA_DISPLAY_ARENA_DRAGONSTAR_TP = "Display <<1>> when a new stage begins in Dragonstar or Maelstrom Arena.",
    SI_LUIE_LAM_CA_DISPLAY_DUNGEON_ENDLESS = "Display Maelstrom Arena Round - <<1>>",
    SI_LUIE_LAM_CA_DISPLAY_DUNGEON_ENDLESS_TP = "Display <<1>> when a new round begins in Maelstrom Arena.",
    ...
    SI_LUIE_LAM_CA_DISPLAY_ZONE_IC_DESCRIPTION = "Display Imperial City Area Description",
    SI_LUIE_LAM_CA_DISPLAY_ZONE_IC_DESCRIPTION_TP = "Display the description text when entering a new area of the Imperial City Sewers.\nNote: This option uses the POI Description Color from Quest/POI Announcements.",

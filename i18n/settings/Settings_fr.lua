...
local strings = {
    ...
    SI_LUIE_LAM_CI_CCT_SNARE_HEADER =                    "Snared/Immobilized Alerts",
    SI_LUIE_LAM_CI_CCT_SNARE_TOGGLE =                    "Show Snared/Immobilized Warning",
    SI_LUIE_LAM_CI_CCT_SNARE_TOGGLE_TP =                 "Display a notification when Snared/Immobilized.",

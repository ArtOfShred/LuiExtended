...
local strings = {
    ...
    SI_LUIE_LAM_BUFF_SHOWSECONDFRACTIONS =               "Afficher les dixièmes de secondes",
    SI_LUIE_LAM_BUFF_SHOWSECONDFRACTIONS_TP =            "Afficher les dixièmes de secondes comme \"12.3\" ou garder seulement les secondes pleines \"12\".",

...
local strings = {
    ...
    -- Settings
    SI_LUIE_LAM_COMPATIBILITY_WARNING = "Option à désactiver si vous rencontrez des problèmes de compatibilité avec les autres Add-Ons.",
    SI_LUIE_LAM_FONT = "Police",
    SI_LUIE_LAM_FONT_SIZE = "Police - Taille",
    SI_LUIE_LAM_FONT_STYLE = "Police - Style",
    SI_LUIE_LAM_RELOADUI = "Recharger l'interface",
    SI_LUIE_LAM_RELOADUI_BUTTON = "Bouton de rechargement de l'interface.",
    SI_LUIE_LAM_RELOADUI_WARNING = "Cela nécessite un rechargement de l'interface.",
    SI_LUIE_LAM_RELOADUI_SLASH_WARNING = "La désactivation d'une commande 'slash' nécessite un rechargement de l'interface.",
    SI_LUIE_LAM_RESETPOSITION = "Réinitialiser les positions des cadres de messages",
    ...
    SI_LUIE_LAM_ALERT_HIDE_ALL = "Cacher les alertes",
    SI_LUIE_LAM_ALERT_HIDE_ALL_TP = "Cacher les alertes qui apparaissent normalement dans le coin en haut et à droite de l'écran.",
    SI_LUIE_LAM_HIDE_EXPERIENCE_BAR = "Cacher la barre de progression de l'expérience et des compétences",
    SI_LUIE_LAM_HIDE_EXPERIENCE_BAR_TP = "Lorsque vous gagnez de l'expérience grâce aux quêtes, à la découverte de zones ou des éliminations de boss, la barre d'expèrience ne s'affiche plus. Utile si vous avez un élément d'interface utilisateur personnalisé dans ce coin de l'écran et que vous ne voulez pas qu'ils se chevauchent.",
    SI_LUIE_LAM_CHANGELOG = "Afficher le Journal des changements (Changelog)",
    SI_LUIE_LAM_CHANGELOG_TP = "Afficher la liste des changements par rapport à la version précédente de LUIE.",
    SI_LUIE_LAM_STARTUPMSG = "Désactiver les messages du démarrage",
    SI_LUIE_LAM_STARTUPMSG_TP = "Ce paramètre désactive les messages qui apparaissent au démarrage.",
    SI_LUIE_LAM_SVPROFILE_HEADER = "Paramètres des profils des personnages",
    SI_LUIE_LAM_SVPROFILE_DESCRIPTION = "Par défaut, LuiExtended utilise les paramètres à l'échelle du compte. Vous pouvez activer les paramètres spécifiques aux personnages. Les profils peuvent être copiés entre les personnages et vous pouvez réinitialiser le personnage actuel ou les paramètres généraux du compte. Notez que les paramètres à l'échelle du compte sont conservés si vous renoncez à l'utilisation de profils de personnages individuels.",
    SI_LUIE_LAM_SVPROFILE_SETTINGSTOGGLE = "Activer les paramètres spécifiques des personnages",
    SI_LUIE_LAM_SVPROFILE_SETTINGSTOGGLE_TP = "Passer de l'utilisation des paramètres à l'échelle du compte à l'utilisation de paramètres par personnage.",
    SI_LUIE_LAM_SVPROFILE_PROFILECOPY = "Copier le profil du personnage",
    SI_LUIE_LAM_SVPROFILE_PROFILECOPY_TP = "Sélectionner un autre personnage ou paramètres à l'échelle du compte à partir desquels copier.",
    SI_LUIE_LAM_SVPROFILE_PROFILECOPYBUTTON = "Copier le profil",
    SI_LUIE_LAM_SVPROFILE_PROFILECOPYBUTTON_TP = "Copier le profil sélectionné ci-dessus dans les paramètres actuels de votre personnage ou de votre compte.",
    SI_LUIE_LAM_SVPROFILE_RESETCHAR = "Réinitialiser le personnage actuel",
    SI_LUIE_LAM_SVPROFILE_RESETCHAR_TP = "Réinitialiser les paramètres actuels du profil de personnage.",
    SI_LUIE_LAM_SVPROFILE_RESETACCOUNT = "Réinitialiser le compte",
    SI_LUIE_LAM_SVPROFILE_RESETACCOUNT_TP = "Réinitialiser les paramètres globaux du compte. Notez que cela ne supprimera ni ne modifiera les paramètres des personnages individuels.",
    SI_LUIE_LAM_UNLOCK_DEFAULT_UI = "Déverrouiller les éléments d'interface utilisateur par défaut",
    SI_LUIE_LAM_UNLOCK_DEFAULT_UI_TP = "Cela déverrouillera et vous permettra de déplacer les éléments de l'interface utilisateur par défaut comme le journal des quêtes, le score du champ de bataille, l'historique du butin et les fenêtres d'état de l'équipement.",
    ...
    SI_LUIE_LAM_BUFFS_DESCRIPTION = "Active l'affichage des Bonus et Malus du joueur et de la cible. A également des diverses options de personnalisation.",
    SI_LUIE_LAM_BUFFSDEBUFFS = "Bonus & Malus",
    SI_LUIE_LAM_MODULEHEADER = "Paramètres des modules",
    SI_LUIE_LAM_MISCHEADER = "Paramètres divers",

    -- Module: Slash Commands
    SI_LUIE_LAM_SLASHCMDS_ENABLE = "Module des commandes Slash",
    ...
    SI_LUIE_LAM_SLASHCMDSHEADER = "Commandes Slash",
    SI_LUIE_LAM_SLASHCMDSHEADER_GENERAL = "Commandes générales",
    ...
    SI_LUIE_LAM_BUFF_ENABLEEFFECTSTRACK = "Module des Bonus & Malus",
    SI_LUIE_LAM_BUFF_HEADER_POSITION = "Options d'affichage",
    SI_LUIE_LAM_BUFF_HARDLOCK = "Attacher la position aux cadres des unités",
    SI_LUIE_LAM_BUFF_HARDLOCK_TP = "Attacher la position du cadre des Bonus à la barre de santé des cadres des unités.",
    SI_LUIE_LAM_BUFF_HARDLOCK_WARNING = "Un rechargement de l'interface sera nécessaire.\nLorsque cette position est verrouillée, vous ne pourrez pas déplacer le cadre des Bonus.",
    SI_LUIE_LAM_BUFF_UNLOCKWINDOW = "Déverrouiller le cadre des Bonus",
    SI_LUIE_LAM_BUFF_UNLOCKWINDOW_TP = "Déverrouiller pour déplacer les cadres des Bonus. Cela ne déverrouillera pas les cadres attachés aux cadres des unités.",
    SI_LUIE_LAM_BUFF_RESETPOSITION_TP = "Cela réinitialisera à la position par défaut de tous les cadres d'icônes des Bonus & Malus.",
    SI_LUIE_LAM_BUFF_SHOWPLAYERBUFF = "Joueur : Afficher Bonus",
    SI_LUIE_LAM_BUFF_SHOWPLAYERBUFF_TP = "Afficher les Bonus du joueur.",
    SI_LUIE_LAM_BUFF_SHOWPLAYERDEBUFF = "Joueur : Afficher Malus",
    SI_LUIE_LAM_BUFF_SHOWPLAYERDEBUFF_TP = "Afficher les Malus du joueur.",
    SI_LUIE_LAM_BUFF_SHOWTARGETBUFF = "Cible : Afficher Bonus",
    SI_LUIE_LAM_BUFF_SHOWTARGETBUFF_TP = "Afficher les Bonus de la cible.",
    SI_LUIE_LAM_BUFF_SHOWTARGETDEBUFF = "Cible : Afficher Malus",
    SI_LUIE_LAM_BUFF_SHOWTARGETDEBUFF_TP = "Afficher les Malus de la cible.",
    ...
    SI_LUIE_LAM_BUFF_ICON_HEADER = "Options d'icône",
    SI_LUIE_LAM_BUFF_ICONSIZE = "Taille des icônes",
    SI_LUIE_LAM_BUFF_ICONSIZE_TP = "Choisir la taille des icônes.",
    SI_LUIE_LAM_BUFF_SHOWREMAINTIMELABEL = "Afficher l'étiquette du temps restant",
    SI_LUIE_LAM_BUFF_SHOWREMAINTIMELABEL_TP = "Afficher l'étiquette de texte avec le nombre de secondes restantes jusqu'à l'expiration des Bonus/Malus.",
    SI_LUIE_LAM_BUFF_LABEL_POSITION_TP = "Ajustez la position verticale de l'étiquette du compte à rebours.",
    SI_LUIE_LAM_BUFF_FONT_TP = "Choisir la police à utiliser pour l'étiquette du compte à rebours.",
    SI_LUIE_LAM_BUFF_FONTSIZE_TP = "Choisir la taille de la police pour l'étiquette du compte à rebours.",
    SI_LUIE_LAM_BUFF_FONTSTYLE_TP = "Choisir le style de police pour l'étiquette de compte à rebours.",
    SI_LUIE_LAM_BUFF_LABELCOLOR_TP = "Définir la couleur de l'étiquette de texte pour qu'elle soit la même que celle de la bordure de l'icône ou gardez-la blanche.",
    SI_LUIE_LAM_BUFF_SHOWSECONDFRACTIONS = "Afficher les dixièmes de seconde",
    SI_LUIE_LAM_BUFF_SHOWSECONDFRACTIONS_TP = 'Afficher les dixièmes de seconde comme "12.3" ou garder seulement les secondes pleines "12".',
    SI_LUIE_LAM_BUFF_SHOWFRACTIONSTHRESHOLDVALUE = "Seuil des dixièmes de seconde", -- Note: This option is actually used in CombatInfo for Bar Highlight
    SI_LUIE_LAM_BUFF_SHOWFRACTIONSTHRESHOLDVALUE_TP = "Lorsqu'une durée restante est inférieure à cette valeur, afficher le chronomètre avec les dixièmes de seconde.",
    SI_LUIE_LAM_BUFF_SHOWFRACTIONSABOVETHRESHOLD = "Toujours afficher les dixièmes de seconde", -- Note: This option is actually used in CombatInfo for Bar Highlight
    SI_LUIE_LAM_BUFF_SHOWFRACTIONSABOVETHRESHOLD_TP = "Afficher également les dixièmes de seconde, quelle que soit la durée (ignorez le seuil défini ci-dessus).",
    ...
    SI_LUIE_LAM_BUFF_FADEEXPIREICON_TP = "Lorsqu'un buff/debuff est sur le point d'expirer, rendre l'icône transparent.",

    SI_LUIE_LAM_BUFF_SORTING_HEADER = "Alignements et tris",
    SI_LUIE_LAM_BUFF_SORTING_NORMAL_HEADER = "Bonus & Malus du joueur et de la cible",
    SI_LUIE_LAM_BUFF_SORTING_GENERIC_ALIGN = "<<1>> Alignement",
    SI_LUIE_LAM_BUFF_SORTING_GENERIC_ALIGN_TP = "Définir l'alignement des icônes dans le conteneur <<1>>.",
    SI_LUIE_LAM_BUFF_SORTING_HORIZONTAL_ALIGN = "<<1>> Alignement horizontal",
    SI_LUIE_LAM_BUFF_SORTING_HORIZONTAL_ALIGN_TP = "Définir l'alignement horizontal des icônes dans le conteneur <<1>>.",
    SI_LUIE_LAM_BUFF_SORTING_VERTICAL_ALIGN = "<<1>> Alignement vertical",
    SI_LUIE_LAM_BUFF_SORTING_VERTICAL_ALIGN_TP = "Définir l'alignement vertical des icônes dans le conteneur <<1>>.",
    SI_LUIE_LAM_BUFF_SORTING_SORT_GENERIC = "<<1>> Tri",
    SI_LUIE_LAM_BUFF_SORTING_SORT_GENERIC_TP = "Choisir la direction dans laquelle les icônes sont triées dans le conteneur <<1>>.",
    SI_LUIE_LAM_BUFF_SORTING_STACK_GENERIC = "<<1>> Row Direction",
    SI_LUIE_LAM_BUFF_SORTING_STACK_GENERIC_TP = "Choose the direction the <<1>> container will create the next row of Buffs/Debuffs when the first row is filled.",
    SI_LUIE_LAM_BUFF_SORTING_WIDTH_GENERIC = "<<1>> Width",
    SI_LUIE_LAM_BUFF_SORTING_WIDTH_GENERIC_TP = "Choose the width for the <<1>> container.",
    SI_LUIE_LAM_BUFF_SORTING_SORT_HORIZONTAL = "<<1>> Tri horizontal",
    SI_LUIE_LAM_BUFF_SORTING_SORT_HORIZONTAL_TP = "Choisir la direction horizontale dans laquelle les icônes sont triées dans le conteneur <<1>>.",
    ...
    SI_LUIE_LAM_BUFF_TOOLTIP_CUSTOM = "Display Custom Tooltips",
    SI_LUIE_LAM_BUFF_TOOLTIP_CUSTOM_TP = "Display custom LUIE Tooltips - this feature requires manual updates (right now it hasn't been updated for a couple years so some tooltips may be wrong).",
    ...
    SI_LUIE_LAM_BUFF_LONGTERM_HEADER = "Filtre des effets longs",
    SI_LUIE_LAM_BUFF_LONGTERM_SELF = "Joueur : Afficher les effets longs",
    SI_LUIE_LAM_BUFF_LONGTERM_SELF_TP = "Joueur : Afficher les icônes des effets d'une durée supérieure à 2 minutes.",
    SI_LUIE_LAM_BUFF_LONGTERM_TARGET = "Cible : Afficher les effets longs",
    SI_LUIE_LAM_BUFF_LONGTERM_TARGET_TP = "Cible : Afficher les icônes des effets d'une durée supérieure à 2 minutes.",
    ...
    SI_LUIE_LAM_BUFF_LONGTERM_CONTAINER = "Orientation du cadre",
    SI_LUIE_LAM_BUFF_LONGTERM_CONTAINER_TP = "Change l'orientation du cadre des effects longs à Horizontal ou Vertical.",
    ...
    SI_LUIE_LAM_BUFF_COLOR_HEADER = "Paramètres des couleurs",
    SI_LUIE_LAM_BUFF_COLOR_HEADER_BASIC = "Paramètres de base des couleurs",
    SI_LUIE_LAM_BUFF_COLOR_HEADER_UNBREAKABLE = "Paramètres des couleurs des effets inévitables et cosmestiques",
    SI_LUIE_LAM_BUFF_COLOR_HEADER_CROWD_CONTROL = "Couleurs pour les contrôles de foule",
    SI_LUIE_LAM_BUFF_COLOR_BUFF = "Couleur des Bonus",
    SI_LUIE_LAM_BUFF_COLOR_BUFF_TP = "Choisir la couleur à utiliser pour les Bonus.",
    SI_LUIE_LAM_BUFF_COLOR_DEBUFF = "Couleur des Malus",
    SI_LUIE_LAM_BUFF_COLOR_DEBUFF_TP = "Choisir la couleur à utiliser pour les Malus.",
    SI_LUIE_LAM_BUFF_COLOR_PRIORITYBUFF = "Couleur des Bonus prioritaires",
    SI_LUIE_LAM_BUFF_COLOR_PRIORITYBUFF_TP = "Choisir la couleur à utiliser pour les Bonus prioritaires.",
    SI_LUIE_LAM_BUFF_COLOR_PRIORITYDEBUFF = "Couleur des Malus prioritaires",
    SI_LUIE_LAM_BUFF_COLOR_PRIORITYDEBUFF_TP = "Choisir la couleur à utiliser pour les Malus prioritaires.",
    SI_LUIE_LAM_BUFF_COLOR_UNBREAKABLE_TOGGLE = "Activer la couleur des Malus inévitables",
    SI_LUIE_LAM_BUFF_COLOR_UNBREAKABLE_TOGGLE_TP = "Si actif, les Malus qui ne peuvent pas être purifiés ou supprimés par des moyens normaux s'afficheront avec la couleur de bordure sélectionnée ci-dessous.",
    SI_LUIE_LAM_BUFF_COLOR_UNBREAKABLE = "Couleur des Malus inévitables",
    SI_LUIE_LAM_BUFF_COLOR_UNBREAKABLE_TP = "Choisir la couleur à utiliser pour les Malus inévitables.",
    SI_LUIE_LAM_BUFF_COLOR_COSMETIC_TOGGLE = "Activer la couleur pour les effets cosmétiques",
    SI_LUIE_LAM_BUFF_COLOR_COSMETIC_TOGGLE_TP = "Si actif, les effets cosmétiques buffs qui n'ont pas d'autres effets s'afficheront avec la couleur de bordure sélectionnée ci-dessous.",
    SI_LUIE_LAM_BUFF_COLOR_COSMETIC = "Couleur des effets cosmétiques",
    SI_LUIE_LAM_BUFF_COLOR_COSMETIC_TP = "Choisir la couleur à utiliser pour les effets cosmétiques.",
    ...
    SI_LUIE_LAM_BUFF_COLOR_DISORIENT = "Couleur pour les désorientations",
    SI_LUIE_LAM_BUFF_COLOR_DISORIENT_TP = "Choisir la couleur à utiliser pour les effets qui désorientent.",
    SI_LUIE_LAM_BUFF_COLOR_FEAR = "Couleur pour la peur",
    SI_LUIE_LAM_BUFF_COLOR_FEAR_TP = "Choisir la couleur à utiliser pour les effets de peur.",
    SI_LUIE_LAM_BUFF_COLOR_STAGGER = "Couleur pour le vacillement",
    SI_LUIE_LAM_BUFF_COLOR_STAGGER_TP = "Choisir la couleur à utiliser pour les effets qui font vaciller.",
    SI_LUIE_LAM_BUFF_COLOR_SILENCE = "Couleur pour les silences",
    SI_LUIE_LAM_BUFF_COLOR_SILENCE_TP = "Choisir la couleur à utiliser pour les effets qui rendent muet.",
    SI_LUIE_LAM_BUFF_COLOR_SNARE = "Couleur pour les ralentissements",
    SI_LUIE_LAM_BUFF_COLOR_SNARE_TP = "Choisir la couleur à utiliser pour les effets qui ralentissent.",
    SI_LUIE_LAM_BUFF_COLOR_ROOT = "Couleur pour les immobilisations",
    SI_LUIE_LAM_BUFF_COLOR_ROOT_TP = "Choisir la couleur à utiliser pour les effets qui immmobilisent.",
    ...
    SI_LUIE_LAM_CA_ENABLE = "Module des messages d'annonces",
    SI_LUIE_LAM_CA_HEADER = "Paramètres des messages d'annonces",
    SI_LUIE_LAM_CA_DESCRIPTION = "Affiche des annonces dans la boîte de dialogues pour divers événements, avec de nombreux paramètres personnalisables.",
    ...
    SI_LUIE_LAM_CA_CURRENCY_SHOWENDLESS = "Display Archival Fortune Changes",
    SI_LUIE_LAM_CA_CURRENCY_SHOWENDLESS_TP = "Print a context sensitive notification to chat when Archival Fortunes are rewarded or spent.",
    SI_LUIE_LAM_CA_CURRENCY_SHOWENDLESSCOLOR = "Archival Fortunes Color", -- TODO: Add Tooltip with finalized color value
    SI_LUIE_LAM_CA_CURRENCY_SHOWENDLESSNAME = "Archival Fortunes Name",
    SI_LUIE_LAM_CA_CURRENCY_SHOWENDLESSNAME_TP = "Name to display for Archival Fortunes.\nDefault: <<1[Archival Fortune/Archival Fortunes]>>",
    SI_LUIE_LAM_CA_CURRENCY_SHOWENDLESSTOTAL = "Display Total Archival Fortunes Suffix",
    SI_LUIE_LAM_CA_CURRENCY_SHOWENDLESSTOTAL_TP = "Show total amount of Archival Fortunes after change is displayed.",
    SI_LUIE_LAM_CA_CURRENCY_ENDLESSTOTAL_MSG = "Total Archival Fortunes Syntax",
    SI_LUIE_LAM_CA_CURRENCY_ENDLESSTOTAL_MSG_TP = "Choose the syntax for the Total Archival Fortunes message.\nDefault: Total Fortunes: %s",
    ...
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_RECEIVE = "Réception",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_RECEIVE_TP = "Défaut : Vous recevez %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_LOOT = "Butin",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_LOOT_TP = "Défaut : Vous recevez le butin %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_EARN = "Gain",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_EARN_TP = "Défaut : Vous gagnez %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_SPEND = "Dépense",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_SPEND_TP = "Défaut : Vous dépensez %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_PAY = "Paiement (Conversation avec des PNJ)",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_PAY_TP = "Défaut : Vous payez %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_USEKIT = "Utilisation d'un objet",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_USEKIT_TP = "Défaut : Vous utilisez %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_POTION = "Utilisation d'une potion",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_POTION_TP = "Défaut : Vous consommez %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_FOOD = "Utilisation de nourriture",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_FOOD_TP = "Défaut : Vous mangez %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_DRINK = "Utilisation de boisson",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_DRINK_TP = "Défaut : Vous buvez %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_DEPLOY = "Déploiement (Siège)",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_DEPLOY_TP = "Défaut : Vous déployez %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_STOW = "Démontage (Siège)",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_STOW_TP = "Défaut : Vous démontez %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_LEARN_RECIPE = "Apprentissage de recette",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_LEARN_RECIPE_TP = "Défaut : Vous apprenez comment fabriquer %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_LEARN_MOTIF = "Apprentissage de motif",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_LEARN_MOTIF_TP = "Défaut : Vous apprenez %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_LEARN_STYLE = "Apprentissage de style",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_LEARN_STYLE_TP = "Défaut : Vous apprenez %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_EXCAVATE = "Excavation",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_EXCAVATE_TP = "Défaut : Vous dégagez %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_LOST = "Perte",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_LOST_TP = "Défaut : Vous perdez %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_STEAL = "Vol",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_STEAL_TP = "Défaut : Vous volez %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_PICKPOCKET = "Vol à la tire",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_PICKPOCKET_TP = "Défaut : Vous volez à la tire %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_BOUNTY = "Prime - Paiement",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_BOUNTY_TP = "Défaut : Vous payez la prime d'un montant de %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_CONFISCATE = "Prime - Confiscation",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_CONFISCATE_TP = "Défaut :Un garde a confisqué %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_REPAIR = "Réparation",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_REPAIR_TP = "Défaut : Vous payez %s en frais de réparation.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_TRADER = "Commercant de guilde - Achat",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_TRADER_TP = "Défaut : Vous achetez un objet chez le commercant de guilde pour %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_LIST = "Commercant de guilde - Vente d'objet",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_LIST_TP = "Défaut : Vous mettez %s en vente.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_LISTING = "Commercant de guilde - Prix de vente d'un objet",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_LISTING_TP = "Défaut : Frais de vente facturés pour un montant de %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_LISTING_VALUE = "Commercant de guilde - Objet + prix de vente d'un objet",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_LISTING_VALUE_TP = "Défaut : Vous mettez %s en vente au prix de %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_TRADEIN = "Echange (Entrant)",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_TRADEIN_TP = "Défaut : Vous recevez %s de %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_TRADEIN_NO_NAME = "Echange (Entrant) - Sans nom de contact",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_TRADEIN_NO_NAME_TP = "Ce message ne s'affiche que s'il y a une erreur lors de la résolution du nom du joueur participant à l'échange.\nDéfaut : Vous recevez %s %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_TRADEOUT = "Echange (Sortant)",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_TRADEOUT_TP = "Défaut : Vous donnez %s à %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_TRADEOUT_NO_NAME = "Echange (Sortant) - Sans nom de contact",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_TRADEOUT_NO_NAME_TP = "Ce message ne s'affiche que s'il y a une erreur lors de la résolution du nom du joueur participant à l'échange.\nDéfaut : Vous échangez %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_MAILIN = "Courriel (Entrant)",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_MAILIN_TP = "Défaut : Vous recevez un courriel contenant %s de la part de %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_MAILIN_NO_NAME = "Courriel (Entrant) - Sans nom de contact",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_MAILIN_NO_NAME_TP = "Ce message ne s'affiche que s'il y a une erreur lors de la résolution du nom du joueur envoyant le courriel.\nDéfaut : Vous recevez un courriel contenant %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_MAILOUT = "Courriel (Sortant)",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_MAILOUT_TP = "Défaut : Vous envoyez %s par courriel à %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_MAILOUT_NO_NAME = "Courriel (Sortant) - Sans nom de contact",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_MAILOUT_NO_NAME_TP = "Ce message ne s'affiche que s'il y a une erreur lors de la résolution du nom du joueur recevant le courriel.\nDéfaut : Vous envoyez %s par courriel.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_MAILCOD = "Courriel - Paiement du contre-remboursement",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_MAILCOD_TP = "Défaut : Vous envoyez %s pour le paiement du contre-remboursement à %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_POSTAGE = "Courriel - Frais de poste",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_POSTAGE_TP = "Défaut : Vous payez %s en frais de poste.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_DEPOSIT = "Banque - Dépôt",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_DEPOSIT_TP = "Défaut : Vous avez déposé %s dans votre banque.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_WITHDRAW = "Banque - Retrait",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_WITHDRAW_TP = "Défaut : Vous récupérez %s de votre banque.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_DEPOSITGUILD = "Banque de guilde - Dépôt",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_DEPOSITGUILD_TP = "Défaut : Vous avez déposé %s dans la banque de guilde.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_DEPOSITSTORAGE = "Coffre - Dépôt",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_DEPOSITSTORAGE_TP = "Défaut : Vous avez déposé %s dans votre coffre.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_WITHDRAWSTORAGE = "Coffre - Retrait",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_WITHDRAWSTORAGE_TP = "Défaut : Vous récupérez %s de votre coffre.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_WITHDRAWGUILD = "Banque de guilde - Retrait",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_WITHDRAWGUILD_TP = "Défaut : Vous récupérez %s de votre banque de guilde.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_WAYSHRINE = "Frais d'utilisation des oratoires",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_WAYSHRINE_TP = "Défaut : Vous payez %s pour l'utilisation de l'oratoire.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_UNSTUCK = "Frais de déblocage",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_UNSTUCK_TP = "Défaut : Frais de déblocage facturés pour un montant de %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_STABLE = "Amélioration des montures",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_STABLE_TP = "Défaut : Vous achetez %s pour %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_STORAGE = "Amélioration des espaces de stockage",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_STORAGE_TP = "Défaut : Vous achetez %s pour %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_ATTRIBUTES = "Respec - Points de caractéristiques",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_ATTRIBUTES_TP = "Défaut : Vous faîtes un don de %s pour redistribuer vos points de caractéristiques.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_CHAMPION = "Respec - Points de champion",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_CHAMPION_TP = "Défaut : Vous payez une taxe of %s pour redistribuer vos points de champion.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_MORPHS = "Respec - Points de compétences évoluées",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_MORPHS_TP = "Défaut : Vous faîtes un don de %s pour redistribuer vos points de compétences évoluées.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_SKILLS = "Respec - Points de compétences",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_SKILLS_TP = "Défaut : Vous faîtes un don de %s pour redistribuer vos points de compétences.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_CAMPAIGN = "Cyrodiil - Réinitialisation de la campagne mère",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_CAMPAIGN_TP = "Défaut : Vous payez %s pour remettre à zéro votre campagne mère.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_BUY = "Achat sans montant",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_BUY_TP = "Défaut : Vous achetez %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_BUY_VALUE = "Achat avec montant",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_BUY_VALUE_TP = "Défaut : Vous achetez %s pour %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_BUYBACK = "Rachat sans montant",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_BUYBACK_TP = "Défaut : Vous rachetez %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_BUYBACK_VALUE = "Rachat avec montant",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_BUYBACK_VALUE_TP = "Défaut : Vous rachetez %s pour %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_SELL = "Vente sans montant",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_SELL_TP = "Défaut : Vous vendez %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_SELL_VALUE = "Vente avec montant",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_SELL_VALUE_TP = "Défaut : Vous vendez %s pour %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_FENCE_VALUE = "Revente d'un objet volé avec montant",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_FENCE_VALUE_TP = "Défaut : Vous revendez l'objet volé %s pour %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_FENCE = "Revente d'un objet volé sans montant",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_FENCE_TP = "Défaut : Vous revendez l'objet volé %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_LAUNDER_VALUE = "Blanchissement d'objet avec montant",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_LAUNDER_VALUE_TP = "Défaut : Vous blanchissez %s pour %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_LAUNDER = "Blanchissement d'objet sans montant",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_LAUNDER_TP = "Défaut : Vous blanchissez %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_USE = "Artisanat - Utilisation",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_USE_TP = "Défaut : Vous utilisez %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_CRAFT = "Artisanat - Fabrication",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_CRAFT_TP = "Défaut : Vous fabriquez %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_EXTRACT = "Artisanat - Extraction",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_EXTRACT_TP = "Défaut : Vous extrayez %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_UPGRADE = "Artisanat - Amélioration (Success)",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_UPGRADE_TP = "Défaut : Vous améliorez %s en %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_UPGRADE_FAIL = "Artisanat - Amélioration (Echec)",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_UPGRADE_FAIL_TP = "Défaut : Votre amélioration de %s a échoué.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_REFINE = "Artisanat - Rafinage",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_REFINE_TP = "Défaut : Vous rafinez %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_DECONSTRUCT = "Artisanat - Démontage",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_DECONSTRUCT_TP = "Défaut : Vous démontez %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_RESEARCH = "Artisanat - Recherche",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_RESEARCH_TP = "Défaut : Vous recherchez %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_DESTROY = "Destruction",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_DESTROY_TP = "Défaut : Vous détruisez %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_CONTAINER = "Vidage d'un conteneur",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_CONTAINER_TP = "Défaut : Vous videz %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_LOCKPICK = "Crochet cassé",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_LOCKPICK_TP = "Défaut : Votre %s s'est cassé.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_REMOVE = "Objet ou objet de quête retiré",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_REMOVE_TP = "Défaut : %s retiré.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_TURNIN = "Objet de quête - Rendre",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_TURNIN_TP = "Message à utiliser lors de la remise d'un objet de quête.\nDéfaut : Vous rendez %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_QUESTUSE = "Objet de quête - Utilisation",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_QUESTUSE_TP = "Message à utiliser lors de l'utilisation d'un objet de quête.\nDéfaut : Vous utilisez %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_EXHAUST = "Objet de quête - Epuisement",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_EXHAUST_TP = "Message à utiliser lors de l'épuisement d'un objet de quête (ex. Utilisation de toutes les charges).\nDéfaut: Vous épuisez %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_OFFER = "Objet de quête - Offre",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_OFFER_TP = "Message à utiliser lors de l'offre d'un objet à un PNJ.\nDéfaut : Vous offrez %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_DISCARD = "Objet de quête - Abandon",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_DISCARD_TP = "Message à utiliser lorsqu'un élément de quête est effectivement supprimé (souvent pour les éléments de quête supprimés de manière aléatoire ou pour des notes ou des listes).\nDéfaut : Vous vous débarrassez de %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_QUESTOPEN = "Objet de quête - Ouverture",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_QUESTOPEN_TP = "Message à utiliser lorsqu'un objet de quête est ouvert (une lettre, une boîte, etc.).\nDéfaut : Vous ouvrez %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_QUESTCONFISCATE = "Objet de quête - Confiscation",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_QUESTCONFISCATE_TP = "Message à utiliser lorsqu'un objet de quête est confisqué/pris contre votre gré par un PNJ.\nDéfaut : %s confisqué.e.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_QUESTADMINISTER = "Objet de quête - Administration",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_QUESTADMINISTER_TP = "Message à utiliser lorsqu'un objet de quête est administré (potion/antidote/nourriture, etc. donné à un PNJ).\nDéfaut : Vous administrez %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_QUESTPLACE = "Objet de quête - Placed",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_QUESTPLACE_TP = "Message à utiliser lorsqu'un objet de quête est placé (dans une cavité, sur un piédestal, etc.).\nDéfaut : Vous placez %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_COMBINE = "Objet de quête - Combiner",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_COMBINE_TP = "Message à utiliser lors de la combinaison d'objets de quête pour créer un autre objet de quête.\nDéfaut : Vous combinez %s pour fabriquer %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_MIX = "Objet de quête - Fusion",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_MIX_TP = "Message à utiliser lors de la fusion d'objets de quête pour créer un autre objet de quête.\nDéfaut : Vous fusionnez %s pour fabriquer %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_BUNDLE = "Objet de quête - Bundle",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_BUNDLE_TP = "Message à utiliser lorsque vous regroupez des objets de quête en un seul objet (ex. une boîte de relique).\nDéfaut : Vous regroupez les %s ensembles.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_GROUP = "Butin des membres du groupe",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_GROUP_TP = "Defaut : %s reçoit le butin %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_DISGUISE_EQUIP = "Déguisement - Porter",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_DISGUISE_EQUIP_TP = "Défaut : Vous vous déguisez avec %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_DISGUISE_REMOVE = "Déguisement - Retrait",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_DISGUISE_REMOVE_TP = "Défaut : Vous retirez %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_DISGUISE_DESTROY = "Déguisement - Destruction",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_DISGUISE_DESTROY_TP = "Défaut : Votre %s est détruit.",
    SI_LUIE_LAM_CA_LOOT_HEADER = "Messages des annonces de butin",
    SI_LUIE_LAM_CA_LOOT_SHOWICONS = "Afficher l'icône des objets",
    SI_LUIE_LAM_CA_LOOT_SHOWICONS_TP = "Afficher l'icône des objets ramassés.",
    SI_LUIE_LAM_CA_LOOT_SHOWARMORTYPE = "Afficher le type d'armure des objets",
    SI_LUIE_LAM_CA_LOOT_SHOWARMORTYPE_TP = "Afficher le type d'armure pertinent des objets ramassés.",
    SI_LUIE_LAM_CA_LOOT_SHOWITEMSTYLE = "Afficher le style des objets",
    SI_LUIE_LAM_CA_LOOT_SHOWITEMSTYLE_TP = "Afficher le style pertinent des objets ramassés.",
    SI_LUIE_LAM_CA_LOOT_SHOWITEMTRAIT = "Afficher le trait des objets",
    SI_LUIE_LAM_CA_LOOT_SHOWITEMTRAIT_TP = "Afficher le trait pertinent des objets ramassés.",
    SI_LUIE_LAM_CA_LOOT_TOTAL = "Afficher le nombre total d'un objet",
    SI_LUIE_LAM_CA_LOOT_TOTAL_TP = "Mettre à jour le nombre total d'un objet après qu'un objet soit rammassé.",
    ...
    SI_LUIE_LAM_CA_LOOT_LOOTLOGDISABLE = "Hide Loot When Loot Log Is Enabled",
    SI_LUIE_LAM_CA_LOOT_LOOTLOGDISABLE_TP = "Disables the display of looted items if you are using the addon Loot Log.",
    ...
    SI_LUIE_LAM_CA_LOOT_HIDETRASH = "Cacher les objets de qualité médiocre",
    SI_LUIE_LAM_CA_LOOT_HIDETRASH_TP = "Ne pas afficher les objets de butin de qualité médiocre.",
    SI_LUIE_LAM_CA_LOOT_LOOTCONFISCATED = "Afficher les objets perdus - Objet confisqué",
    SI_LUIE_LAM_CA_LOOT_LOOTCONFISCATED_TP = "Affiche un message quand un garde vous confisque un objet.",
    SI_LUIE_LAM_CA_LOOT_LOOTSHOWDESTROYED = "Afficher les objets perdus - Objet détruit",
    SI_LUIE_LAM_CA_LOOT_LOOTSHOWDESTROYED_TP = "Affiche un message quand un objet est détruit.",
    SI_LUIE_LAM_CA_LOOT_LOOTSHOWREMOVED = "Afficher les objets perdus - Objet supprimé",
    SI_LUIE_LAM_CA_LOOT_LOOTSHOWREMOVED_TP = "Affiche un message quand un objet est supprimé lors d'un évènement.",
    SI_LUIE_LAM_CA_LOOT_LOOTSHOWLIST = "Afficher les objets mis en vente",
    SI_LUIE_LAM_CA_LOOT_LOOTSHOWLIST_TP = "Affiche un messaqge lorsque que vous mettez en vente un objet à l'hôtel des ventes de la guilde.",
    SI_LUIE_LAM_CA_LOOT_LOOTSHOWTURNIN = "Afficher les objets perdus - Objet rendu lors d'une quête",
    SI_LUIE_LAM_CA_LOOT_LOOTSHOWTURNIN_TP = "Affiche un message quand vous rendez un objet de quête.",
    SI_LUIE_LAM_CA_LOOT_LOOTSHOWUSE_POTION = "Afficher les objets perdus - Potion utilisée",
    SI_LUIE_LAM_CA_LOOT_LOOTSHOWUSE_POTION_TP = "Affiche un message quand vous utilisez une potion.",
    SI_LUIE_LAM_CA_LOOT_LOOTSHOWUSE_FOOD = "Afficher les objets perdus - Nourriture mangée",
    SI_LUIE_LAM_CA_LOOT_LOOTSHOWUSE_FOOD_TP = "Affiche un message quand vous consommez de la nourriture.",
    SI_LUIE_LAM_CA_LOOT_LOOTSHOWUSE_DRINK = "Afficher les objets perdus - Boisson bue",
    SI_LUIE_LAM_CA_LOOT_LOOTSHOWUSE_DRINK_TP = "Affiche une message quand vous buvez une boisson.",
    SI_LUIE_LAM_CA_LOOT_LOOTSHOWUSE_REPAIR_KIT = "Afficher les objets perdus - Kit de répération utilisé",
    SI_LUIE_LAM_CA_LOOT_LOOTSHOWUSE_REPAIR_KIT_TP = "Affiche un message quand vous utilisez un kit de réparation.",
    SI_LUIE_LAM_CA_LOOT_LOOTSHOWUSE_SOUL_GEM = "Afficher les objets perdus - Pierre d'âme utilisée",
    SI_LUIE_LAM_CA_LOOT_LOOTSHOWUSE_SOUL_GEM_TP = "Affiche un message quand vous utilisez une pierre d'âme.",
    SI_LUIE_LAM_CA_LOOT_LOOTSHOWUSE_SIEGE = "Afficher les objets perdus - Arme de siège déployée",
    SI_LUIE_LAM_CA_LOOT_LOOTSHOWUSE_SIEGE_TP = "Affiche un message quand vous utilisez une arme de siège.",
    SI_LUIE_LAM_CA_LOOT_LOOTSHOWUSE_MISC = "Afficher les objets perdus - Objet divers utilisé",
    SI_LUIE_LAM_CA_LOOT_LOOTSHOWUSE_MISC_TP = "Affiche un message quand vous utilisez un objet divers.",
    SI_LUIE_LAM_CA_LOOT_LOOTRECIPE = "Afficher les recettes d'artisanats apprises",
    SI_LUIE_LAM_CA_LOOT_LOOTRECIPE_TP = "Affiche un message lorsque vous apprenez une recette d'artisanat.",
    SI_LUIE_LAM_CA_LOOT_LOOTMOTIF = "Afficher les motifs appris",
    SI_LUIE_LAM_CA_LOOT_LOOTMOTIF_TP = "Affiche un message quand vous apprenez un motif.",
    SI_LUIE_LAM_CA_LOOT_LOOTSTYLE = "Afficher les styles appris",
    SI_LUIE_LAM_CA_LOOT_LOOTSTYLE_TP = "Affiche un message quand vous apprenez un style.",
    ...
    SI_LUIE_LAM_CA_ANTIQUITY_HEADER = "Messages sur les antiquités",
    SI_LUIE_LAM_CA_ANTIQUITY_LEAD_HEADER = "Piste découverte",
    SI_LUIE_LAM_CA_ANTIQUITY_ENABLE = "Affiche les pistes découvertes - <<1>>",
    SI_LUIE_LAM_CA_ANTIQUITY_ENABLE_TP = "Affiche <<1>> quand vous découvrez une piste d'antiquité.",
    SI_LUIE_LAM_CA_ANTIQUITY_BRACKET = "Crochets pour les noms de piste",
    SI_LUIE_LAM_CA_ANTIQUITY_BRACKET_TP = "Choisir d'afficher ou non les crochets [ ] brackets autour du nom de la piste découverte.",
    SI_LUIE_LAM_CA_ANTIQUITY_ICON = "Icône de piste",
    SI_LUIE_LAM_CA_ANTIQUITY_ICON_TP = "Afficher une icône pour les pistes pertinentes découvertes.",
    SI_LUIE_LAM_CA_ANTIQUITY_COLOR = "Couleur des message d'antiquité", -- TODO: Add Tooltip with finalized color value
    SI_LUIE_LAM_CA_ANTIQUITY_PREFIX = "Antiquité : Message de préfixe",
    SI_LUIE_LAM_CA_ANTIQUITY_PREFIX_TP = "Choisir le message de préfixe affiché quand une piste d'antiquité est découverte.\nDéfaut : Piste d'Antiquité acquise",
    SI_LUIE_LAM_CA_ANTIQUITY_PREFIX_BRACKET = "Antiquité : Crochet préfixe ",
    SI_LUIE_LAM_CA_ANTIQUITY_PREFIX_BRACKET_TP = "Ces crochets délimiteront le message de préfixe quand une piste d'antiquité est décvouverte.",
    SI_LUIE_LAM_CA_ANTIQUITY_SUFFIX = "Antiquité : Message de suffixe",
    SI_LUIE_LAM_CA_ANTIQUITY_SUFFIX_TP = "Choisir le message de suffixe affiché quand une piste d'antiquité est décvouverte.\nDéfaut : Aucune message",
    ...
    SI_LUIE_LAM_CA_DISPLAY_HEADER_MISC = "Misc Announcements",
    SI_LUIE_LAM_CA_DISPLAY_HEADER_ZONE = "Zone Announcements",
    SI_LUIE_LAM_CA_DISPLAY_HEADER_ARENA = "Arena Announcements",
    SI_LUIE_LAM_CA_DISPLAY_HEADER_DUNGEON = "Dungeon Announcements",
    ...
    SI_LUIE_LAM_CA_DISPLAY_MISC_GENERAL = "Display General Announcements - <<1>>",
    SI_LUIE_LAM_CA_DISPLAY_MISC_GENERAL_TP = "Display <<1>> when an uncategorized Display Announcement is shown.",
    SI_LUIE_LAM_CA_DISPLAY_MISC_RESPEC = "Display Respec Notification - <<1>>",
    SI_LUIE_LAM_CA_DISPLAY_MISC_RESPEC_TP = "Display <<1>> when you redistribute Champion Points and when you relearn attributes, skill points, or morphs.",
    SI_LUIE_LAM_CA_DISPLAY_MISC_GROUPAREA = "Display Entering/Leaving Group Area - <<1>>",
    SI_LUIE_LAM_CA_DISPLAY_MISC_GROUPAREA_TP = "Display <<1>> when entering or leaving a Group Area.",
    SI_LUIE_LAM_CA_DISPLAY_ZONE_CRAGLORN = "Display Craglorn Buffs - <<1>>",
    SI_LUIE_LAM_CA_DISPLAY_ZONE_CRAGLORN_TP = "Display <<1>> when you gain a buff from completing a World Boss event in Craglorn.",
    SI_LUIE_LAM_CA_DISPLAY_ZONE_IC = "Display Imperial City Area Messages - <<1>>",
    SI_LUIE_LAM_CA_DISPLAY_ZONE_IC_TP = "Display <<1>> when entering a new area of the Imperial City Sewers.",
    SI_LUIE_LAM_CA_DISPLAY_ZONE_IC_DESCRIPTION = "Display Area Description (CA)",
    SI_LUIE_LAM_CA_DISPLAY_ZONE_IC_DESCRIPTION_TP = "Display the description text in chat when entering a new area of the Imperial City Sewers.\nNote: This option uses the POI Description Color from Quest/POI Announcements.",
    SI_LUIE_LAM_CA_DISPLAY_ARENA_MAELSTROM = "Display Maelstrom Arena Messages - <<1>>",
    SI_LUIE_LAM_CA_DISPLAY_ARENA_MAELSTROM_TP = "Display <<1>> when progressing in Maelstrom Arena.",
    SI_LUIE_LAM_CA_DISPLAY_ARENA_DRAGONSTAR = "Display Dragonstar Arena Messages - <<1>>",
    SI_LUIE_LAM_CA_DISPLAY_ARENA_DRAGONSTAR_TP = "Display <<1>> when progressing in Dragonstar Arena.",
    SI_LUIE_LAM_CA_DISPLAY_DUNGEON_ENDLESS = "Display Endless Archive Progress - <<1>>",
    SI_LUIE_LAM_CA_DISPLAY_DUNGEON_ENDLESS_TP = "Display <<1>> when progressing in Endless Archive.",
    ...
    -- Module: Combat Info
    SI_LUIE_LAM_CI_HEADER = "Paramètres des informations de combat",
    SI_LUIE_LAM_CI_SHOWCOMBATINFO = "Module des informations de combat",
    ...
    SI_LUIE_LAM_CI_ENEMY_MARKER_HEADER = "Floating Markers",
    SI_LUIE_LAM_CI_ENEMY_MARKER = "Show Enemy Markers",
    SI_LUIE_LAM_CI_ENEMY_MARKER_TP = "Display a red arrow over the head of enemies you are currently in combat with.",
    SI_LUIE_LAM_CI_ENEMY_MARKER_SIZE = "Enemy Marker Size",
    ...
    SI_LUIE_LAM_CI_CCT_ROOT_TOGGLE_TP = "Display a notification when Immobilized. Requires the base game menu setting under Combat for Active Combat Tips to be enabled.",
    SI_LUIE_LAM_CI_CCT_ROOT_COLOR = "Root Color",
    SI_LUIE_LAM_CI_CCT_SNARE_HEADER = "Snared Alerts",
    SI_LUIE_LAM_CI_CCT_SNARE_TOGGLE = "Show Snared Warning",
    SI_LUIE_LAM_CI_CCT_SNARE_TOGGLE_TP = "Display a notification when Snared. Immobilization effects will display as snares if the setting for Immobilized Warnings is disabled.",
    SI_LUIE_LAM_CI_CCT_SNARE_COLOR = "Snare Color",
    ...
    -- Module: Info Panel
    SI_LUIE_LAM_PNL = "Panneau d'informations",
    SI_LUIE_LAM_PNL_ENABLE = "Module du panneau d'informations",
    SI_LUIE_LAM_PNL_DESCRIPTION = "Affiche un panneau avec des informations utiles comme la latence, les FPS, l'usage de l'armure et les charges des armes, etc...",
    SI_LUIE_LAM_PNL_DISABLECOLORSRO = "Désactiver les couleurs des données en lecture seule",
    ...
    SI_LUIE_LAM_PNL_ELEMENTS_HEADER = "Elements du panneau d'informations",
    SI_LUIE_LAM_PNL_HEADER = "Paramètres du panneau d'informations",
    ...
    SI_LUIE_LAM_PNL_RESETPOSITION_TP = "Réinitialisation de la position du panneau d'information dans le coin haut/droit de l'écran.",
    SI_LUIE_LAM_PNL_SHOWARMORDURABILITY = "Afficher l'usage de l'armure",
    SI_LUIE_LAM_PNL_SHOWBAGSPACE = "Afficher le remplissage des sacs",
    SI_LUIE_LAM_PNL_SHOWCLOCK = "Afficher l'heure",
    SI_LUIE_LAM_PNL_CLOCKFORMAT = "Clock Format",
    SI_LUIE_LAM_PNL_SHOWEAPONCHARGES = "Afficher les charges des armes",
    SI_LUIE_LAM_PNL_SHOWFPS = "Afficher les FPS",
    SI_LUIE_LAM_PNL_SHOWLATENCY = "Afficher la latence",
    SI_LUIE_LAM_PNL_SHOWMOUNTTIMER = "Afficher l'état d'entrainement de la monture |c00FFFF*|r",
    SI_LUIE_LAM_PNL_SHOWMOUNTTIMER_TP = "(*) Cette informations sera automatiquement masquée si la monture est entrainée au maximum de ses capacités.",
    SI_LUIE_LAM_PNL_SHOWSOULGEMS = "Afficher le nombre de pierres d'âmes",
    SI_LUIE_LAM_PNL_UNLOCKPANEL = "Déverrouiller le panneau d'informations",
    SI_LUIE_LAM_PNL_UNLOCKPANEL_TP = "Permet le déplacement du panneau d'informations avec la souris.",
    SI_LUIE_LAM_PNL_DISPLAYONWORLDMAP = "Afficher le panneau d'informations dans la fenêtre de la carte du monde",
    ...
    -- Module: Unitframes
    SI_LUIE_LAM_UF_ENABLE = "Module des cadres des unités",
    ...
    SI_LUIE_LAM_UF_CFRAMES_COLOR_INVULNERABLE = "Invulnerable Color",
    ...
    -- Module: Combat Text
    SI_LUIE_LAM_CT = "Messages de Combat",
    SI_LUIE_LAM_CT_SHOWCOMBATTEXT = "Module de Messages de Combat",
    SI_LUIE_LAM_CT_DESCRIPTION = "Affichez les messages de combat avec des valeurs de dégâts/soins et diverses alertes.",
    SI_LUIE_LAM_CT_UNLOCK = "Déverrouiller",
    SI_LUIE_LAM_CT_UNLOCK_TP = "Déverrouiller les panneaux pour les déplacer.",
    SI_LUIE_LAM_CT_IC_ONLY = "En combat seulement",
    SI_LUIE_LAM_CT_IC_ONLY_TP = "Only display incoming and outgoing numbers when in combat.",
    SI_LUIE_LAM_CT_TRANSPARENCY = "Configure la Transparence",
    SI_LUIE_LAM_CT_TRANSPARENCY_TP = "Configure une valeur d'alpha pour les messages de combat.",
    ...
    SI_LUIE_LAM_CT_SHARED_DAMAGE = "Dégâts",
    SI_LUIE_LAM_CT_SHARED_DAMAGE_CRITICAL = "Dégâts (Critique)",
    SI_LUIE_LAM_CT_SHARED_HEALING = "Soins",
    SI_LUIE_LAM_CT_SHARED_HEALING_CRITICAL = "Soins (Critique)",
    SI_LUIE_LAM_CT_SHARED_DOT = "Dégâts sur la Durée (DoT)",
    SI_LUIE_LAM_CT_SHARED_DOT_ABV = "DoT",
    SI_LUIE_LAM_CT_SHARED_DOT_CRITICAL = "Dégâts sur la Durée (Critique)",
    SI_LUIE_LAM_CT_SHARED_HOT = "Soins sur la Durée (HoT)",
    SI_LUIE_LAM_CT_SHARED_HOT_ABV = "HoT",
    SI_LUIE_LAM_CT_SHARED_HOT_CRITICAL = "Soins sur la Durée (Critique)",
    SI_LUIE_LAM_CT_SHARED_GAIN_LOSS = "Variation de Ressources (Gain/Perte)",
    SI_LUIE_LAM_CT_SHARED_ENERGIZE = "Gain de Ressources",
    SI_LUIE_LAM_CT_SHARED_ENERGIZE_ULTIMATE = "Gain de Compétence Ultime",
    SI_LUIE_LAM_CT_SHARED_DRAIN = "Perte de Ressources",
    SI_LUIE_LAM_CT_SHARED_MITIGATION = "Atténuation",
    SI_LUIE_LAM_CT_SHARED_MISS = "Raté",
    SI_LUIE_LAM_CT_SHARED_IMMUNE = "Immunisé",
    SI_LUIE_LAM_CT_SHARED_PARRIED = "Paré",
    SI_LUIE_LAM_CT_SHARED_REFLECTED = "Réfléchi",
    SI_LUIE_LAM_CT_SHARED_DAMAGE_SHIELD = "Dégats absorbés",
    SI_LUIE_LAM_CT_SHARED_DODGED = "Esquivé",
    SI_LUIE_LAM_CT_SHARED_BLOCKED = "Bloqué",
    SI_LUIE_LAM_CT_SHARED_INTERRUPTED = "Interrompu",
    SI_LUIE_LAM_CT_SHARED_CROWD_CONTROL = "Contrôle de foule",
    SI_LUIE_LAM_CT_SHARED_DISORIENTED = "Désorienté",
    SI_LUIE_LAM_CT_SHARED_FEARED = "Effrayé",
    SI_LUIE_LAM_CT_SHARED_CHARMED = "Charmed",
    SI_LUIE_LAM_CT_SHARED_OFF_BALANCE = "Bilan +/-",
    SI_LUIE_LAM_CT_SHARED_SILENCED = "Réduit au silence",
    SI_LUIE_LAM_CT_SHARED_STUNNED = "Etourdi",
    SI_LUIE_LAM_CT_SHARED_COMBAT_STATE = "Combat State",
    SI_LUIE_LAM_CT_SHARED_COMBAT_IN = "En Combat",
    SI_LUIE_LAM_CT_SHARED_COMBAT_OUT = "Hors Combat",
    SI_LUIE_LAM_CT_SHARED_ALERT = "Active les alertes de combats",
    SI_LUIE_LAM_CT_SHARED_ALERT_BLOCK = "Bloquer",
    SI_LUIE_LAM_CT_SHARED_ALERT_BLOCK_S = "Block Stagger",
    SI_LUIE_LAM_CT_SHARED_ALERT_DODGE = "Esquiver",
    SI_LUIE_LAM_CT_SHARED_ALERT_AVOID = "Eviter",
    SI_LUIE_LAM_CT_SHARED_ALERT_INTERRUPT = "Interrompre",
    SI_LUIE_LAM_CT_SHARED_ALERT_UNMIT = "Non Atténuable",
    SI_LUIE_LAM_CT_SHARED_ALERT_POWER = "Important Enemy Buffs (Power/Enrage)",
    SI_LUIE_LAM_CT_SHARED_ALERT_DESTROY = "Détruire (Cible Prioritaire)",
    SI_LUIE_LAM_CT_SHARED_ALERT_SUMMON = "Enemy NPC Summons",
    SI_LUIE_LAM_CT_SHARED_POINTS = "Points d'expérience, de champion, et d'alliance",
    SI_LUIE_LAM_CT_SHARED_POINTS_ALLIANCE = "Points d'alliance",
    SI_LUIE_LAM_CT_SHARED_POINTS_EXPERIENCE = "Points d'expérience",
    SI_LUIE_LAM_CT_SHARED_POINTS_CHAMPION = "Points de champion",
    SI_LUIE_LAM_CT_SHARED_RESOURCE = "Ressources",
    SI_LUIE_LAM_CT_SHARED_LOW_HEALTH = "Vie Basse",
    SI_LUIE_LAM_CT_SHARED_LOW_MAGICKA = "Magie Basse",
    SI_LUIE_LAM_CT_SHARED_LOW_STAMINA = "Vigueur Basse",
    SI_LUIE_LAM_CT_SHARED_ULTIMATE_READY = "Compétence Ultime Prête",
    SI_LUIE_LAM_CT_SHARED_POTION_READY = "Potion Prête",
    SI_LUIE_LAM_CT_SHARED_ULTIMATE_AND_POTION_READY = "Compétence Ultime & Potion Prêtes",
    SI_LUIE_LAM_CT_SHARED_INCOMING = "Entrant",
    SI_LUIE_LAM_CT_SHARED_OUTGOING = "Reçu",
    SI_LUIE_LAM_CT_SHARED_DISPLAY = "Afficher",
    SI_LUIE_LAM_CT_SHARED_FORMAT = "Format",
    SI_LUIE_LAM_CT_SHARED_CRITICAL = "Critique",
    SI_LUIE_LAM_CT_SHARED_OPTIONS = "Options",
    SI_LUIE_LAM_CT_SHARED_COLOR = "Couleur de la police",
    SI_LUIE_LAM_CT_SHARED_WARNING = "Alerte",
    SI_LUIE_LAM_CT_SHARED_STAMINA = "Vigueur",
    SI_LUIE_LAM_CT_SHARED_MAGICKA = "Magie",
    SI_LUIE_LAM_CT_SHARED_ULTIMATE = "Point Ultime",
    SI_LUIE_LAM_CT_HEADER_DAMAGE_AND_HEALING = "Dégâts & Soins",
    SI_LUIE_LAM_CT_HEADER_RESOURCE_GAIN_DRAIN = "Gain et Perte de Ressources",
    SI_LUIE_LAM_CT_HEADER_MITIGATION = "Atténuation",
    SI_LUIE_LAM_CT_HEADER_CROWD_CONTROL = "Contrôle de foule",
    SI_LUIE_LAM_CT_HEADER_NOTIFICATION = "Notification",
    SI_LUIE_LAM_CT_HEADER_LOW_RESOURCE = "Alerte : Ressource faible",

    SI_LUIE_LAM_CT_HEADER_DAMAGE_COLOR = "Dégât : Options de couleurs",
    SI_LUIE_LAM_CT_HEADER_HEALING_COLOR = "Soins : Options de couleurs",
    SI_LUIE_LAM_CT_HEADER_SHARED_FONT_SIZE = "Taille de police partagée",
    SI_LUIE_LAM_CT_HEADER_SHARED_RESOURCE_OPTIONS = "Paramètres partagés",
    SI_LUIE_LAM_CT_INCOMING_DAMAGE_HEAL_HEADER = "Dégâts & Soins Entrants",
    SI_LUIE_LAM_CT_INCOMING_DAMAGE_TP = "Afficher les dégâts directs entrants.",
    ...
    SI_LUIE_LAM_CT_NOTIFICATION_COMBAT_STATE = "Statut de Combat",
    ...
    SI_LUIE_LAM_CT_NOTIFICATION_RESOURCES = "Ressources",
    ...
    SI_LUIE_LAM_CT_NOTIFICATION_POINTS_ALLIANCE_TP = "Afficher les points d'alliance gagnés.",
    SI_LUIE_LAM_CT_NOTIFICATION_POINTS_EXPERIENCE_TP = "Afficher les points d'expérience gagnés.",
    SI_LUIE_LAM_CT_NOTIFICATION_POINTS_CHAMPION_TP = "Afficher les points de champion gagnés.",

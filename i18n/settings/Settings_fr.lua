...
local strings = {
    ...
    SI_LUIE_LAM_RELOADUI =                               "Rechargement de l'interface",
    ...
    SI_LUIE_LAM_RESETPOSITION =                          "Réinitialisation des positions des cadres de messages",
    ...
    SI_LUIE_LAM_BUFFSDEBUFFS =                           "Améliorations & affaiblissements",

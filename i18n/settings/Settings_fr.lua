...
local strings = {
    ...
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_QUESTOPEN =          "Objet de quête - Opened",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_QUESTOPEN_TP =       "Message to use when a quest item is opened (a letter, a box, etc).\nDéfaut : You open %s.",
    SI_LUIE_LAM_CA_CURRENCY_MESSAGE_QUESTCONFISCATE =    "QObjet de quête - Confiscated",

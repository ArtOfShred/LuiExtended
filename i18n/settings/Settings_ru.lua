...
local strings = {
    ...
    SI_LUIE_LAM_CI_CCT_ROOT_TOGGLE_TP = "Отображать уведомление, когда вас обездвижили.",
    ...
    SI_LUIE_LAM_CI_CCT_SNARE_TOGGLE_TP = "Отображать уведомление, когда вас поймали.",

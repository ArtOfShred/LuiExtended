...
local strings = {
    ...
    SI_LUIE_LAM_CA_DISPLAY_MISC_RESPEC = "Выводит сообщение при Сбросе - <<1>>",
    SI_LUIE_LAM_CA_DISPLAY_MISC_RESPEC_TP = "Выводит <<1>> когда вы перераспределяете очки чемпиона и очки характеристик, навыков или морфы.",
    SI_LUIE_LAM_CA_DISPLAY_ARENA_MAELSTROM = "Уровни DSA/MSA арен - <<1>>",
    SI_LUIE_LAM_CA_DISPLAY_ARENA_MAELSTROM_TP = "Показывает <<1>> когда начинается новый уровень Драгонстарской или Вихревой арены.",
    ...
    SI_LUIE_LAM_CA_DISPLAY_DUNGEON_ENDLESS = "Раунды Вихревой арены - <<1>>",
    SI_LUIE_LAM_CA_DISPLAY_DUNGEON_ENDLESS_TP = "Показывает <<1>> когда начинается новый раунд Вихревой арены.",
    SI_LUIE_LAM_CA_DISPLAY_ZONE_CRAGLORN = "Баффы Краглорна - <<1>>",
    SI_LUIE_LAM_CA_DISPLAY_ZONE_CRAGLORN_TP = "Показывает <<1>> когда вы получаете бафф за завершение мировых событий Краглорна.",
    SI_LUIE_LAM_CA_DISPLAY_MISC_GROUPAREA = "Вход/Выход из групповой области - <<1>>",
    SI_LUIE_LAM_CA_DISPLAY_MISC_GROUPAREA_TP = "Показывает <<1>> при входе или выходе из групповой области.",
    SI_LUIE_LAM_CA_DISPLAY_ZONE_IC = "Сообщения областей Имп.города - <<1>>",
    SI_LUIE_LAM_CA_DISPLAY_ZONE_IC_TP = "Показывает <<1>> при входе в новую область Имперского города и канализации.\nПримечание: Эта настройка использует цвет названий POI Оповещения заданий/POI.",
    SI_LUIE_LAM_CA_DISPLAY_ZONE_IC_DESCRIPTION = "Описание областей Имперского города",
    SI_LUIE_LAM_CA_DISPLAY_ZONE_IC_DESCRIPTION_TP = "Показывает текст описания при входе в новую область Имперского города и канализации.\nПримечание: Эта настройка использует цвет названий POI Оповещения заданий/POI.",

...
local strings = {
    ...
    SI_LUIE_LAM_UF_SHARED_LABEL_NOTHING =                "Nothing",
    SI_LUIE_LAM_UF_SHARED_LABEL_CURRENT =                "Current",
    SI_LUIE_LAM_UF_SHARED_LABEL_CURRSHIELD =             "Current + Shield",
    SI_LUIE_LAM_UF_SHARED_LABEL_MAX =                    "Max",
    SI_LUIE_LAM_UF_SHARED_LABEL_PERCENT =                "Percentage%",
    SI_LUIE_LAM_UF_SHARED_LABEL_CURRMAX =                "Current / Max",
    SI_LUIE_LAM_UF_SHARED_LABEL_CURRSHIELDMAX =          "Current + Shield / Max",
    SI_LUIE_LAM_UF_SHARED_LABEL_CURRMAXPERCENT =         "Current / Max (Percentage%)",
    SI_LUIE_LAM_UF_SHARED_LABEL_CURRSHIELDMAXPERCENT =   "Current + Shield / Max (Percentage%)",
    SI_LUIE_LAM_UF_SHARED_LABEL_CURRPERCENT =            "Current (Percentage%)",
    SI_LUIE_LAM_UF_SHARED_LABEL_CURRSHIELDPERCENT =      "Current + Shield (Percentage%)",

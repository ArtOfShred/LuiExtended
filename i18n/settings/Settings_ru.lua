...
local strings = {
    ...
    SI_LUIE_LAM_CA_ANTIQUITY_PREFIX_TP =                 "Префикс сообщения о найденной зацепки.\nПо умолчанию: Найдена зацепка",
    SI_LUIE_LAM_CA_ANTIQUITY_PREFIX_BRACKET =            "Скобки префикса сообщения",
    SI_LUIE_LAM_CA_ANTIQUITY_PREFIX_BRACKET_TP =         "Выберете скобки в которых будет находится префикс сообщения о найденной зацепки.",
    SI_LUIE_LAM_CA_ANTIQUITY_SUFFIX =                    "Суффикс найденной зацепки",
    SI_LUIE_LAM_CA_ANTIQUITY_SUFFIX_TP =                 "Суффикс сообщения о найденной зацепки. (Находится в конце сообщения) \nПо умолчанию: Ничего",
    ...
    SI_LUIE_LAM_CI_ALERT_CC_COLOR_SILENCE =              "Безмолвия",
    SI_LUIE_LAM_CI_ALERT_CC_COLOR_SILENCE_TP =           "Устанавливает цвет рамки значка для входящего эффекта Безмолвия",
    SI_LUIE_LAM_CI_ALERT_CC_COLOR_STAGGER =              "Stagger", --TODO: Translete

...
local strings = {
    ...
    SI_LUIE_LAM_CI_ALERT_CC_COLOR_STAGGER =              "Шатание", --TODO: Translete
    SI_LUIE_LAM_CI_ALERT_CC_COLOR_STAGGER_TP =           "Устанавливает цвет рамки значка для входящего эффекта Шатания",

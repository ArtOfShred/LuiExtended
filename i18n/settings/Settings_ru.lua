...
local strings = {
    ...
    SI_LUIE_LAM_SLASHCMDS_ARMORY_TP = "'/armory' Призывает <<1>> (Если разблокировано).",
    SI_LUIE_LAM_SLASHCMDS_DECON = "( '/decon' ) деконструкция",
    SI_LUIE_LAM_SLASHCMDS_DECON_TP = "'/decon' Призывает <<1>> (Если разблокировано).\n\t\t\t\t\tАльтернативный вариант: '/deconstruction'",
    ...
    SI_LUIE_LAM_CI_CCT_ROOT_HEADER = "Оповещения о обездвижении",
    SI_LUIE_LAM_CI_CCT_ROOT_TOGGLE = "Показать предупреждение о обездвижении",
    ...
    SI_LUIE_LAM_CI_CCT_SNARE_HEADER = "Оповещения о ловушке",
    SI_LUIE_LAM_CI_CCT_SNARE_TOGGLE = "Показать предупреждение о ловушке",
    ...
    SI_LUIE_LAM_UF_WHITELIST_ADD_ASSISTANTS_TP = "Добавляет помощников таких как: Эзаби, Фезез, Контрабандистка Пирарри, Нузима, Тифис Андромо, Барон, Скупщица в белый список.",

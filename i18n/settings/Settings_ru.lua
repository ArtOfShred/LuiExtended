...
local strings = {
    ...
    SI_LUIE_LAM_CI_CCT_SNARE_HEADER =                    "Оповещения о ловушке/обездвижении",
    SI_LUIE_LAM_CI_CCT_SNARE_TOGGLE =                    "Показать предупреждение о ловушке/обездвижении",
    SI_LUIE_LAM_CI_CCT_SNARE_TOGGLE_TP =                 "Отображать уведомление, когда вас поймали/обездвижили.",

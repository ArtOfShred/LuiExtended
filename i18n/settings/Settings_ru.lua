...
local strings = {
    ...
    SI_LUIE_LAM_BUFF_SHOWFRACTIONSABOVETEN =             "Показать Доли секунды всегда",
    SI_LUIE_LAM_BUFF_SHOWFRACTIONSABOVETEN_TP =          "Показывать Доли секунды, когда оставшееся время превышает десять секунд.",

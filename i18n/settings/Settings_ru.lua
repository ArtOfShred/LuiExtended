...
local strings = {
    ...
    SI_LUIE_LAM_CI_ALERT_MITIGATION_SUFFIX_TP =          s"Enable this option to display the BLOCK/DODGE/AVOID/INTERRUPT/CANNOT MITIGATE suffix on incoming ability alerts.",

...
local strings = {
    ...
    SI_LUIE_LAM_BUFF_SHOWFRACTIONSABOVETEN =             "Show Fractions Above Ten", -- TODO: Tranlete
    SI_LUIE_LAM_BUFF_SHOWFRACTIONSABOVETEN_TP =          "Also show fractions when the remaining time is above ten seconds.", -- TODO: Tranlete

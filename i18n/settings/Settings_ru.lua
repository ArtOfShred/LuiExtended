...
local strings = {
    ...
    SI_LUIE_LAM_BUFF_SHOW_GROUND_DAMAGE =                "Отображать наземные ауры урона/исцеления",
    SI_LUIE_LAM_BUFF_SHOW_GROUND_DAMAGE_TP =             "Отображает индикатор баффа, когда вы стоите на эффекте враждебной АОЕ без каких-либо элементов управления толпой, таких как Arrow Barrage. Также показывает для целительных эффектов, таких как Cleansing Ritual.",
    ...
    SI_LUIE_LAM_BUFF_PROM_BUFFALIGNMENT_VERT =           "Вертикальное положение баффов",
    SI_LUIE_LAM_BUFF_PROM_BUFFALIGNMENT_VERT_TP =        "Выравнивание значков баффа и дебаффа в контейнере баффа при установке в вертикальную ориентацию.",
    SI_LUIE_LAM_BUFF_PROM_BUFFALIGNMENT_HORIZ =          "Горизонтальное положение баффов",
    SI_LUIE_LAM_BUFF_PROM_BUFFALIGNMENT_HORIZ_TP =       "Выравнивание значков баффа и дебаффа в контейнере баффа при установке в горизонтальную ориентацию.",
    SI_LUIE_LAM_BUFF_PROM_DEBUFFALIGNMENT_VERT =         "Вертикальное положение дебаффов",
    SI_LUIE_LAM_BUFF_PROM_DEBUFFALIGNMENT_VERT_TP =      "Выравнивание значков баффа и дебаффа в контейнере баффа при установке в вертикальную ориентацию.",
    SI_LUIE_LAM_BUFF_PROM_DEBUFFALIGNMENT_HORIZ =        "Горизонтальное положение дебаффов",
    SI_LUIE_LAM_BUFF_PROM_DEBUFFALIGNMENT_HORIZ_TP =     "Выравнивание значков баффа и дебаффа в контейнере баффа при установке в горизонтальную ориентацию.",
    ...
    SI_LUIE_LAM_GENERIC_MAJOR_MINOR =                    "Use Default Major & Minor Slayer/Aegis/etc Icons", --TODO Translete
    SI_LUIE_LAM_GENERIC_MAJOR_MINOR_TP =                 "When enabled, use the default icons for Major/Minor Slayer, Aegis, Courage, and Toughness.", --TODO Translete

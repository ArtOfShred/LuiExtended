...
local strings = {
    ...
    LUIE_STRING_SKILL_MINOR_MAGICKASTEAL_TP = "Восстанавливает |cFFFFFF168|r магии каждую |cFFFFFF1|r секунду, при получении урона.",
    LUIE_STRING_SKILL_MINOR_LIFESTEAL_TP = "Восстанавливает |cFFFFFF600|r здоровья каждую |cFFFFFF1|r секунду, при получении урона.",
    LUIE_STRING_SKILL_MINOR_ENERVATION_TP = "Снижает критический урон на |cFFFFFF10|r%.",

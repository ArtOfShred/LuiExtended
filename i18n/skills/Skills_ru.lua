...
local strings = {
    ...
    SI_LUIE_SKILL_MUNDUS_BASIC_THIEF =                   "Повышает ваш рейтинг критического удара Оружием и Заклинаниями на |cFFFFFF1333|r.",
    ...
    SI_LUIE_SKILL_MINOR_FORTITUDE_TP =                   "Повышает восстановление здоровья на |cFFFFFF15|r%.",
    SI_LUIE_SKILL_MAJOR_FORTITUDE_TP =                   "Повышает восстановление здоровья на |cFFFFFF30|r%.",
    SI_LUIE_SKILL_MINOR_ENDURANCE_TP =                   "Повышает восстановление запаса сил на |cFFFFFF15|r%.",
    SI_LUIE_SKILL_MAJOR_ENDURANCE_TP =                   "Повышает восстановление запаса сил на |cFFFFFF30|r%.",
    SI_LUIE_SKILL_MINOR_INTELLECT_TP =                   "Повышает восстановление магии на |cFFFFFF15|r%.",
    ...
    SI_LUIE_SKILL_MAJOR_FORCE_TP =                       "Повышает критический урон на |cFFFFFF20|r%.",
    SI_LUIE_SKILL_MINOR_VITALITY_TP =                    "Повышает получаемое исцеление на |cFFFFFF8|r%.",
    SI_LUIE_SKILL_MAJOR_VITALITY_TP =                    "Повышает получаемое исцеление на |cFFFFFF16|r%.",
    SI_LUIE_SKILL_MINOR_MENDING_TP =                     "Повышает наносимое исцеление на |cFFFFFF8|r%.",
    SI_LUIE_SKILL_MAJOR_MENDING_TP =                     "Повышает наносимое исцеление на |cFFFFFF16|r%.",
    SI_LUIE_SKILL_MINOR_PROTECTION_TP =                  "Снижает получаемый урон на |cFFFFFF5|r%.",
    SI_LUIE_SKILL_MAJOR_PROTECTION_TP =                  "Снижает получаемый урон на |cFFFFFF10|r%.",
    ...
    SI_LUIE_SKILL_MINOR_EXPEDITION_TP =                  "Повышает скорость передвижения на |cFFFFFF15|r%.",
    ...
    SI_LUIE_SKILL_MINOR_COURAGE_TP =                     "Повышает урон от оружия и заклинаний на |cFFFFFF215|r.",
    SI_LUIE_SKILL_MAJOR_COURAGE_TP =                     "Повышает урон от оружия и заклинаний на |cFFFFFF430|r.",
    ...
    SI_LUIE_SKILL_MINOR_VULNERABILITY_TP =               "Увеличивает получаемый урон на |cFFFFFF5|r%.",
    SI_LUIE_SKILL_MAJOR_VULNERABILITY_TP =               "Увеличивает получаемый урон на |cFFFFFF10|r%.",
    SI_LUIE_SKILL_MINOR_MAIM_TP =                        "Снижает наносимый урон на |cFFFFFF5|r%.",
    SI_LUIE_SKILL_MAJOR_MAIM_TP =                        "Снижает наносимый урон на |cFFFFFF10|r%.",
    SI_LUIE_SKILL_MINOR_DEFILE_TP =                      "Снижает получаемое исцеление и восстановление здоровья на |cFFFFFF8|r%.",
    SI_LUIE_SKILL_MAJOR_DEFILE_TP =                      "Снижает получаемое исцеление и восстановление здоровья на |cFFFFFF16|r%.",
    ...
    SI_LUIE_SKILL_MAJOR_SLAYER_TP =                      "Ваши атаки наносят на |cFFFFFF10|r% больше урона по противникам в Подземельях, Испытаниях и на Аренах.",
    ...
    SI_LUIE_SKILL_GENERIC_INCREASE_HEALING_RECEIVED_NO_DUR_TP = "Увеличивает получаемое исцеление на |cFFFFFF<<2>>|r%.",
    ...
    SI_LUIE_SKILL_MOLTEN_ARMAMENTS_TP =                  "Увеличивает урон полностью заряженных Силовых атак  на |cFFFFFF50|r% в течение |cFFFFFF<<1>>|r секунд.",
    ...
    SI_LUIE_SKILL_CRYSTAL_FRAGMENTS_TP =                 "Ваше следующее применение Crystal Fragments в течение |cFFFFFF<<1>>|r секунд происходит мгновенно, наносит на |cFFFFFF66|r% больше урона, и расходует на |cFFFFFF50|r% меньше Магии.",
    ...
    SI_LUIE_SKILL_DAEDRIC_MINES_TP =                     "Взрывается, когда близко подходит противник, нанося Магический урон и обездвиживая его на |cFFFFFF2|r секунды.",
    ...
    SI_LUIE_SKILL_BOUND_ARMOR_TP =                       "Увеличивает на |cFFFFFF<<2>>|r% блокируемый урон на |cFFFFFF<<1>>|r секунды.",

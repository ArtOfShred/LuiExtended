...
local strings = {
    ...
    SI_LUIE_SKILL_GRIM_FOCUS_DEFENSE_TP =                "Reduce damage taken by |cFFFFFF2|r%, stacking up to |cFFFFFF5|r times.\n\nStacks are lost when firing the spectral bow or exiting combat.",
    ...
    SI_LUIE_SKILL_UNSTABLE_CORE_TP =                     "Using a Direct Damage attack deals increasing Magic Damage and harms you with growing intensity.\n\nYour first attack reduces your movement speed by |cFFFFFF30|r% for |cFFFFFF4|r seconds, your second attack immobilizes you for |cFFFFFF3|r seconds, and your third attack stuns you for |cFFFFFF3|r seconds.\n\nThe effects can activate once every |cFFFFFF1|r second.",
    ...
    SI_LUIE_SKILL_BONE_ARMOR_TP =                        "Gain Major Resolve and Major Ward for |cFFFFFF<<1>>|r seconds.\n\nCreates a corpse when the effect completes.",
    SI_LUIE_SKILL_BECKONING_ARMOR_TP =                   "Gain Major Resolve and Major Ward for |cFFFFFF<<1>>|r seconds.\n\nWhile active, enemies that strike you with ranged attacks will be pulled toward you once every |cFFFFFF3|r seconds.\n\nCreates a corpse when the effect completes.",
    SI_LUIE_SKILL_SUMMONERS_ARMOR_TP =                   "Gain Major Resolve and Major Ward for |cFFFFFF<<1>>|r seconds.\n\nWhile active, reduces the cost of Blastbones, Skeletal Mage, and Spirit Mender by |cFFFFFF15|r%.\n\nCreates a corpse when the effect completes.",
    ...
    SI_LUIE_SKILL_BLADE_CLOAK_TP =                       "Кольцо летающих острых лезвий окружает вас, нанося Физический урон всем ближайшим противникам каждые |cFFFFFF<<2>>|r секунды в течение |cFFFFFF<<1>>|r секунд.",
    ...
    SI_LUIE_SKILL_INVIGORATING_DRAIN_TP =                "Afflicted with Magic Damage every |cFFFFFF1|r second for |cFFFFFF<<1>>|r seconds. Each tick heals the vampire for |cFFFFFF15|r% of their missing health and generates |cFFFFFF5|r Ultimate.",

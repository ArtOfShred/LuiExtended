...
local strings = {
    ...
    --SI_LUIE_SKILL_BRACE_TP =                             "Блокируется атака, получаемый урон снижен и действует иммунитет к оглушающим и отбрасывающим эффектам .",
    ...
    SI_LUIE_SKILL_MINOR_FORTITUDE_TP =                   "Повышает восстановление здоровья на |cFFFFFF20|r%.",
    SI_LUIE_SKILL_MAJOR_FORTITUDE_TP =                   "Повышает восстановление здоровья на |cFFFFFF40|r%.",
    SI_LUIE_SKILL_MINOR_ENDURANCE_TP =                   "Повышает восстановление запаса сил на |cFFFFFF20|r%.",
    SI_LUIE_SKILL_MAJOR_ENDURANCE_TP =                   "Повышает восстановление запаса сил на |cFFFFFF40|r%.",
    SI_LUIE_SKILL_MINOR_INTELLECT_TP =                   "Повышает восстановление магии на |cFFFFFF20|r%.",
    SI_LUIE_SKILL_MAJOR_INTELLECT_TP =                   "Повышает восстановление магии на |cFFFFFF40|r%.",
    ...
    SI_LUIE_SKILL_PHASE_TP =                             "Повышает Физическую и Магическую сопротивляемости на |cFFFFFF660|r в течение |cFFFFFF<<1>>|r секунд.",
    SI_LUIE_SKILL_UNCHAINED_TP =                         "Снижает расход Запаса сил на вашу следующую способность, применённую в течение |cFFFFFF<<1>>|r секунд на |cFFFFFF80|r%.",
    SI_LUIE_SKILL_FORESIGHT_TP =                         "Снижает расход Магии на вашу следующую способность, применённую в течение |cFFFFFF<<1>>|r секунд на |cFFFFFF80|r%.",
    SI_LUIE_SKILL_RETALIATION_TP =                       "Ваша следующая Обычная атака, проведённая в течение |cFFFFFF<<1>>|r секунд наносит |cFFFFFF30|r% дополнительного урона.",

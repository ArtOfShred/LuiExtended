...
local strings = {
    ...
    SI_LUIE_SKILL_BLUE_BETTY_TP =                        "Восстанавливает |cFFFFFF4992|r Магии в течение |cFFFFFF<<1>>|r секунд.\n\nEvery |cFFFFFF5|r seconds, the netch removes |cFFFFFF1|r negative effect from you.",
    SI_LUIE_SKILL_BULL_NETCH_TP =                        "Восстанавливает |cFFFFFF4992|r Запаса сил в течение |cFFFFFF<<1>>|r секунд.\n\nEvery |cFFFFFF5|r seconds, the netch removes |cFFFFFF1|r negative effect from you.",

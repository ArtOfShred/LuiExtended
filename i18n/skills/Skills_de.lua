...
local strings = {
    ...
    SI_LUIE_SKILL_DISGUISE_TP =                          "Verkleidet. Ihr könnt durch Wachen oder auffällige Handlungen entdeckt werden.\n\nEingehender Schaden wird Eure Verkleidung zerstören.",

...
local strings = {
    ...
    SI_LUIE_SKILL_CRYSTAL_FRAGMENTS_TP =                 "Your next Crystal Fragments cast within |cFFFFFF<<1>>|r seconds is instant, deals |cFFFFFF33|r% more damage, and costs |cFFFFFF50|r% less Magicka.",
    ...
    SI_LUIE_SKILL_DETONATING_SIPHON_TP =                 "Enemies within |cFFFFFF5|r meters of the corpse and between you and the corpse take Disease Damage over |cFFFFFF<<1>>|r seconds.\n\nIf the siphon lasts its full duration it causes the corpse to explode, dealing additional Disease Damage to all enemies within |cFFFFFF5|r meters of the corpse.",
    ...
    SI_LUIE_SKILL_BLOOD_SCION_TP =                       "Transformed into a monstrous creatue of the night for |cFFFFFF<<1>>|r seconds, increasing your Max Health, Magicka, and Stamina by |cFFFFFF10000|r.\n\nWhile transformed you heal for |cFFFFFF15|r% of all damage you deal and can see enemies through walls.\n\nYou cannot generate Ultimate while transformed.",
    SI_LUIE_SKILL_SWARMING_SCION_TP =                    "Transformed into a monstrous creatue of the night for |cFFFFFF<<1>>|r seconds, increasing your Max Health, Magicka, and Stamina by |cFFFFFF10000|r.\n\nWhile transformed you heal for |cFFFFFF15|r% of all damage you deal and can see enemies through walls.\n\nBats also swarm around you and shred enemies within |cFFFFFF10|r meters, dealing Magic Damage every |cFFFFFF1|r second.\n\nYou cannot generate Ultimate while transformed.",
    ...
    SI_LUIE_SKILL_SET_EARTHGORE =                        "Healing the lowest Health friendly target in the |cFFFFFF7|r meter pool every |cFFFFFF1|r second.",

...
local strings = {
    ...
    SI_LUIE_SKILL_SUB_ASSAULT_TP =                       "After |cFFFFFF3|r seconds, deal Physical Damage and apply Major Fracture for |cFFFFFF5|r seconds to enemies up to |cFFFFFF20|r meters in front of you.",
    ...
    SI_LUIE_SKILL_UNNERVING_BONEYARD_GROUND_TP =         "Taking Frost Damage every |cFFFFFF<<2>>|r <<2[second/seconds]>> and afflicted with Major Breach and Major Fracture.",

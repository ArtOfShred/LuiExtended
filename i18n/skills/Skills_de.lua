...
local strings = {
    ...
    SI_LUIE_SKILL_HIDDEN_TP =                            "Geduckt und verborgen.\n\nEntzieht Ausdauer während der Bewegung.",
    ...
    --SI_LUIE_SKILL_BLOCK_TP =                             "Auf eine Attacke vorbereiten, reduziert den erhaltenden Schaden gewährt Immunität gegen Betäubung und Rückstoß.",
    ...
    SI_LUIE_SKILL_SUB_ASSAULT_TP =                       "After |cFFFFFF3|r seconds, deal Physical Damage and apply Major Breach for |cFFFFFF5|r seconds to enemies up to |cFFFFFF20|r meters in front of you.",

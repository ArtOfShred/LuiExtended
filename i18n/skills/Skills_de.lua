...
local strings = {
    ...
    LUIE_STRING_SKILL_MINOR_MAGICKASTEAL_TP = "Restore |cFFFFFF168|r Magicka every |cFFFFFF1|r second when damaged.",
    LUIE_STRING_SKILL_MINOR_LIFESTEAL_TP = "Restore |cFFFFFF600|r Health every |cFFFFFF1|r second when damaged.",
    LUIE_STRING_SKILL_MINOR_ENERVATION_TP = "Reduce Critical Damage by |cFFFFFF10|r%.",

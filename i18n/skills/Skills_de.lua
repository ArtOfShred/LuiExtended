...
local strings = {
    ...
    SI_LUIE_SKILL_PLAGUE_SLINGER_TP =                    "Launch a posion ball at the nearest enemy within |cFFFFFF10|r meters of the Skeever Corpse, dealing Poison Damage every |cFFFFFF1|r second for |cFFFFFF<<1>>|r seconds.",
    SI_LUIE_SKILL_SET_STORM_MASTER_TP =                  "Your Light Attacks deal additional Shock Damage for |cFFFFFF20|r seconds.",

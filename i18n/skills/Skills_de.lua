...
local strings = {
    ...
    SI_LUIE_SKILL_BLUE_BETTY_TP =                        "Restoring |cFFFFFF4992|r Magicka over |cFFFFFF<<1>>|r seconds.\n\nEvery |cFFFFFF5|r seconds, the netch removes |cFFFFFF1|r negative effect from you.",
    SI_LUIE_SKILL_BULL_NETCH_TP =                        "Restoring |cFFFFFF4992|r Stamina over |cFFFFFF<<1>>|r seconds.\n\nEvery |cFFFFFF5|r seconds, the netch removes |cFFFFFF1|r negative effect from you.",
    ...
    SI_LUIE_SKILL_SET_PIRATE_SKELETON_TP =               "Gain Major Protection and Major Defile for |cFFFFFF<<1>>|r seconds.",
    ...
    SI_LUIE_SKILL_TRINIMACS_VALOR_TP =                   "After |cffffff2|r seconds the fragment of Trinimac explodes, healing you and allies and dealing Magic Damage to enemies in a |cffffff5|r meter radius.",

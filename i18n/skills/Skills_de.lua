...
local strings = {
    ...
    SI_LUIE_SKILL_VAMPIRIC_DRAIN_TP =                    "Afflicted with Magic Damage every |cFFFFFF1|r second for |cFFFFFF<<1>>|r seconds.\n\nEvery time this effect deals damage it heals the vampire for |cFFFFFF23|r% of their missing Health.",
    SI_LUIE_SKILL_DRAIN_VIGOR_TP =                       "Afflicted with Magic Damage every |cFFFFFF1|r second for |cFFFFFF<<1>>|r seconds.\n\nEvery time this effect deals damage it heals the vampire for |cFFFFFF23|r% of their missing Health and restores |cFFFFFF5|r% of their missing Stamina.",
    SI_LUIE_SKILL_EXHILARATING_DRAIN_TP =                "Afflicted with Magic Damage every |cFFFFFF1|r second for |cFFFFFF<<1>>|r seconds.\n\nEvery time this effect deals damage it heals the vampire for |cFFFFFF23|r% of their missing Health and grants them |cFFFFFF4|r% Ultimate.",

...
local strings =
{
    ...
    --
    --
    LUIE_STRING_SKILL_MUNDUS_BASIC_LADY = 'Augmente la résistance physique et aux sorts de |cFFFFFF2744|r.';
    LUIE_STRING_SKILL_MUNDUS_BASIC_LOVER = 'Augmente la pénétration physique et des sorts de |cFFFFFF2744|r.';
    LUIE_STRING_SKILL_MUNDUS_BASIC_LORD = 'Augmente la santé maximale de |cFFFFFF2225|r.';
    LUIE_STRING_SKILL_MUNDUS_BASIC_MAGE = 'Augmente la magie maximale de |cFFFFFF2023|r.';
    LUIE_STRING_SKILL_MUNDUS_BASIC_TOWER = 'Augmente la vigueur maximale de |cFFFFFF2023|r.';
    LUIE_STRING_SKILL_MUNDUS_BASIC_ATRONACH = 'Augmente la récupération de magie de |cFFFFFF310|r.';
    LUIE_STRING_SKILL_MUNDUS_BASIC_SERPENT = 'Augmente la récupération de vigueur de |cFFFFFF310|r.';
    LUIE_STRING_SKILL_MUNDUS_BASIC_SHADOW = 'Augmente les dégâts et soins critiques de |cFFFFFF11|r%.';
    LUIE_STRING_SKILL_MUNDUS_BASIC_RITUAL = "Augmente l'efficacité des soins de |cFFFFFF8|r%.";
    LUIE_STRING_SKILL_MUNDUS_BASIC_THIEF = 'Augmente les chances de coups critiques physiques et magiques de |cFFFFFF1333|r.';
    LUIE_STRING_SKILL_MUNDUS_BASIC_WARRIOR = 'Augmente les dégats des armes de |cFFFFFF238|r.';
    LUIE_STRING_SKILL_MUNDUS_BASIC_APPRENTICE = 'Augmente les dégâts magiques de  |cFFFFFF238|r.';
    LUIE_STRING_SKILL_MUNDUS_BASIC_STEED = 'Augmente la vitesse de déplacement de |cFFFFFF10|r% et la récupération de santé de |cFFFFFF238|r.';

    -- Mundus Substitute strings for scaled default tooltips
    --
    LUIE_STRING_SKILL_MUNDUS_SUB_THIEF = 'Chance de coups critiques';
    LUIE_STRING_SKILL_MUNDUS_SUB_THIEF_REPLACE = 'Critiques';
    LUIE_STRING_SKILL_MUNDUS_SUB_RES_PEN = 'Physique et Sorts';
    LUIE_STRING_SKILL_MUNDUS_SUB_RES_PEN_REPLACE = 'Physique et Sorts';
    LUIE_STRING_SKILL_MUNDUS_STRING = 'Augmente votre';

    -- Player Innate
    LUIE_STRING_SKILL_RECALL_PENALTY = 'Penalité de téléportation';
    LUIE_STRING_SKILL_RESURRECTION_IMMUNITY = 'Immunité de résurrection';
    LUIE_STRING_SKILL_SOUL_GEM_RESURRECTION = "Pierre d'âme de résurrection";
    ...
    LUIE_STRING_SKILL_AYLEID_WELL_FORTIFIED_TP = 'Augmente la santé maximale de |cFFFFFF10|r% pendant |cFFFFFF30|r minutes.';
    LUIE_STRING_SKILL_IMMOBILIZE_IMMUNITY_TP = "Insensible aux effets d'immobilisation pendant |cFFFFFF<<1>>|r secondes.";
    LUIE_STRING_SKILL_SNARE_IMMOBILIZE_IMMUNITY_TP = "Insensible aux effets de ralentissement et d'immobilisation pendant |cFFFFFF<<1>>|r secondes.";
    LUIE_STRING_SKILL_DODGE_FATIGUE_TP = 'Les esquives consécutives coûtent |cFFFFFF33|r% points de vigueur supplémentaires par |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    ...
    LUIE_STRING_SKILL_DISGUISE_TP = 'Une fois déguisé, vous poouvez être détecté par les sentinelles ou en effectuant des actions suspectes.\n\nSubir des dégâts autres que par chute détruira votre déguisement.';
    ...
    -- Glyphs
    LUIE_STRING_SKILL_GLYPH_WEAKENING_TP = 'Réduit les dégâts des armes et magiques pendant |cFFFFFF<<1>>|r secondes.';
    ...
    LUIE_STRING_SKILL_DRINK_INCREASE = 'Augmente';
    LUIE_STRING_SKILL_REMOVE_TOOLTIP_SCALED_LEVEL = 'Ces effets sont échelonnés en fonction de votre niveau.'; -- Note this needs to be an exact match to the description in Crown Crate food/drink items for it to be correctly removed in each localization.
    LUIE_STRING_SKILL_REMOVE_TOOLTIP_DOUBLE_BLOODY_MARA = 'Si vous êtes un vampire, le sang contenu dans cette boisson vous purifiera également, réduisant votre niveau de 1.\nTCes effets sont échelonnés en fonction de votre niveau.'; -- Must be exact match in each localization
    ...
    LUIE_STRING_SKILL_REMOVE_TOOLTIP_ARTAEUM_BOWL = 'Augmente aussi'; -- Must be exact match in each localization
    LUIE_STRING_SKILL_ADD_TOOLTIP_ARTAEUM_BOWL = '\n\nAugmente aussi';
    LUIE_STRING_SKILL_REMOVE_TOOLTIP_TWICE_SPIKED_ALE = 'Cette boisson est très gazeuse.\nCes effets sont échelonnés en fonction de votre niveau.'; -- Must be exact match in each localization
    ...
    LUIE_STRING_SKILL_COLLECTIBLE_VANITY_PET_TP = 'Vous avez un animal de compagnie non-combatant actif.';

    -- Experience
    LUIE_STRING_SKILL_EXPERIENCE_HALF_HOUR_TP = "Augmente les points d'expérience gagnés de |cFFFFFF<<1>>|r% pendant |cFFFFFF30|r minutes.";
    LUIE_STRING_SKILL_EXPERIENCE_HOUR_TP = "Augmente les points d'expérience gagnés de |cFFFFFF<<1>>|r% pendant |cFFFFFF<<2>>|r <<2[heure/heures]>>.";
    LUIE_STRING_SKILL_EXPERIENCE_PELINAL = "Augmente les points d'alliance gagnés de |cFFFFFF100|r% et les points d'expérience gagnés de |cFFFFFF100|r% en tuant des joueurs pendant |cFFFFFF<<1>>|r <<1[heure/heures]>>.";
    ...
    -- Misc
    LUIE_STRING_SKILL_FILLET_FISH = 'Filet de poisson';
    ...
    LUIE_STRING_SKILL_EVENT_FREEZING = 'Vous êtes gelé et votre vitesse de déplacement est réduite. Trouver un feu de camp pour vous réchauffer.';
    LUIE_STRING_SKILL_EVENT_WARM = "Vous êtes blotti autour d'un feu de camp à proximité pour vous réchauffer. Diminue la durée de gerl de |cFFFFFF10|r secondes toutes les |cFFFFFF1|r secondes.";
    LUIE_STRING_SKILL_EVENT_FESTIVAL_GROG = 'Vous vous sentez un peu... désorienté.';
    LUIE_STRING_SKILL_EVENT_FESTIVAL_MINTS = 'Vous avez TRES froid.';
    ...
    -- Major / Minor Buffs
    LUIE_STRING_SKILL_MINOR_RESOLVE_TP = 'Augmente la résistance physique et aux sorts de |cFFFFFF2974|r.';
    LUIE_STRING_SKILL_MAJOR_RESOLVE_TP = 'Augmente la résistance physique et aux sorts de |cFFFFFF5948|r.';
    LUIE_STRING_SKILL_MINOR_FORTITUDE_TP = 'Augmente la récupération de santé de |cFFFFFF15|r%.';
    LUIE_STRING_SKILL_MAJOR_FORTITUDE_TP = 'Augmente la récupération de santé de |cFFFFFF30|r%.';
    LUIE_STRING_SKILL_MINOR_ENDURANCE_TP = 'Augmente la récupération de vigueur de |cFFFFFF15|r%.';
    LUIE_STRING_SKILL_MAJOR_ENDURANCE_TP = 'Augmente la récupération de vigueur de |cFFFFFF30|r%.';
    LUIE_STRING_SKILL_MINOR_INTELLECT_TP = 'Augmente la récupération de magie de |cFFFFFF15|r%.';
    LUIE_STRING_SKILL_MAJOR_INTELLECT_TP = 'Augmente la récupération de magie de |cFFFFFF30|r%.';
    LUIE_STRING_SKILL_MINOR_SORCERY_TP = 'Augmente les dégâts des sorts de |cFFFFFF10|r%.';
    LUIE_STRING_SKILL_MAJOR_SORCERY_TP = 'Augmente les dégâts des sorts de |cFFFFFF20|r%.';
    ...
    LUIE_STRING_SKILL_MINOR_BRUTALITY_TP = 'Augmente les dégâts des armes de |cFFFFFF10|r%.';
    LUIE_STRING_SKILL_MAJOR_BRUTALITY_TP = 'Augmente les dégâts des armes de |cFFFFFF20|r%.';
    ...
    LUIE_STRING_SKILL_MINOR_BERSERK_TP = 'Augmente les dégâts réalisés de |cFFFFFF5|r%.';
    LUIE_STRING_SKILL_MAJOR_BERSERK_TP = 'Augmente les dégâts réalisés de |cFFFFFF10|r%.';
    LUIE_STRING_SKILL_MINOR_FORCE_TP = 'Augmente les dégâts critiques de |cFFFFFF10|r%.';
    LUIE_STRING_SKILL_MAJOR_FORCE_TP = 'Augmente les dégâts critiques de |cFFFFFF20|r%.';
    LUIE_STRING_SKILL_MINOR_VITALITY_TP = 'Augmente les soins reçus de |cFFFFFF8|r%.';
    LUIE_STRING_SKILL_MAJOR_VITALITY_TP = 'Augmente les soins reçus de |cFFFFFF16|r%.';
    LUIE_STRING_SKILL_MINOR_MENDING_TP = 'Augmente les soins réalisés de |cFFFFFF8|r%.';
    LUIE_STRING_SKILL_MAJOR_MENDING_TP = 'Augmente les soins réalisés de |cFFFFFF16|r%.';
    LUIE_STRING_SKILL_MINOR_PROTECTION_TP = 'Réduit les dégâts reçus de |cFFFFFF5|r%.';
    LUIE_STRING_SKILL_MAJOR_PROTECTION_TP = 'Réduit les dégâts reçus de |cFFFFFF10|r%.';
    LUIE_STRING_SKILL_MINOR_EVASION_TP = 'Réduit les dégâts de zone reçus de |cFFFFFF10|r%.';
    LUIE_STRING_SKILL_MAJOR_EVASION_TP = 'Réduit les dégâts de zone reçus de |cFFFFFF20|r%.';
    LUIE_STRING_SKILL_MINOR_EXPEDITION_TP = 'Augmente la vitesse de déplacement de |cFFFFFF15|r%.';
    LUIE_STRING_SKILL_MAJOR_EXPEDITION_TP = 'Augmente la vitesse de déplacement de |cFFFFFF30|r%.';
    LUIE_STRING_SKILL_MAJOR_GALLOP_TP = 'Augmente la vitesse de déplacement de la monture de |cFFFFFF30|r%.';
    LUIE_STRING_SKILL_MINOR_HEROISM_TP = "Gagne |cFFFFFF1|r Points d'Ultime toutes les |cFFFFFF1.5|r secondes.";
    LUIE_STRING_SKILL_MAJOR_HEROISM_TP = "Gagne |cFFFFFF3|r Points d'Ultime toutes les |cFFFFFF1.5|r secondes.";
    LUIE_STRING_SKILL_MINOR_TOUGHNESS_TP = 'Augmente la santé maximale de |cFFFFFF10|r%.';
    LUIE_STRING_SKILL_MINOR_COURAGE_TP = 'Augmente les dégâts des armes et des sorts de |cFFFFFF215|r.';
    LUIE_STRING_SKILL_MAJOR_COURAGE_TP = 'Augmente les dégâts des armes et des sorts de |cFFFFFF430|r.';

    -- Major / Minor Debuffs
    LUIE_STRING_SKILL_MINOR_BREACH_TP = 'Réduit la résistance physique et aux sorts de |cFFFFFF2974|r.';
    LUIE_STRING_SKILL_MAJOR_BREACH_TP = 'Réduit la résistance physique et aux sorts de |cFFFFFF5948|r.';
    LUIE_STRING_SKILL_MAJOR_FRACTURE_NPC_TP = 'Réduit la résistance physique de |cFFFFFF4000|r.';
    LUIE_STRING_SKILL_MINOR_VULNERABILITY_TP = 'Augmente les dégâts reçus de |cFFFFFF5|r%.';
    LUIE_STRING_SKILL_MAJOR_VULNERABILITY_TP = 'Augmente les dégâts reçus de |cFFFFFF10|r%.';
    LUIE_STRING_SKILL_MINOR_MAIM_TP = 'Réduit les dégâts réalisés de |cFFFFFF5|r%.';
    LUIE_STRING_SKILL_MAJOR_MAIM_TP = 'Réduit les dégâts réalisés de |cFFFFFF10|r%.';
    LUIE_STRING_SKILL_MINOR_DEFILE_TP = 'Réduit les soins reçus et la récupération de santé de |cFFFFFF8|r%.';
    LUIE_STRING_SKILL_MAJOR_DEFILE_TP = 'Réduit les soins reçus et la récupération de santé de |cFFFFFF16|r%.';
    ...
    LUIE_STRING_SKILL_MINOR_COWARDICE_TP = 'Réduit les dégâts des armes et des sorts de |cFFFFFF215|r.';
    LUIE_STRING_SKILL_MAJOR_COWARDICE_TP = 'Réduit les dégâts des armes et des sorts de |cFFFFFF430|r.';
    LUIE_STRING_SKILL_MINOR_MANGLE_TP = 'Réduit la santé maximale de |cFFFFFF10|r%.';
    LUIE_STRING_SKILL_MINOR_TIMIDITY_TP = 'Drain |cFFFFFF1|r Ultimate every |cFFFFFF1.5|r seconds while in combat.';
    LUIE_STRING_SKILL_MINOR_BRITTLE_TP = 'Augmente les dégâts critiques reçus de |cFFFFFF10|r%.';
    LUIE_STRING_SKILL_MAJOR_BRITTLE_TP = 'Augmente les dégâts critiques reçus de |cFFFFFF20|r%.';

    -- Slayer / Aegis
    LUIE_STRING_SKILL_MINOR_SLAYER_TP = 'Vos attaques infligent |cFFFFFF5|r% de dégâts en plus aux ennemis des donjons, raids et arènes.';
    LUIE_STRING_SKILL_MAJOR_SLAYER_TP = 'Vos attaques infligent |cFFFFFF10|r% de dégâts en plus aux ennemis des donjons, raids et arènes.';
    LUIE_STRING_SKILL_MINOR_AEGIS_TP = 'Vous recevez |cFFFFFF5|r% de dégâts en moins de la part des ennemis des donjons, raids et arènes.';
    LUIE_STRING_SKILL_MAJOR_AEGIS_TP = 'Vous recevez |cFFFFFF10|r% de dégâts en moins de la part des ennemis des donjons, raids et arènes.';

    -- Empower
    LUIE_STRING_SKILL_EMPOWER_TP = 'Increase damage done with Heavy Attacks against monsters by |cFFFFFF70|r%.';

    -- Potions
    LUIE_STRING_SKILL_SPELL_RESISTANCE_POTION_TP = 'Augmente la résistance aux sorts de |cFFFFFF5280|r pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_PHYSICAL_RESISTANCE_POTION_TP = 'Augmente la résistance physique de |cFFFFFF5280|r pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_RAVAGE_ARMOR_TP = 'Réduit la résistance physique de |cFFFFFF1320|r pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_RAVAGE_SPELL_PROTECTION_TP = 'Réduit la résistance aux sorts de |cFFFFFF1320|r pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_SPELL_RESISTANCE_POISON_TP = 'Augmente la résistance aux sorts de |cFFFFFF1320|r pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_PHYSICAL_RESISTANCE_POISON_TP = 'Augmente la résistance physique de |cFFFFFF1320|r pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    ...
    -- Craft
    LUIE_STRING_SKILL_SHADOWSTRIKE_TP = "Invisible pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.\n\nTant que vous êtes sous cet effet, vous pouvez lancer 'Lame du malheur'.";

    -- Warfare
    LUIE_STRING_SKILL_ENLIVENING_OVERFLOW_TP = 'Augmente la récupération de santé, de magie et de vigueur de |cFFFFFF0.5|r% de votre maximum de magie, avec une limite de |cFFFFFF150|r, pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_FORESIGHT_TP = 'Réduit les coûts en magie et vigueur de vos compétences de soins de |cFFFFFF75|r% pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    ...
    -- Fitness
    LUIE_STRING_SKILL_EXPERT_EVASION_TP = "Vous avez récemment bénéficié d'une esquive gratuite et ne pouvez plus le faire pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.";
    LUIE_STRING_SKILL_WINDED_TP = 'You have recently benefitted from a reactive Break Free effect and may not do so again for |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_UNCHAINED_TP = 'Réduit le coût de votre prochaine capacité de vigueur utilisée dans les |cFFFFFF<<1>>|r secondes de |cFFFFFF<<2>>|r%.';
    ...
    -- Test Effect
    LUIE_STRING_SKILL_TEST_TP = 'Ceci est un effet de test.';

    -- Generic Recovery
    LUIE_STRING_SKILL_GENERIC_STAMINA_RECOVERY_NO_DUR_TP = 'Augmente la récupération de vigueur de |cFFFFFF<<2>>|r.';
    LUIE_STRING_SKILL_GENERIC_MAGICKA_RECOVERY_NO_DUR_TP = 'Augmente la récupération de magie de |cFFFFFF<<2>>|r.';

    LUIE_STRING_SKILL_GENERIC_INCREASE_HEALING_RECEIVED_NO_DUR_TP = 'Augmente les soins reçus de |cFFFFFF<<2>>|r%.';

    -- Damage over Time / Heal over Time
    LUIE_STRING_SKILL_GENERIC_DOT_NO_TICK_TP = 'Affercté par SUBSTRING sur la durée pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_GENERIC_DOT_TP = 'Affercté par SUBSTRING toutes les |cFFFFFF<<2>>|r <<2[seconde/secondes]>> pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_GENERIC_DOT_SNARE_TP = 'Affercté par SUBSTRING toutes les |cFFFFFF<<2>>|r <<2[seconde/secondes]>> et vitesse de déplacement réduite de |cFFFFFF<<3>>|r% pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_GENERIC_HOT_TP = 'Soins toutes les |cFFFFFF<<2>>|r <<2[seconde/secondes]>> pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_GENERIC_HOT_CHANNEL_TP = 'Soins toutes les |cFFFFFF<<2>>|r <<2[seconde/secondes]>> pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>> durant la canalisation.';

    -- Ground over Time
    LUIE_STRING_SKILL_GENERIC_GROUND_AOE_TP = 'Subir SUBSTRING toutes les |cFFFFFF<<2>>|r <<2[seconde/secondes]>>.';
    LUIE_STRING_SKILL_GENERIC_GROUND_HEAL_TP = 'Soins toutes les |cFFFFFF<<2>>|r <<2[seconde/secondes]>>.';
    LUIE_STRING_SKILL_GENERIC_GROUND_AOE_SNARE_TP = 'Subir SUBSTRING toutes les |cFFFFFF<<2>>|r <<2[seconde/secondes]>> et vitesse de déplacement réduite de |cFFFFFF<<3>>|r%.';
    LUIE_STRING_SKILL_GENERIC_GROUND_AOE_STACK_TP = 'Subir une agmentation de SUBSTRING toutes les |cFFFFFF<<2>>|r <<2[seconde/secondes]>>.\n\nLes dégâts subis augmentés de |cFFFFFF<<3>>|r% par empilement.';

    -- Resistances
    LUIE_STRING_SKILL_GENERIC_PHYSICAL_RESIST_TP = 'Augmente la résistance physique pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_GENERIC_SPELL_RESIST_NO_DUR_TP = 'Augmente la résistyance aux sorts.';
    LUIE_STRING_SKILL_GENERIC_PHY_SPELL_RESIST = 'Augmente la résistance physique et aux sorts pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_GENERIC_PHY_SPELL_RESIST_VALUE_TP = 'Augmente la résistance physique et aux sorts de |cFFFFFF<<2>>|r pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_GENERIC_PHY_SPELL_RESIST_NO_DUR_TP = 'Augmente la résistance physique et aux sorts.';
    LUIE_STRING_SKILL_GENERIC_PHY_SPELL_RESIST_NO_DUR_VALUE_TP = 'Augmente la résistance physique et aux sorts de |cFFFFFF<<2>>|r.';

    LUIE_STRING_SKILL_GENERIC_REDUCE_PHY_SPELL_RESIST_VALUE_TP = 'Réduit la résistance physique et aux sorts de |cFFFFFF<<2>>|r pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_GENERIC_REDUCE_PHY_SPELL_RESIST_TP = 'Réduit la résistance physique et aux sorts pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_GENERIC_REDUCE_PHY_SPELL_RESIST_NO_DUR_TP = 'Réduit la résistance physique et aux sorts.';
    LUIE_STRING_SKILL_GENERIC_REDUCE_PHY_SPELL_RESIST_NO_DUR_VALUE_TP = 'Réduit la résistance physique et aux sorts de |cFFFFFF<<2>>|r.';

    LUIE_STRING_SKILL_GENERIC_REDUCE_PHYSICAL_RESIST_VALUE_TP = 'Réduit la résistance physique de |cFFFFFF<<2>>|r pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';

    LUIE_STRING_SKILL_GENERIC_REDUCE_WEP_SPELL_DMG_PERCENTAGE_TP = 'Réduit les dégâts des armes et des sorts de |cFFFFFF<<2>>|r% pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_GENERIC_REDUCE_WEP_SPELL_DMG_VALUE_TP = 'Réduit les dégâts des armes et des sorts de |cFFFFFF<<2>>|r pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';

    LUIE_STRING_SKILL_GENERIC_LOWER_MAX_HP_TP = 'Réduit la santé maximale de |cFFFFFF<<2>>|r% pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';

    LUIE_STRING_SKILL_GENERIC_REDUCE_DAMAGE_DONE_TP = 'Réduit les dégâts réalisés de |cFFFFFF<<2>>|r% pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_GENERIC_REDUCE_HEALING_RECEIVED_TP = 'Réduit les soins reçus de |cFFFFFF<<2>>|r% pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';

    -- Resource Regeneration, Shields
    LUIE_STRING_SKILL_GENERIC_HEALTH_RECOVERY_TP = 'Augmente la récupération de santé pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_GENERIC_MGK_REGEN_TP = 'Restitue de la magie toutes les  |cFFFFFF<<2>>|r <<2[seconde/secondes]>> pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_GENERIC_MGK_REGEN_VALUE_TP = 'Restitue |cFFFFFF<<3>>|r de magie toutes les |cFFFFFF<<2>>|r <<2[seconde/secondes]>> pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_GENERIC_STAM_REGEN_TP = 'Restitue de la vigueur toutes les |cFFFFFF<<2>>|r <<2[seconde/secondes]>> pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_GENERIC_STAM_REGEN_VALUE_TP = 'Restitiue |cFFFFFF<<3>>|r de vigueur toutes les |cFFFFFF<<2>>|r <<2[seconde/secondes]>> pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_GENERIC_DAMAGE_SHIELD_NO_DUR_TP = 'Absorption de dégâts.';
    LUIE_STRING_SKILL_GENERIC_DAMAGE_SHIELD_TP = 'Absorption de dégâts pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_GENERIC_DAMAGE_SHIELD_PERCENT_TP = 'Absorption de |cFFFFFF<<2>>|r% des dégâts subis pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';

    -- Stealth / Detection
    LUIE_STRING_SKILL_GENERIC_MARKED_TP = "Marqué pour |cFFFFFF<<1>>|r <<1[seconde/secondes]>>. Vous êtes visible par l'ennemi qui vous a marqué même lorsque vous êtes furtif.";
    LUIE_STRING_SKILL_GENERIC_TRAUMA_TP = 'Annule les |cFFFFFF2000|r prochains points de soins reçus pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_GENERIC_REVEAL_TP = 'Détecté pour |cFFFFFF<<1>>|r <<1[seconde/secondes]>>. Vous ne pouvez pas vous cacher.';
    LUIE_STRING_SKILL_GENERIC_REVEAL_NO_DUR_TP = 'Détecté. Vous ne pouvez pas vous cacher.';
    LUIE_STRING_SKILL_GENERIC_INVISIBILITY_TP = 'Invisible pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_GENERIC_DETECTION_TP = 'Augmente la détection furtive de |cFFFFFF20|r mètres pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_GENERIC_DETECTION_NPC_TP = 'Révéle les ennemis furtifs et invisibles à proximité.';

    -- Crowd Control / Immunity
    LUIE_STRING_SKILL_GENERIC_OFF_BALANCE_IMMUNITY_TP = 'Immunisé aux effets qui exploitent les cibles déséquilibrées pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_GENERIC_MAJOR_VULNERABILITY_IMMUNITY = 'Immunité aux vulnérabilités majeures';
    LUIE_STRING_SKILL_GENERIC_MAJOR_VULNERABILITY_IMMUNITY_TP = 'Immunisé contre les vulnérabilités majeures pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_GENERIC_OFF_BALANCE_TP = 'Déséquilibré pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_GENERIC_OFF_BALANCE_NO_DUR_TP = 'Déséquilibré.';
    LUIE_STRING_SKILL_GENERIC_SNARE_TP = 'Vitesse de déplacement réduite de |cFFFFFF<<2>>|r% pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_GENERIC_SNARE_NO_DUR_TP = 'Vitesse de déplacement réduite de |cFFFFFF<<2>>|r%.';
    LUIE_STRING_SKILL_GENERIC_IMMOBILIZE_TP = 'Immobilisé pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_GENERIC_IMMOBILIZE_NO_DUR_TP = 'Immobilisé.';
    LUIE_STRING_SKILL_GENERIC_STAGGER_TP = 'Vacillement.';
    LUIE_STRING_SKILL_GENERIC_STUN_TP = 'Etourdi pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_GENERIC_STUN_NO_DUR_TP = 'Etourdi.';
    LUIE_STRING_SKILL_GENERIC_LEVITATE_TP = 'Lévitation pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_GENERIC_KNOCKBACK_TP = 'Repoussé pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_GENERIC_KNOCKDOWN_TP = 'Renversé pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_GENERIC_KNOCKDOWN_NO_DUR_TP = 'Renversé.';
    LUIE_STRING_SKILL_GENERIC_FEAR_TP = 'Effrayé pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_GENERIC_FEAR_NO_DUR_TP = 'Effrayé.';
    LUIE_STRING_SKILL_GENERIC_SILENCE_TP = 'Muet pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_GENERIC_SILENCE_NO_DUR_TP = 'Muet.';
    LUIE_STRING_SKILL_GENERIC_BLIND_TP = 'Aveuglé pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>. |cFFFFFF100|r% de chance de rater toutes les attaques.';
    LUIE_STRING_SKILL_GENERIC_CC_IMMUNITY_TP = 'Insensible aux effets de recul et de désactivation des effects pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_GENERIC_SCARY_IMMUNITIES_TP = 'Immunisé contre tous les effets de contrôle de foule et de mouvement.';
    LUIE_STRING_SKILL_GENERIC_SCARY_IMMUNITIES_DUR_TP = 'Immunisé contre tous les effets de contrôle de foule et de mouvement pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_GENERIC_FLYING_IMMUNITIES_TP = 'Immunisé contre tous les effets de contrôle de mouvement.';
    LUIE_STRING_SKILL_SET_GENERIC_IMMUNITY_TP = 'Immunisé aux dommages et à tous les effets négatifs pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_GENERIC_IMMUNITY_PERMANENT_TP = 'Immunisé aux dommages et à tous les effets négatifs.';
    LUIE_STRING_SKILL_GENERIC_DAMAGE_IMMUNITY_PERMANENT_TP = 'Immune to damage.';
    LUIE_STRING_SKILL_GENERIC_DISORIENT_TP = 'Désorienté pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_GENERIC_DISORIENT_NO_DUR_TP = 'Désorienté.';
    ...
    -- Generic Stat Buffs
    LUIE_STRING_SKILL_SET_GENERIC_WEP_SPELL_DAMAGE_TIME_TP = 'Augmente les dégâts des armes et des sorts pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_SET_GENERIC_WEP_SPELL_DAMAGE_TIME_VALUE_TP = 'Augmente les dégâts des armes et des sorts de |cFFFFFF<<2>>|r pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_SET_GENERIC_WEP_DAMAGE_TIME_TP = 'Augmente les dégâts des armes pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_SET_GENERIC_WEP_DAMAGE_VALUE_TIME_TP = 'Augmente les dégâts des armes de |cFFFFFF<<2>>|r pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_SET_GENERIC_SPELL_DAMAGE_TIME_TP = 'Augmente les dégâts des sorts pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_SET_GENERIC_SPELL_DAMAGE_TIME_VALUE_TP = 'Augmente les dégâts des sorts de |cFFFFFF<<2>>|r pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_SET_GENERIC_LA_HA_DAMAGE_TP = 'Vos attaques légères et puissantes infligent des dégâts supplémentaires pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_SET_GENERIC_LA_HA_DAMAGE_VALUE_TP = 'Vos attaques légères et puissantes infligent |cFFFFFF<<2>>|r de dégâts supplémentaires pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_SET_GENERIC_MAG_RECOVERY_TIME_TP = 'Augmente la récupération de magie pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_SET_GENERIC_MAG_RECOVERY_TIME_VALUE_TP = 'Augmente la récupération de magie de |cFFFFFF<<2>>|r pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';

    LUIE_STRING_SKILL_SET_GENERIC_CRITICAL_DAMAGE_TP = 'Augmente les dégâts critiques de |cFFFFFF<<2>>|r% pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';

    LUIE_STRING_SKILL_GENERIC_INCREASE_DAMAGE_TAKEN_TP = 'Augmente les dégâts subis de |cFFFFFF<<2>>|r% pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_GENERIC_REDUCE_DAMAGE_TAKEN_TP = 'Réduit les dégâts subis de |cFFFFFF<<2>>|r% pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';

    LUIE_STRING_SKILL_GENERIC_ENRAGE = 'Augmente les dégâts infligés de |cFFFFFF<<2>>|r% pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_GENERIC_ENRAGE_NO_DUR = 'Augmente les dégâts infligés de |cFFFFFF<<2>>|r%.';
    LUIE_STRING_SKILL_GENERIC_ENRAGE_DAMAGE_TAKEN_NO_DUR = 'Augmente les dégâts infligés de |cFFFFFF<<2>>|r% et augmente les dégâts subis de |cFFFFFF<<3>>|r%.';
    LUIE_STRING_SKILL_GENERIC_ENRAGE_DAMAGE_REDUCE_NO_DUR = 'Augmente les dégâts infligés de |cFFFFFF<<2>>|r% et réduit les dégâts subis de |cFFFFFF<<3>>|r%.';
    LUIE_STRING_SKILL_GENERIC_ENRAGE_STACK_PERMANENT_TP = "Augmente les dégâts infligés de |cFFFFFF<<2>>|r% par nombre d'accumulation.";

    LUIE_STRING_SKILL_GENERIC_MOVEMENT_SPEED_TP = 'Augmente la vitesse de déplacement de |cFFFFFF<<2>>|r% pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';

    LUIE_STRING_SKILL_GENERIC_PHYSICAL_SPELL_PEN_TP = 'Augmente la pénétration physique et des sorts de |cFFFFFF<<2>>|r pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';

    LUIE_STRING_SKILL_SET_GENERIC_ICD_TP = 'Vous avez récemment bénéficié des effets de <<2>> et ne pourrez plus en profiter pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    LUIE_STRING_SKILL_SET_GENERIC_ICD_MINUTES_TP = 'Vous avez récemment bénéficié des effets de <<2>> et ne pourrez plus en profiter pendant |cFFFFFF<<3>>|r <<3[minute/minutes]>>.';

    LUIE_STRING_SKILL_SET_GENERIC_REDUCE_WEAPON_DAMAGE_TIME_VALUE_TP = 'Réduit les dégâts des armes de |cFFFFFF<<2>>|r pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';

    LUIE_STRING_SKILL_INCREASE_MAX_MAGICKA_DURATION_PERCENTAGE_TP = 'Augmente la magie maximale de |cFFFFFF<<2>>|r% pendant |cFFFFFF<<1>>|r <<1[seconde/secondes]>>.';
    ...
    LUIE_STRING_SKILL_SET_ILAMBRIS = 'Enemies within |cFFFFFF4|r meters of the meteor shower take Flame and Shock Damage every |cFFFFFF1|r second.';
    ...
    -- Mounted
    LUIE_STRING_SKILL_MOUNTED = 'En selle';
    LUIE_STRING_SKILL_MOUNTED_TP = 'Vous êtes sur une monture.';
    LUIE_STRING_SKILL_MOUNTED_PASSENGER = 'En selle (Passager)';
    LUIE_STRING_SKILL_MOUNTED_PASSENGER_TP = 'Vous êtes sur une monture en tant que passager.';

...
local strings = {
    ...
    LUIE_STRING_SKILL_MINOR_MAGICKASTEAL_TP = "Récupère |cFFFFFF168|r de magie chaque |cFFFFFF1|r seconde quand blessé.",
    LUIE_STRING_SKILL_MINOR_LIFESTEAL_TP = "Récupère |cFFFFFF600|r de santé Health chaque |cFFFFFF1|r seconde quand blessé.",
    LUIE_STRING_SKILL_MINOR_ENERVATION_TP = "Réduit les dégâts critiques de |cFFFFFF10|r%.",
    LUIE_STRING_SKILL_MINOR_UNCERTAINTY_TP = "Reduce Weapon Critical and Spell Critical by |cFFFFFF1314|r.",
    ...
    LUIE_STRING_SKILL_MEATBAG_CATAPULT_TP = "Healing and Health Recovery reduced by |cFFFFFF50|r% for |cFFFFFF<<1>>|r seconds.",
    LUIE_STRING_SKILL_MEATBAG_CATAPULT_GROUND_TP = "Enemies in the area take Disease Damage every |cFFFFFF1|r second and suffer |cFFFFFF50|r% reduced Healing and Health Recovery for |cFFFFFF6|r seconds.",
    ...
    LUIE_STRING_SKILL_SCATTERSHOT_CATAPULT_GROUND_TP = "Enemies in the area take Physical Damage every |cFFFFFF1|r second and take |cFFFFFF20|r% more damage from all sources for |cFFFFFF6|r seconds.",

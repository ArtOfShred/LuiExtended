...
local strings =
{
    ...
    LUIE_STRING_SKILL_INVISIBLE_TP = 'Concealed from sight by magical or environmental means.';
    ...
    LUIE_STRING_SKILL_SET_SENCHE_RAHTS_GRIT = 'After being damaged by a damage over time ability, increase your Healing Received by |cFFFFFF<<1>>|r% and your Physical and Spell Resistance by |cFFFFFF<<2>>|r for |cFFFFFF<<3>>|r seconds.';

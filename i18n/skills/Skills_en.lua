...
local strings = {
    ...
    SI_LUIE_SKILL_PERMAFROST_TP =                        "Enemies in the |cFFFFFF10|r meter radius of the storm take Frost Damage and have their movement speed reduced by |cFFFFFF40|r% every |cFFFFFF1|r second.\n\nDamaging an enemy three times with the storm will stun them for |cFFFFFF3|r seconds.",

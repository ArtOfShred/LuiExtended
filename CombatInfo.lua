...
CI.FontFamilies = {
    ["Fontin"] = {
        ["FontBold"]    = "/LuiExtended/assets/fontin_sans_b.otf",
        ["FontRegular"] = "/LuiExtended/assets/fontin_sans_r.otf",
    },
    ["Futura Condensed"] = {
...
function CI.Initialize( enabled )
    ...
    PrintXP = LUIE.ChatAnnouncements.PrintXPChange
    LogKillXP = LUIE.DamageMeter.LogExp
...
function CI.OnXPUpdate( eventCode, unitTag, currentExp, maxExp, reason )
    ...
    if reason == 0 then LogKillXP(value) end
end

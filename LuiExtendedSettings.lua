...
function LUIE_CreateSettings()
    ...
    optionsData[#optionsData + 1] = {
        ...
        controls = {
            ...
            {
                type = "checkbox",
                name = "Show Battle Spirit in AvA and Duels",
                tooltip = "Set whether the battle spirit buff will display in AvA and Duels.",
            ...
            {
                type = "checkbox",
                name = "Show ESO Plus Member",
                tooltip = "Set whether the ESO Plus Member buff is displayed.",

...
function LUIE_CreateSettings()
    ...
    optionsData[#optionsData + 1] = {
        ...
        controls = {
            ...
            {
                type = "checkbox",
                name = GetString(SI_LUIE_LAM_BUFF_LONGTERM_MUNDUS),
                tooltip = GetString(SI_LUIE_LAM_BUFF_LONGTERM_MUNDUS_TOOLTIP),
            ...
            {
                type = "checkbox",
                name = GetString(SI_LUIE_LAM_BUFF_LONGTERM_EQUIP),
                tooltip = GetString(SI_LUIE_LAM_BUFF_LONGTERM_EQUIP_TOOLTIP),
            ...
            {
                type = "checkbox",
                name = GetString(SI_LUIE_LAM_BUFF_LONGTERM_VAMP),
                tooltip = GetString(SI_LUIE_LAM_BUFF_LONGTERM_VAMP_TOOLTIP),
            ...
            {
                type = "checkbox",
                name = GetString(SI_LUIE_LAM_BUFF_LONGTERM_CYRO),
                tooltip = GetString(SI_LUIE_LAM_BUFF_LONGTERM_CYRO_TOOLTIP),
            ...
            {
                type = "checkbox",
                name = GetString(SI_LUIE_LAM_BUFF_LONGTERM_BATTLESPIRIT),
                tooltip = GetString(SI_LUIE_LAM_BUFF_LONGTERM_BATTLESPIRIT_TOOLTIP),
                getFunc = function() return not LUIE.SpellCastBuffs.SV.IgnoreBattleSpirit end,
                setFunc = function(value) LUIE.SpellCastBuffs.SV.IgnoreBattleSpirit = not value LUIE.SpellCastBuffs.ReloadEffects() end,
                width = "full",
                default = not LUIE.SpellCastBuffs.D.IgnoreBattleSpirit,
                disabled = function() return not ( LUIE.SV.SpellCastBuff_Enable and ( LUIE.SpellCastBuffs.SV.LongTermEffects_Player or LUIE.SpellCastBuffs.SV.LongTermEffects_Target ) ) end,
            },
            {
                type = "checkbox",
                name = GetString(SI_LUIE_LAM_BUFF_LONGTERM_ESOPLUS),
                tooltip = GetString(SI_LUIE_LAM_BUFF_LONGTERM_ESOPLUS_TOOLTIP),
                getFunc = function() return not LUIE.SpellCastBuffs.SV.IgnoreEsoPlus end,
                setFunc = function(value) LUIE.SpellCastBuffs.SV.IgnoreEsoPlus = not value LUIE.SpellCastBuffs.ReloadEffects() end,
                width = "full",
                default = not LUIE.SpellCastBuffs.D.IgnoreEsoPlus,
                disabled = function() return not ( LUIE.SV.SpellCastBuff_Enable and ( LUIE.SpellCastBuffs.SV.LongTermEffects_Player or LUIE.SpellCastBuffs.SV.LongTermEffects_Target ) ) end,
            },
            {
                type = "checkbox",
            ...
            },
            {
                ...
                setFunc = function(value) LUIE.SpellCastBuffs.SV.ShowBlockPlayer = value end,
                width = "full",
            ...
            },
            {
                ...
                setFunc = function(value) LUIE.SpellCastBuffs.SV.ShowBlockTarget = value end,
                width = "full",

...
function LUIE_WelcomeScreen(menu)
    ...
    local function AddLine(text, font, align, color)
        ...
        if lastLabel == nil then
            label:SetAnchor(TOP, parent, TOPLEFT, 200, offset + 6)
        else
            label:SetAnchor(TOP, lastLabel, BOTTOM, 0, offset + 2)
        end
